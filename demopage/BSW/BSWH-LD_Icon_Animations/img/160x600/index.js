...
if (reversed == null) { reversed = false; }
	...
	// Layer_4
	this.text = new cjs.Text("Learn how\nto choose\nthe right\nOB/GYN.", "bold 35px 'Sharp Sans'", "#FFFFFF");
	this.text.lineHeight = 41;
	this.text.lineWidth = 214;
	this.text.parent = this;
	this.text.setTransform(-77.6,-119.3);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.text_02, new cjs.Rectangle(-79.6,-121.3,217.5,173), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.text = new cjs.Text("Thinking\nabout\ngetting\npregnant?", "bold 35px 'Sharp Sans'", "#FFFFFF");
	this.text.lineHeight = 41;
	this.text.lineWidth = 282;
	this.text.parent = this;
	this.text.setTransform(-78.25,-150.75);
...
p.nominalBounds = new cjs.Rectangle(-80.2,-152.7,285.6,173);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(319));

	// diagonal_mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_168 = new cjs.Graphics().p("EhV9A3AIqPs+Mg4WhHPMCeyh+nMCSTC5CMieyB+ng");
	...
	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(168).to({graphics:mask_graphics_168,x:856.175,y:-275.025}).wait(1).to({graphics:mask_graphics_169,x:832.575,y:-261.575}).wait(1).to({graphics:mask_graphics_170,x:809.375,y:-248.325}).wait(1).to({graphics:mask_graphics_171,x:786.575,y:-235.375}).wait(1).to({graphics:mask_graphics_172,x:764.175,y:-222.625}).wait(1).to({graphics:mask_graphics_173,x:742.175,y:-210.075}).wait(1).to({graphics:mask_graphics_174,x:720.625,y:-197.775}).wait(1).to({graphics:mask_graphics_175,x:699.425,y:-185.725}).wait(1).to({graphics:mask_graphics_176,x:678.675,y:-173.875}).wait(1).to({graphics:mask_graphics_177,x:658.325,y:-162.275}).wait(1).to({graphics:mask_graphics_178,x:638.375,y:-150.925}).wait(1).to({graphics:mask_graphics_179,x:618.825,y:-139.825}).wait(1).to({graphics:mask_graphics_180,x:599.675,y:-128.875}).wait(1).to({graphics:mask_graphics_181,x:580.975,y:-118.225}).wait(1).to({graphics:mask_graphics_182,x:562.675,y:-107.775}).wait(1).to({graphics:mask_graphics_183,x:544.725,y:-97.575}).wait(1).to({graphics:mask_graphics_184,x:527.225,y:-87.625}).wait(1).to({graphics:mask_graphics_185,x:510.125,y:-77.875}).wait(1).to({graphics:mask_graphics_186,x:493.425,y:-68.325}).wait(1).to({graphics:mask_graphics_187,x:477.175,y:-59.075}).wait(1).to({graphics:mask_graphics_188,x:461.275,y:-50.025}).wait(1).to({graphics:mask_graphics_189,x:445.825,y:-41.225}).wait(1).to({graphics:mask_graphics_190,x:430.775,y:-32.625}).wait(1).to({graphics:mask_graphics_191,x:416.075,y:-24.275}).wait(1).to({graphics:mask_graphics_192,x:401.875,y:-16.175}).wait(1).to({graphics:mask_graphics_193,x:388.025,y:-8.275}).wait(1).to({graphics:mask_graphics_194,x:374.575,y:-0.625}).wait(1).to({graphics:mask_graphics_195,x:361.525,y:6.825}).wait(1).to({graphics:mask_graphics_196,x:348.925,y:13.975}).wait(1).to({graphics:mask_graphics_197,x:336.725,y:20.925}).wait(1).to({graphics:mask_graphics_198,x:324.925,y:27.675}).wait(1).to({graphics:mask_graphics_199,x:313.525,y:34.175}).wait(1).to({graphics:mask_graphics_200,x:302.525,y:40.425}).wait(1).to({graphics:mask_graphics_201,x:291.925,y:46.475}).wait(1).to({graphics:mask_graphics_202,x:281.775,y:52.275}).wait(1).to({graphics:mask_graphics_203,x:271.975,y:57.825}).wait(1).to({graphics:mask_graphics_204,x:262.625,y:63.175}).wait(1).to({graphics:mask_graphics_205,x:253.675,y:68.275}).wait(1).to({graphics:mask_graphics_206,x:245.125,y:73.125}).wait(1).to({graphics:mask_graphics_207,x:236.975,y:77.775}).wait(1).to({graphics:mask_graphics_208,x:229.225,y:82.175}).wait(1).to({graphics:mask_graphics_209,x:221.925,y:86.375}).wait(1).to({graphics:mask_graphics_210,x:214.975,y:90.325}).wait(1).to({graphics:mask_graphics_211,x:208.475,y:94.025}).wait(1).to({graphics:mask_graphics_212,x:202.375,y:97.475}).wait(1).to({graphics:mask_graphics_213,x:196.675,y:100.725}).wait(1).to({graphics:mask_graphics_214,x:191.375,y:103.775}).wait(1).to({graphics:mask_graphics_215,x:186.525,y:106.525}).wait(1).to({graphics:mask_graphics_216,x:182.025,y:109.075}).wait(1).to({graphics:mask_graphics_217,x:177.925,y:111.425}).wait(1).to({graphics:mask_graphics_218,x:174.275,y:113.475}).wait(1).to({graphics:mask_graphics_219,x:171.025,y:115.375}).wait(1).to({graphics:mask_graphics_220,x:168.175,y:116.975}).wait(99));

	// BSWH_Logo
	this.instance = new lib.bswh_logo();
	this.instance.setTransform(80.05,279.55,0.6483,0.6483,0,0,0,0.1,0.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(176).to({_off:false},0).to({alpha:1},22).wait(121));

	// cta_btn
	this.instance_1 = new lib.cta_btn();
	this.instance_1.setTransform(82.45,348.2,0.3908,0.3908,0,0,0,197.3,53.4);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(176).to({_off:false},0).to({alpha:1},22).wait(121));

	// diagonal_endFrame
	this.instance_2 = new lib.diagonal_mask();
	this.instance_2.setTransform(380.15,594.65,0.9468,0.9468,-90.0009,0,0,-0.6,1.2);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(168).to({_off:false},0).wait(1).to({regX:75.2,regY:176.4,x:511.65,y:511},0).wait(1).to({x:482.65,y:500.95},0).wait(1).to({scaleX:0.9469,scaleY:0.9469,x:457.7,y:492.3},0).wait(1).to({x:435.9,y:484.75},0).wait(1).to({x:416.7,y:478.1},0).wait(1).to({x:399.6,y:472.15},0).wait(1).to({x:384.3,y:466.85},0).wait(1).to({x:370.5,y:462.1},0).wait(1).to({x:358,y:457.75},0).wait(1).to({x:346.65,y:453.8},0).wait(1).to({x:336.3,y:450.25},0).wait(1).to({x:326.9,y:446.95},0).wait(1).to({x:318.2,y:443.95},0).wait(1).to({x:310.25,y:441.2},0).wait(1).to({x:302.9,y:438.65},0).wait(1).to({x:296.1,y:436.3},0).wait(1).to({x:289.85,y:434.1},0).wait(1).to({x:284.05,y:432.1},0).wait(1).to({x:278.65,y:430.25},0).wait(1).to({x:273.7,y:428.5},0).wait(1).to({x:269.05,y:426.9},0).wait(1).to({x:264.8,y:425.45},0).wait(1).to({x:260.8,y:424.05},0).wait(1).to({x:257.15,y:422.8},0).wait(1).to({x:253.7,y:421.6},0).wait(1).to({x:250.55,y:420.5},0).wait(1).to({x:247.6,y:419.5},0).wait(1).to({x:244.9,y:418.55},0).wait(1).to({x:242.35,y:417.65},0).wait(1).to({x:240.05,y:416.85},0).wait(1).to({x:237.85,y:416.1},0).wait(1).to({x:235.9,y:415.4},0).wait(1).to({x:234.05,y:414.8},0).wait(1).to({x:232.35,y:414.2},0).wait(1).to({x:230.8,y:413.65},0).wait(1).to({x:229.4,y:413.2},0).wait(1).to({x:228.1,y:412.75},0).wait(1).to({x:226.95,y:412.3},0).wait(1).to({x:225.9,y:411.95},0).wait(1).to({x:224.95,y:411.65},0).wait(1).to({x:224.05,y:411.35},0).wait(1).to({x:223.3,y:411.05},0).wait(1).to({x:222.65,y:410.85},0).wait(1).to({x:222.05,y:410.65},0).wait(1).to({x:221.55,y:410.45},0).wait(1).to({x:221.15,y:410.3},0).wait(1).to({x:220.8,y:410.2},0).wait(1).to({x:220.5,y:410.1},0).wait(1).to({x:220.3,y:410},0).wait(1).to({x:220.15,y:409.95},0).wait(1).to({x:220.05},0).wait(1).to({regX:-0.6,regY:1.1,x:54.1,y:481.75},0).wait(99));
	...
	this.shape_2.setTransform(832.575,-261.575);
	this.shape_2._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1}]},168).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).wait(99));
	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(169).to({_off:false},0).wait(1).to({x:809.375,y:-248.325},0).wait(1).to({x:786.575,y:-235.375},0).wait(1).to({x:764.175,y:-222.625},0).wait(1).to({x:742.175,y:-210.075},0).wait(1).to({x:720.625,y:-197.775},0).wait(1).to({x:699.425,y:-185.725},0).wait(1).to({x:678.675,y:-173.875},0).wait(1).to({x:658.325,y:-162.275},0).wait(1).to({x:638.375,y:-150.925},0).wait(1).to({x:618.825,y:-139.825},0).wait(1).to({x:599.675,y:-128.875},0).wait(1).to({x:580.975,y:-118.225},0).wait(1).to({x:562.675,y:-107.775},0).wait(1).to({x:544.725,y:-97.575},0).wait(1).to({x:527.225,y:-87.625},0).wait(1).to({x:510.125,y:-77.875},0).wait(1).to({x:493.425,y:-68.325},0).wait(1).to({x:477.175,y:-59.075},0).wait(1).to({x:461.275,y:-50.025},0).wait(1).to({x:445.825,y:-41.225},0).wait(1).to({x:430.775,y:-32.625},0).wait(1).to({x:416.075,y:-24.275},0).wait(1).to({x:401.875,y:-16.175},0).wait(1).to({x:388.025,y:-8.275},0).wait(1).to({x:374.575,y:-0.625},0).wait(1).to({x:361.525,y:6.825},0).wait(1).to({x:348.925,y:13.975},0).wait(1).to({x:336.725,y:20.925},0).wait(1).to({x:324.925,y:27.675},0).wait(1).to({x:313.525,y:34.175},0).wait(1).to({x:302.525,y:40.425},0).wait(1).to({x:291.925,y:46.475},0).wait(1).to({x:281.775,y:52.275},0).wait(1).to({x:271.975,y:57.825},0).wait(1).to({x:262.625,y:63.175},0).wait(1).to({x:253.675,y:68.275},0).wait(1).to({x:245.125,y:73.125},0).wait(1).to({x:236.975,y:77.775},0).wait(1).to({x:229.225,y:82.175},0).wait(1).to({x:221.925,y:86.375},0).wait(1).to({x:214.975,y:90.325},0).wait(1).to({x:208.475,y:94.025},0).wait(1).to({x:202.375,y:97.475},0).wait(1).to({x:196.675,y:100.725},0).wait(1).to({x:191.375,y:103.775},0).wait(1).to({x:186.525,y:106.525},0).wait(1).to({x:182.025,y:109.075},0).wait(1).to({x:177.925,y:111.425},0).wait(1).to({x:174.275,y:113.475},0).wait(1).to({x:171.025,y:115.375},0).wait(1).to({x:168.175,y:116.975},0).wait(99));
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(71).to({graphics:mask_1_graphics_71,x:-393.05,y:882.525}).wait(1).to({graphics:mask_1_graphics_72,x:-383.05,y:867.175}).wait(1).to({graphics:mask_1_graphics_73,x:-373.15,y:852.075}).wait(1).to({graphics:mask_1_graphics_74,x:-363.4,y:837.125}).wait(1).to({graphics:mask_1_graphics_75,x:-353.75,y:822.375}).wait(1).to({graphics:mask_1_graphics_76,x:-344.25,y:807.825}).wait(1).to({graphics:mask_1_graphics_77,x:-334.85,y:793.475}).wait(1).to({graphics:mask_1_graphics_78,x:-325.6,y:779.325}).wait(1).to({graphics:mask_1_graphics_79,x:-316.5,y:765.375}).wait(1).to({graphics:mask_1_graphics_80,x:-307.5,y:751.575}).wait(1).to({graphics:mask_1_graphics_81,x:-298.65,y:738.025}).wait(1).to({graphics:mask_1_graphics_82,x:-289.9,y:724.675}).wait(1).to({graphics:mask_1_graphics_83,x:-281.3,y:711.475}).wait(1).to({graphics:mask_1_graphics_84,x:-272.8,y:698.525}).wait(1).to({graphics:mask_1_graphics_85,x:-264.45,y:685.725}).wait(1).to({graphics:mask_1_graphics_86,x:-256.25,y:673.125}).wait(1).to({graphics:mask_1_graphics_87,x:-248.15,y:660.725}).wait(1).to({graphics:mask_1_graphics_88,x:-240.2,y:648.525}).wait(1).to({graphics:mask_1_graphics_89,x:-232.35,y:636.525}).wait(1).to({graphics:mask_1_graphics_90,x:-224.65,y:624.725}).wait(1).to({graphics:mask_1_graphics_91,x:-217.05,y:613.125}).wait(1).to({graphics:mask_1_graphics_92,x:-209.6,y:601.725}).wait(1).to({graphics:mask_1_graphics_93,x:-202.25,y:590.475}).wait(1).to({graphics:mask_1_graphics_94,x:-195.05,y:579.475}).wait(1).to({graphics:mask_1_graphics_95,x:-188,y:568.675}).wait(1).to({graphics:mask_1_graphics_96,x:-181.05,y:558.025}).wait(1).to({graphics:mask_1_graphics_97,x:-174.25,y:547.575}).wait(1).to({graphics:mask_1_graphics_98,x:-167.55,y:537.375}).wait(1).to({graphics:mask_1_graphics_99,x:-161,y:527.325}).wait(1).to({graphics:mask_1_graphics_100,x:-154.55,y:517.475}).wait(1).to({graphics:mask_1_graphics_101,x:-148.25,y:507.825}).wait(1).to({graphics:mask_1_graphics_102,x:-142.05,y:498.375}).wait(1).to({graphics:mask_1_graphics_103,x:-136.05,y:489.125}).wait(1).to({graphics:mask_1_graphics_104,x:-130.1,y:480.075}).wait(1).to({graphics:mask_1_graphics_105,x:-124.3,y:471.175}).wait(1).to({graphics:mask_1_graphics_106,x:-118.65,y:462.525}).wait(1).to({graphics:mask_1_graphics_107,x:-113.1,y:454.025}).wait(1).to({graphics:mask_1_graphics_108,x:-107.7,y:445.775}).wait(1).to({graphics:mask_1_graphics_109,x:-102.4,y:437.675}).wait(1).to({graphics:mask_1_graphics_110,x:-97.25,y:429.775}).wait(1).to({graphics:mask_1_graphics_111,x:-92.25,y:422.125}).wait(1).to({graphics:mask_1_graphics_112,x:-87.35,y:414.625}).wait(1).to({graphics:mask_1_graphics_113,x:-82.6,y:407.325}).wait(1).to({graphics:mask_1_graphics_114,x:-77.95,y:400.225}).wait(1).to({graphics:mask_1_graphics_115,x:-73.45,y:393.325}).wait(1).to({graphics:mask_1_graphics_116,x:-69.05,y:386.625}).wait(1).to({graphics:mask_1_graphics_117,x:-64.8,y:380.075}).wait(1).to({graphics:mask_1_graphics_118,x:-60.65,y:373.775}).wait(1).to({graphics:mask_1_graphics_119,x:-56.65,y:367.675}).wait(1).to({graphics:mask_1_graphics_120,x:-52.8,y:361.725}).wait(1).to({graphics:mask_1_graphics_121,x:-49.05,y:355.975}).wait(1).to({graphics:mask_1_graphics_122,x:-45.45,y:350.475}).wait(1).to({graphics:mask_1_graphics_123,x:-41.95,y:345.125}).wait(1).to({graphics:mask_1_graphics_124,x:-38.6,y:339.975}).wait(1).to({graphics:mask_1_graphics_125,x:-35.35,y:335.025}).wait(1).to({graphics:mask_1_graphics_126,x:-32.25,y:330.275}).wait(1).to({graphics:mask_1_graphics_127,x:-29.3,y:325.725}).wait(1).to({graphics:mask_1_graphics_128,x:-26.4,y:321.375}).wait(1).to({graphics:mask_1_graphics_129,x:-23.7,y:317.225}).wait(1).to({graphics:mask_1_graphics_130,x:-21.1,y:313.225}).wait(1).to({graphics:mask_1_graphics_131,x:-18.65,y:309.475}).wait(1).to({graphics:mask_1_graphics_132,x:-16.3,y:305.875}).wait(1).to({graphics:mask_1_graphics_133,x:-14.1,y:302.525}).wait(1).to({graphics:mask_1_graphics_134,x:-12.05,y:299.325}).wait(1).to({graphics:mask_1_graphics_135,x:-10.1,y:296.325}).wait(1).to({graphics:mask_1_graphics_136,x:-8.25,y:293.525}).wait(1).to({graphics:mask_1_graphics_137,x:-6.55,y:290.925}).wait(1).to({graphics:mask_1_graphics_138,x:-5,y:288.525}).wait(1).to({graphics:mask_1_graphics_139,x:-3.55,y:286.325}).wait(1).to({graphics:mask_1_graphics_140,x:-2.25,y:284.325}).wait(1).to({graphics:mask_1_graphics_141,x:-1.05,y:282.525}).wait(178));

	// Txt_Frame_02
	this.instance_3 = new lib.text_02();
	this.instance_3.setTransform(68.35,391.1,0.7293,0.7293);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(85).to({_off:false},0).to({alpha:1},12).wait(222));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(143).to({_off:false},0).to({regY:-137,scaleX:1.3179,scaleY:1.3179,x:855.6,y:236.75},67).to({_off:true},1).wait(108));

	// diagonal
	this.instance_5 = new lib.diagonal_mask();
	this.instance_5.setTransform(409.25,465.6,0.9469,0.9469,0,0,180,-0.4,1.1);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(71).to({_off:false},0).to({regX:-0.3,scaleX:1.4497,scaleY:1.4497,x:-236.85,y:-479.55},71).to({_off:true},1).wait(176));

	// baby
	this.instance_6 = new lib.baby_mc("synched",0);
	this.instance_6.setTransform(76.6,128.8,0.6731,0.6731,0,0,0,17.2,56);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(100).to({_off:false},0).wait(219));

	// background_pink
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#A1C1E6").s().p("EhvvgGmMBiYhpAMB9HB2NMhiYBpAg");
	this.shape_3.setTransform(-393.05,882.525);
	this.shape_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(71).to({_off:false},0).wait(1).to({x:-383.05,y:867.175},0).wait(1).to({x:-373.15,y:852.075},0).wait(1).to({x:-363.4,y:837.125},0).wait(1).to({x:-353.75,y:822.375},0).wait(1).to({x:-344.25,y:807.825},0).wait(1).to({x:-334.85,y:793.475},0).wait(1).to({x:-325.6,y:779.325},0).wait(1).to({x:-316.5,y:765.375},0).wait(1).to({x:-307.5,y:751.575},0).wait(1).to({x:-298.65,y:738.025},0).wait(1).to({x:-289.9,y:724.675},0).wait(1).to({x:-281.3,y:711.475},0).wait(1).to({x:-272.8,y:698.525},0).wait(1).to({x:-264.45,y:685.725},0).wait(1).to({x:-256.25,y:673.125},0).wait(1).to({x:-248.15,y:660.725},0).wait(1).to({x:-240.2,y:648.525},0).wait(1).to({x:-232.35,y:636.525},0).wait(1).to({x:-224.65,y:624.725},0).wait(1).to({x:-217.05,y:613.125},0).wait(1).to({x:-209.6,y:601.725},0).wait(1).to({x:-202.25,y:590.475},0).wait(1).to({x:-195.05,y:579.475},0).wait(1).to({x:-188,y:568.675},0).wait(1).to({x:-181.05,y:558.025},0).wait(1).to({x:-174.25,y:547.575},0).wait(1).to({x:-167.55,y:537.375},0).wait(1).to({x:-161,y:527.325},0).wait(1).to({x:-154.55,y:517.475},0).wait(1).to({x:-148.25,y:507.825},0).wait(1).to({x:-142.05,y:498.375},0).wait(1).to({x:-136.05,y:489.125},0).wait(1).to({x:-130.1,y:480.075},0).wait(1).to({x:-124.3,y:471.175},0).wait(1).to({x:-118.65,y:462.525},0).wait(1).to({x:-113.1,y:454.025},0).wait(1).to({x:-107.7,y:445.775},0).wait(1).to({x:-102.4,y:437.675},0).wait(1).to({x:-97.25,y:429.775},0).wait(1).to({x:-92.25,y:422.125},0).wait(1).to({x:-87.35,y:414.625},0).wait(1).to({x:-82.6,y:407.325},0).wait(1).to({x:-77.95,y:400.225},0).wait(1).to({x:-73.45,y:393.325},0).wait(1).to({x:-69.05,y:386.625},0).wait(1).to({x:-64.8,y:380.075},0).wait(1).to({x:-60.65,y:373.775},0).wait(1).to({x:-56.65,y:367.675},0).wait(1).to({x:-52.8,y:361.725},0).wait(1).to({x:-49.05,y:355.975},0).wait(1).to({x:-45.45,y:350.475},0).wait(1).to({x:-41.95,y:345.125},0).wait(1).to({x:-38.6,y:339.975},0).wait(1).to({x:-35.35,y:335.025},0).wait(1).to({x:-32.25,y:330.275},0).wait(1).to({x:-29.3,y:325.725},0).wait(1).to({x:-26.4,y:321.375},0).wait(1).to({x:-23.7,y:317.225},0).wait(1).to({x:-21.1,y:313.225},0).wait(1).to({x:-18.65,y:309.475},0).wait(1).to({x:-16.3,y:305.875},0).wait(1).to({x:-14.1,y:302.525},0).wait(1).to({x:-12.05,y:299.325},0).wait(1).to({x:-10.1,y:296.325},0).wait(1).to({x:-8.25,y:293.525},0).wait(1).to({x:-6.55,y:290.925},0).wait(1).to({x:-5,y:288.525},0).wait(1).to({x:-3.55,y:286.325},0).wait(1).to({x:-2.25,y:284.325},0).wait(1).to({x:-1.05,y:282.525},0).wait(178));

	// diagonal
	this.instance_7 = new lib.diagonal_mask();
	this.instance_7.setTransform(276.25,646.6,0.9469,0.9469,0,0,180,-0.4,1.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({regY:1.2,scaleX:1.2533,scaleY:1.2533,x:-48.7,y:-325.3},49).to({_off:true},1).wait(269));

	// diagonal
	this.instance_8 = new lib.diagonal_mask();
	this.instance_8.setTransform(-167.95,606.25,0.9469,0.9469,0,0,0,-0.5,1.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({regX:-0.4,regY:1.2,scaleX:1.3619,scaleY:1.3619,x:368.2,y:-407.3},57).to({_off:true},1).wait(261));

	// diagonal_mask
	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#B482BA").s().p("EhW1gEFMAwjgwhIAHgHMAiTgiTMBauBbGMhS9BS7g");
	this.shape_4.setTransform(241.125,335.4);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#B482BA").s().p("EhW1gEFMBS9hS7MBauBbGMhS9BS7g");
	this.shape_5.setTransform(249.875,348);
	this.shape_5._off = true;

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#B482BA").s().p("EhW1gEFMBS9hS7MBauBbGMhS9BS6g");
	this.shape_6.setTransform(258.575,360.65);
	this.shape_6._off = true;

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#B482BA").s().p("EhW1gEFMBS9hS6MBauBbFMhS9BS7g");
	this.shape_7.setTransform(293.525,411.1);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#B482BA").s().p("EhW1gEFMBS9hS6MBauBbFMhS9BS6g");
	this.shape_8.setTransform(302.275,423.7);
	this.shape_8._off = true;

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_4}]}).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7,p:{x:293.525,y:411.1}}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_7,p:{x:319.725,y:448.9}}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_7,p:{x:642.925,y:915.55}}]},1).to({state:[{t:this.shape_7,p:{x:651.675,y:928.15}}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).wait(270));
	this.timeline.addTween(cjs.Tween.get(this.shape_5).wait(1).to({_off:false},0).to({_off:true},1).wait(8).to({_off:false,x:328.475,y:461.55},0).wait(1).to({x:337.225,y:474.15},0).wait(1).to({x:345.925,y:486.75},0).to({_off:true},1).wait(6).to({_off:false,x:407.075,y:575.05},0).wait(1).to({x:415.825,y:587.65},0).wait(1).to({x:424.575,y:600.25},0).wait(1).to({x:433.275,y:612.85},0).to({_off:true},1).wait(4).to({_off:false,x:476.975,y:675.95},0).wait(1).to({x:485.675,y:688.55},0).wait(1).to({x:494.425,y:701.15},0).wait(1).to({x:503.175,y:713.75},0).to({_off:true},1).wait(5).to({_off:false,x:555.575,y:789.45},0).wait(1).to({x:564.325,y:802.05},0).wait(1).to({x:573.025,y:814.65},0).wait(1).to({x:581.775,y:827.25},0).to({_off:true},1).wait(8).to({_off:false,x:660.375,y:940.8},0).wait(1).to({x:669.125,y:953.4},0).wait(270));
	this.timeline.addTween(cjs.Tween.get(this.shape_6).wait(2).to({_off:false},0).wait(1).to({x:267.325,y:373.25},0).wait(1).to({x:276.075,y:385.85},0).wait(1).to({x:284.775,y:398.45},0).to({_off:true},1).wait(7).to({_off:false,x:354.675,y:499.35},0).to({_off:true},1).wait(26).to({_off:false,x:590.525,y:839.9},0).wait(1).to({x:599.225,y:852.5},0).wait(1).to({x:607.975,y:865.1},0).to({_off:true},1).wait(276));
	this.timeline.addTween(cjs.Tween.get(this.shape_8).wait(7).to({_off:false},0).wait(1).to({x:311.025,y:436.3},0).to({_off:true},1).wait(5).to({_off:false,x:363.425,y:512},0).wait(1).to({x:372.125,y:524.6},0).wait(1).to({x:380.875,y:537.2},0).wait(1).to({x:389.625,y:549.8},0).wait(1).to({x:398.325,y:562.4},0).to({_off:true},1).wait(4).to({_off:false,x:442.025,y:625.5},0).wait(1).to({x:450.775,y:638.1},0).wait(1).to({x:459.475,y:650.7},0).wait(1).to({x:468.225,y:663.3},0).to({_off:true},1).wait(4).to({_off:false,x:511.925,y:726.4},0).wait(1).to({x:520.625,y:739},0).wait(1).to({x:529.375,y:751.6},0).wait(1).to({x:538.125,y:764.2},0).wait(1).to({x:546.825,y:776.8},0).to({_off:true},1).wait(7).to({_off:false,x:616.725,y:877.7},0).wait(1).to({x:625.475,y:890.35},0).wait(1).to({x:634.175,y:902.95},0).to({_off:true},1).wait(273));

	// Txt_Frame_01
	this.instance_9 = new lib.text_01("synched",14);
	this.instance_9.setTransform(67.65,412.8,0.7267,0.7267,0,0,0,0.4,0.3);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(20).to({_off:false},0).to({alpha:1,startPosition:29},15).wait(284));

	// stork
	this.instance_10 = new lib.stork_mc("synched",0);
	this.instance_10.setTransform(74.35,129.3,0.7472,0.7472,0,0,0,139.6,124);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(3).to({_off:false},0).wait(316));

	// background_blue
	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#7CE0D3").s().p("EgdmAz4MAAAhnvMA7NAAAMAAABnvg");
	this.shape_9.setTransform(153.525,307.025);

	this.timeline.addTween(cjs.Tween.get(this.shape_9).wait(319));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-1028.2,-972.3,2860.7,2569.1);
// library properties:
lib.properties = {
