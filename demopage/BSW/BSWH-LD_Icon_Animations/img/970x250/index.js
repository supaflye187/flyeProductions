...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,596,1160,204],[1162,596,266,77],[0,802,983,176],[0,0,1814,594],[985,802,605,152]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(102.525,73.55);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.text_02, new cjs.Rectangle(-54.8,43.4,314.7,60.300000000000004), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-69.55,-13.75,0.2964,0.2964);
...
p.nominalBounds = new cjs.Rectangle(-69.5,-13.7,343.8,60.400000000000006);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(485.5032,125.5035,1.001,1.004);
	...
	this.instance.setTransform(670.6,108.2,1.7539,1.7539,0,0,0,0.1,0.1);
	...
	this.instance_3.setTransform(135.95,-10.3,1.7384,1.7384,0,0,0,0.1,0.1);
	...
	this.instance_6.setTransform(831.8,107.95,0.9088,0.9088,0,0,0,17.5,56.1);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(116).to({_off:false},0).wait(203));
	...
	this.instance_9.setTransform(157.5,89.75,1.6868,1.6868,0,0,0,0.1,0.1);
	...
	this.instance_10.setTransform(822.35,123.15,1.1324,1.1324,0,0,0,139.6,123.8);
