...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[607,596,391,76],[0,0,1814,594],[0,596,605,152]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0,3.4,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.BSWH_Logo_H, new cjs.Rectangle(0,3.4,1051.5,188), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(137.7,11.5,0.147,0.147);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(198).to({_off:false},0).to({regY:0.7,scaleX:0.1467,scaleY:0.1467,x:181.25},34,cjs.Ease.quadOut).wait(116));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(109).to({_off:false},0).to({alpha:1},12).wait(227));
	...
	// diagonal
	this.instance_6 = new lib.diagonal_mask();
	this.instance_6.setTransform(654.6,-109.4,0.5269,0.5269,0,0,180,-0.5,1.1);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(4).to({_off:false},0).to({regX:-0.3,regY:1,scaleX:0.5032,scaleY:0.5032,x:-58.55,y:-103.2},62).to({_off:true},1).wait(281));

	// diagonal
	this.instance_7 = new lib.diagonal_mask();
	this.instance_7.setTransform(-456.9,-89.85,0.4751,0.4751,0,0,0,-0.4,1.2);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(4).to({_off:false},0).to({x:357.1,y:-92.85},66).to({_off:true},1).wait(277));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(4).to({_off:false},0).to({alpha:1},15).wait(329));
