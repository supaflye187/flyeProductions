...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-30.75,-8.675);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.BSWH_Logo_Dallas, new cjs.Rectangle(-147.9,-33.3,234.4,49.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(66).to({_off:false},0).wait(1).to({y:202.3,alpha:0.1103},0).wait(1).to({y:199.8,alpha:0.2213},0).wait(1).to({y:197.35,alpha:0.3294},0).wait(1).to({y:195.05,alpha:0.4313},0).wait(1).to({y:192.95,alpha:0.5248},0).wait(1).to({y:191.05,alpha:0.6086},0).wait(1).to({y:189.4,alpha:0.6823},0).wait(1).to({y:187.95,alpha:0.7464},0).wait(1).to({y:186.7,alpha:0.8014},0).wait(1).to({y:185.65,alpha:0.8482},0).wait(1).to({y:184.75,alpha:0.8875},0).wait(1).to({y:184.05,alpha:0.9201},0).wait(1).to({y:183.45,alpha:0.9467},0).wait(1).to({y:182.95,alpha:0.9679},0).wait(1).to({y:182.6,alpha:0.9844},0).to({_off:true},1).wait(226));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(63).to({_off:false},0).to({y:151.75,alpha:1},17,cjs.Ease.quadOut).wait(1).to({_off:true},1).wait(226));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(60).to({_off:false},0).to({y:122.3,alpha:1},17,cjs.Ease.quadOut).wait(4).to({_off:true},1).wait(226));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(56).to({_off:false},0).to({y:122.45,alpha:1},18,cjs.Ease.quadOut).wait(7).to({_off:true},1).wait(226));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(37).to({_off:false},0).to({y:90.5,alpha:1},17,cjs.Ease.quadOut).wait(27).to({_off:true},1).wait(226));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(34).to({_off:false},0).to({y:89.9,alpha:1},17,cjs.Ease.quadOut).wait(30).to({_off:true},1).wait(226));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(31).to({_off:false},0).to({y:60.4,alpha:1},17,cjs.Ease.quadOut).wait(33).to({_off:true},1).wait(226));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(28).to({_off:false},0).to({y:60.3,alpha:1},17,cjs.Ease.quadOut).wait(36).to({_off:true},1).wait(226));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(9).to({_off:false},0).to({y:29.05,alpha:1},17,cjs.Ease.quadOut).wait(55).to({_off:true},1).wait(226));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(6).to({_off:false},0).to({y:-0.45,alpha:1},17,cjs.Ease.quadOut).wait(58).to({_off:true},1).wait(226));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(3).to({_off:false},0).to({y:-0.5,alpha:1},17,cjs.Ease.quadOut).wait(61).to({_off:true},1).wait(226));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({y:-0.35,alpha:1},17,cjs.Ease.quadOut).wait(64).to({_off:true},1).wait(226));
...
// stage content:
(lib.BSWH_DigestiveHealth_04_AllSaints_300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(11).to({_off:false},0).to({alpha:1},9).wait(175));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(1).to({y:-46.9},0).wait(1).to({y:-28.75},0).wait(1).to({y:-12.55},0).wait(1).to({y:1.8},0).wait(1).to({y:14.2},0).wait(1).to({y:24.7},0).wait(1).to({y:33.3},0).wait(1).to({y:39.95},0).wait(1).to({y:44.75},0).wait(1).to({y:47.6},0).wait(1).to({y:48.55},0).wait(184));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(11).to({_off:false},0).to({alpha:1},10).wait(174));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(11).to({_off:false},0).to({alpha:1},10).wait(174));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(15).to({_off:false},0).to({regY:0.1,y:553.45,alpha:1,mode:"synched",loop:false},11,cjs.Ease.quadOut).wait(75).to({mode:"single",startPosition:49},0).wait(94));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(20).to({_off:false},0).wait(81).to({mode:"single",startPosition:81},0).wait(94));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(101).to({_off:false},0).to({regX:0.2,regY:0.7,scaleX:0.0741,scaleY:0.0741,rotation:15.9551,x:237.05,alpha:1},7,cjs.Ease.quadOut).to({regX:0.1,regY:0.6,scaleX:0.0856,scaleY:0.0856,rotation:15.9622},4,cjs.Ease.quadOut).wait(83));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(11).to({_off:false},0).to({y:600.2},14,cjs.Ease.quadOut).wait(170));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2,p:{y:676.3}}]}).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4,p:{y:606.55}}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4,p:{y:558.85}}]},1).to({state:[{t:this.shape_4,p:{y:547.85}}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_2,p:{y:528.25}}]},1).wait(184));
	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(1).to({_off:false},0).wait(1).to({y:627.35},0).to({_off:true},1).wait(1).to({_off:false,y:588.2},0).wait(1).to({y:572.3},0).to({_off:true},1).wait(2).to({_off:false,y:539.25},0).wait(1).to({y:533.15},0).wait(1).to({y:529.45},0).to({_off:true},1).wait(184));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_5,p:{y:676.3}}]}).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7,p:{y:606.55}}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7,p:{y:558.85}}]},1).to({state:[{t:this.shape_7,p:{y:547.85}}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_5,p:{y:528.25}}]},1).wait(184));
	this.timeline.addTween(cjs.Tween.get(this.shape_6).wait(1).to({_off:false},0).wait(1).to({y:627.35},0).to({_off:true},1).wait(1).to({_off:false,y:588.2},0).wait(1).to({y:572.3},0).to({_off:true},1).wait(2).to({_off:false,y:539.25},0).wait(1).to({y:533.15},0).wait(1).to({y:529.45},0).to({_off:true},1).wait(184));
