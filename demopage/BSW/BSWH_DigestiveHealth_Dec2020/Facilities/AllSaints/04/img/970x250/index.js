...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(584.175,119.8);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.BSWH_Logo_Dallas, new cjs.Rectangle(420.9,85.4,326.6,68.79999999999998), null);
...
// stage content:
(lib.BSWH_DigestiveHealth_04_AllSaints_970x250 = function(mode,startPosition,loop,reversed) {
