...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.txt_deepBreath).to({x:-68.45},284,cjs.Ease.quadOut).wait(54));
	...
	this.timeline.addTween(cjs.Tween.get(this.txt_deepBreath_1).to({x:-68.45},284,cjs.Ease.quadOut).to({alpha:0},5).wait(49));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(289).to({_off:false},0).to({regX:2.1,regY:2.7,scaleX:0.1102,scaleY:0.1102,rotation:15.7416,x:887.55,y:54.7,alpha:1},7,cjs.Ease.quadOut).to({regX:2,regY:3,scaleX:0.1299,scaleY:0.1299,rotation:15.7429,x:887.6},4,cjs.Ease.quadOut).wait(38));
