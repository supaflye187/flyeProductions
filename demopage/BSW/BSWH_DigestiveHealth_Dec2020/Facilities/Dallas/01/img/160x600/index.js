...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-86.5911,-26.5722,0.5631,0.5631);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.BSWH_Logo_Dallas, new cjs.Rectangle(-161,-40.5,148.8,27.9), null);
...
// stage content:
(lib.BSWH_DigestiveHealth_01_Dallas_160x600_v02 = function(mode,startPosition,loop,reversed) {
