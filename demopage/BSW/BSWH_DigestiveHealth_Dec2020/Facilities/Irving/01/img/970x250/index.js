...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.txt_deepBreath).to({x:-70.45},283,cjs.Ease.quadOut).wait(55));
	...
	this.timeline.addTween(cjs.Tween.get(this.txt_deepBreath_1).to({x:-70.45},283,cjs.Ease.quadOut).to({alpha:0},4).wait(51));
...
p.nominalBounds = new cjs.Rectangle(-335.8,83.5,2817.4,311.5);
// library properties:
lib.properties = {
