...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-85.975,-26.475);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.BSWH_Logo_Dallas, new cjs.Rectangle(-152,-40.4,132.1,27.9), null);
...
// stage content:
(lib.BSWH_DigestiveHealth_03_Irving_160x600 = function(mode,startPosition,loop,reversed) {
