...
if (reversed == null) { reversed = false; }
	...
	// BSWH_Logo
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-87.025,-26.275);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.BSWH_Logo_Dallas, new cjs.Rectangle(-153,-40.2,132,27.900000000000002), null);
...
// stage content:
(lib.BSWH_DigestiveHealth_03_Mckinney_160x600 = function(mode,startPosition,loop,reversed) {
