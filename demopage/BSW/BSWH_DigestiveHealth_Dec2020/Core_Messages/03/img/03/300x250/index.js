...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-63.5336,165.9543,0.6839,0.6839);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.BSWH_Logo_Dallas, new cjs.Rectangle(-153.9,149,180.8,34), null);
...
// stage content:
(lib.BSWH_DigestiveHealth_03_300x250 = function(mode,startPosition,loop,reversed) {
