...
p.nominalBounds = new cjs.Rectangle(0,0,370,90);// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(24.725,-28.025);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_qualityCare, new cjs.Rectangle(-120.5,-54.3,290.5,52.599999999999994), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-29.7,92.025);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_earlyDetection, new cjs.Rectangle(-121.9,66.7,184.5,50.7), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(5.025,-27.925);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_cancerHatesFighters, new cjs.Rectangle(-119,-53.7,248.1,51.6), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-22.35,-28.625);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_advancedTreatment, new cjs.Rectangle(-119.9,-54.8,195.10000000000002,52.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#008FBE").s().p("A9DHMIAAuXMA6HAAAIAAOXg");
	this.shape.setTransform(33.5,-151.275);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.image_04, new cjs.Rectangle(-152.5,-197.2,372,91.89999999999999), null);
...
}).prototype = getMCSymbolPrototype(lib.image_03, new cjs.Rectangle(-150,-196.5,370,90), null);
...
}).prototype = getMCSymbolPrototype(lib.image_02, new cjs.Rectangle(-150,-196.5,370,90), null);
...
}).prototype = getMCSymbolPrototype(lib.image_01, new cjs.Rectangle(-150,-196.5,370,90), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#3C8EBA").s().p("");
	this.shape.setTransform(-35.25,19.525);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#1140A0").s().p("");
	this.shape_1.setTransform(38.05,-9.8625);
...
p.nominalBounds = new cjs.Rectangle(-105.2,-28.5,239.60000000000002,50.6);


// stage content:
(lib.BSWH_CancerHatesUs_V3_728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(420.5,78.5,0.6247,0.6247,0,0,0,0.1,0.1);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(319).to({_off:false},0).to({y:47.5,alpha:1},7,cjs.Ease.quadOut).to({y:48.5},6,cjs.Ease.quadOut).wait(23));

	// txt_cancerHatesUs
	this.instance_2 = new lib.txt_cancerHatesUs();
	this.instance_2.setTransform(127.2,-12.85);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(285).to({_off:false},0).to({y:48.3},26,cjs.Ease.quadOut).wait(44));

	// image_mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_275 = new cjs.Graphics().p("A7pFjIAArFMA3TAAAIAALFg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(275).to({graphics:mask_graphics_275,x:186,y:44.55}).wait(80));

	// safeCare_logo
	this.instance_3 = new lib.safeCare_logo();
	this.instance_3.setTransform(315.8,44.45,1.5679,1.5679,-15.231,0,0,0.1,0.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(302).to({_off:false},0).to({regX:0,regY:0.1,scaleX:0.68,scaleY:0.68,rotation:0,x:315.6,y:44.3,alpha:1},9,cjs.Ease.quadOut).to({regY:0,scaleX:0.732,scaleY:0.732,y:44.25},15,cjs.Ease.quadOut).wait(29));

	// image_05
	this.instance_4 = new lib.image_05();
	this.instance_4.setTransform(150.2,105.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(277).to({_off:false},0).wait(1).to({regX:36,regY:-151,x:186.2,y:-23.75},0).wait(1).to({y:-9.1},0).wait(1).to({y:1.55},0).wait(1).to({y:9.65},0).wait(1).to({y:16.05},0).wait(1).to({y:21.2},0).wait(1).to({y:25.4},0).wait(1).to({y:28.85},0).wait(1).to({y:31.7},0).wait(1).to({y:34.15},0).wait(1).to({y:36.15},0).wait(1).to({y:37.85},0).wait(1).to({y:39.25},0).wait(1).to({y:40.5},0).wait(1).to({y:41.5},0).wait(1).to({y:42.35},0).wait(1).to({y:43.05},0).wait(1).to({y:43.65},0).wait(1).to({y:44.15},0).wait(1).to({y:44.6},0).wait(1).to({y:44.95},0).wait(1).to({y:45.2},0).wait(1).to({y:45.45},0).wait(1).to({y:45.6},0).wait(1).to({y:45.75},0).wait(1).to({y:45.85},0).wait(1).to({y:45.95},0).wait(1).to({y:46},0).wait(2).to({y:46.05},0).wait(4).to({regX:0,regY:0,x:150.2,y:197.1},0).wait(44));

	// txt_qualityCare
	this.instance_5 = new lib.txt_qualityCare();
	this.instance_5.setTransform(127.2,-1.85);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(217).to({_off:false},0).to({y:62.65},26,cjs.Ease.quadOut).wait(112));

	// image_mask (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_207 = new cjs.Graphics().p("A7pFjIAArFMA3TAAAIAALFg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(207).to({graphics:mask_1_graphics_207,x:186,y:44.55}).wait(148));

	// CC_Logo
	this.instance_6 = new lib.CC_Logo();
	this.instance_6.setTransform(322.3,59.75,0.3204,0.3204,0,0,0,0.1,0.1);
	...
	this.instance_7.setTransform(150.2,104.7);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(209).to({_off:false},0).wait(1).to({regX:33.5,regY:-151.3,x:183.7,y:-24.35},0).wait(1).to({y:-9.6},0).wait(1).to({y:1.05},0).wait(1).to({y:9.2},0).wait(1).to({y:15.65},0).wait(1).to({y:20.8},0).wait(1).to({y:25},0).wait(1).to({y:28.45},0).wait(1).to({y:31.35},0).wait(1).to({y:33.75},0).wait(1).to({y:35.8},0).wait(1).to({y:37.5},0).wait(1).to({y:38.95},0).wait(1).to({y:40.15},0).wait(1).to({y:41.2},0).wait(1).to({y:42.05},0).wait(1).to({y:42.75},0).wait(1).to({y:43.35},0).wait(1).to({y:43.85},0).wait(1).to({y:44.3},0).wait(1).to({y:44.6},0).wait(1).to({y:44.9},0).wait(1).to({y:45.1},0).wait(1).to({y:45.3},0).wait(1).to({y:45.45},0).wait(1).to({y:45.55},0).wait(1).to({y:45.65},0).wait(1).to({y:45.7},0).wait(2).to({y:45.75},0).wait(4).to({regX:0,regY:0,x:150.2,y:197.1},0).wait(112));

	// txt_advancedTreatment
	this.instance_8 = new lib.txt_advancedTreatment();
	this.instance_8.setTransform(127.2,-49.35);
	...
	mask_2._off = true;
	var mask_2_graphics_142 = new cjs.Graphics().p("A7pFjIAArFMA3TAAAIAALFg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(142).to({graphics:mask_2_graphics_142,x:186,y:44.55}).wait(213));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(144).to({_off:false},0).wait(1).to({regX:35,regY:-151.5,x:185.2,y:-244.6},0).wait(1).to({y:-183.65},0).wait(1).to({y:-139.45},0).wait(1).to({y:-105.7},0).wait(1).to({y:-79.15},0).wait(1).to({y:-57.8},0).wait(1).to({y:-40.4},0).wait(1).to({y:-26},0).wait(1).to({y:-14.1},0).wait(1).to({y:-4.1},0).wait(1).to({y:4.3},0).wait(1).to({y:11.35},0).wait(1).to({y:17.3},0).wait(1).to({y:22.3},0).wait(1).to({y:26.55},0).wait(1).to({y:30.1},0).wait(1).to({y:33.1},0).wait(1).to({y:35.6},0).wait(1).to({y:37.65},0).wait(1).to({y:39.4},0).wait(1).to({y:40.8},0).wait(1).to({y:41.95},0).wait(1).to({y:42.9},0).wait(1).to({y:43.6},0).wait(1).to({y:44.2},0).wait(1).to({y:44.65},0).wait(1).to({y:44.95},0).wait(1).to({y:45.2},0).wait(1).to({y:45.35},0).wait(1).to({y:45.45},0).wait(1).to({y:45.55},0).wait(3).to({regX:0,regY:0,x:150.2,y:197.1},0).wait(177));

	// txt_earlyDetection
	this.instance_10 = new lib.txt_earlyDetection();
	this.instance_10.setTransform(129.7,-168.35);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(87).to({_off:false},0).to({y:-58.35},26,cjs.Ease.quadOut).wait(242));

	// image_mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_77 = new cjs.Graphics().p("A7pFjIAArFMA3TAAAIAALFg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(77).to({graphics:mask_3_graphics_77,x:186,y:44.55}).wait(278));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(79).to({_off:false},0).wait(1).to({regX:35,regY:-151.5,x:185.2,y:-244.6},0).wait(1).to({y:-183.65},0).wait(1).to({y:-139.45},0).wait(1).to({y:-105.7},0).wait(1).to({y:-79.15},0).wait(1).to({y:-57.8},0).wait(1).to({y:-40.4},0).wait(1).to({y:-26},0).wait(1).to({y:-14.1},0).wait(1).to({y:-4.1},0).wait(1).to({y:4.3},0).wait(1).to({y:11.35},0).wait(1).to({y:17.3},0).wait(1).to({y:22.3},0).wait(1).to({y:26.55},0).wait(1).to({y:30.1},0).wait(1).to({y:33.1},0).wait(1).to({y:35.6},0).wait(1).to({y:37.65},0).wait(1).to({y:39.4},0).wait(1).to({y:40.8},0).wait(1).to({y:41.95},0).wait(1).to({y:42.9},0).wait(1).to({y:43.6},0).wait(1).to({y:44.2},0).wait(1).to({y:44.65},0).wait(1).to({y:44.95},0).wait(1).to({y:45.2},0).wait(1).to({y:45.35},0).wait(1).to({y:45.45},0).wait(1).to({y:45.55},0).wait(3).to({regX:0,regY:0,x:150.2,y:197.1},0).wait(242));

	// txt_cancerHatesFighters
	this.instance_12 = new lib.txt_cancerHatesFighters();
	this.instance_12.setTransform(127.2,-48.35);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(22).to({_off:false},0).to({y:62.15},26,cjs.Ease.quadOut).wait(307));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({regX:35,regY:-151.5,x:185.2,y:-244.6},0).wait(1).to({y:-183.65},0).wait(1).to({y:-139.45},0).wait(1).to({y:-105.7},0).wait(1).to({y:-79.15},0).wait(1).to({y:-57.8},0).wait(1).to({y:-40.4},0).wait(1).to({y:-26},0).wait(1).to({y:-14.1},0).wait(1).to({y:-4.1},0).wait(1).to({y:4.3},0).wait(1).to({y:11.35},0).wait(1).to({y:17.3},0).wait(1).to({y:22.3},0).wait(1).to({y:26.55},0).wait(1).to({y:30.1},0).wait(1).to({y:33.1},0).wait(1).to({y:35.6},0).wait(1).to({y:37.65},0).wait(1).to({y:39.4},0).wait(1).to({y:40.8},0).wait(1).to({y:41.95},0).wait(1).to({y:42.9},0).wait(1).to({y:43.6},0).wait(1).to({y:44.2},0).wait(1).to({y:44.65},0).wait(1).to({y:44.95},0).wait(1).to({y:45.2},0).wait(1).to({y:45.35},0).wait(1).to({y:45.45},0).wait(1).to({y:45.55},0).wait(3).to({regX:0,regY:0,x:150.2,y:197.1},0).wait(307));
...
p.nominalBounds = new cjs.Rectangle(363,-59.1,366,165.9);
// library properties:
lib.properties = {
