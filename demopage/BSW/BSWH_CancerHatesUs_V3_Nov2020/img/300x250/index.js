...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-107.175,-15);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(-51.025,-28.325);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_qualityCare, new cjs.Rectangle(-118.5,-53.3,135,50.3), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgbB1IAAhiIhNiHIA9AAIAsBUIAshUIA7AAIhMCIIAABhg");
	this.shape.setTransform(-31.4,-41.175);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(-28.7,-27.975);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_earlyDetection, new cjs.Rectangle(-117.7,-52.8,178,49.699999999999996), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-42.55,10.725);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(-51.575,-28.15);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_cancerHatesFighters, new cjs.Rectangle(-117.9,-53.2,150.8,76), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("AgZBxIAAivIg+AAIAAgyICuAAIAAAyIg8AAIAACvg");
	this.shape.setTransform(-109.1,-15.375);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("");
	this.shape_1.setTransform(-25.9,-28.175);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_advancedTreatment, new cjs.Rectangle(-118.9,-52.3,186,48.3), null);
...
}).prototype = getMCSymbolPrototype(lib.image_04, new cjs.Rectangle(-150,-196.5,300,189), null);
...
}).prototype = getMCSymbolPrototype(lib.image_03, new cjs.Rectangle(-150,-196.5,300,189), null);
...
}).prototype = getMCSymbolPrototype(lib.image_02, new cjs.Rectangle(-150,-196.5,300,189), null);
...
}).prototype = getMCSymbolPrototype(lib.image_01, new cjs.Rectangle(-150,-196.5,300,189), null);
...
if (reversed == null) { reversed = false; }
	...
	// BSWH_Logo
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#3C8EBA").s().p("");
	this.shape.setTransform(-27.775,30.65);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#1140A0").s().p("");
	this.shape_1.setTransform(25.95,9.1125);
...
p.nominalBounds = new cjs.Rectangle(-80.1,-4.3,176.6,36.9);


// stage content:
(lib.BSWH_CancerHatesUs_V3_300x250 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(55.05,251.95,0.6053,0.6053,0,0,0,0.1,0);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(319).to({_off:false},0).to({y:219.45,alpha:1},7,cjs.Ease.quadOut).to({y:219.95},6,cjs.Ease.quadOut).wait(23));

	// txt_cancerHatesUs
	this.instance_2 = new lib.txt_cancerHatesUs();
	this.instance_2.setTransform(124.7,-45.2);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(285).to({_off:false},0).to({y:141.05},26,cjs.Ease.quadOut).wait(44));

	// image_mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_275 = new cjs.Graphics().p("A1tN6IAA7zMArbAAAIAAbzg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(275).to({graphics:mask_graphics_275,x:150,y:99.05}).wait(80));

	// safeCare_logo
	this.instance_3 = new lib.safeCare_logo();
	this.instance_3.setTransform(227.35,61.15,2.7404,2.7404,7.2009,0,0,0.3,0.3);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(302).to({_off:false},0).to({regX:0.1,regY:0.2,scaleX:0.9312,scaleY:0.9312,rotation:0,x:227.05,alpha:1},9,cjs.Ease.quadOut).to({scaleX:1.0051,scaleY:1.0051,x:227,y:61.1},15,cjs.Ease.quadOut).wait(29));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(277).to({_off:false},0).wait(1).to({regY:3,y:-152.85},0).wait(1).to({y:-121.8},0).wait(1).to({y:-99.25},0).wait(1).to({y:-82.05},0).wait(1).to({y:-68.5},0).wait(1).to({y:-57.6},0).wait(1).to({y:-48.7},0).wait(1).to({y:-41.4},0).wait(1).to({y:-35.3},0).wait(1).to({y:-30.2},0).wait(1).to({y:-25.95},0).wait(1).to({y:-22.35},0).wait(1).to({y:-19.3},0).wait(1).to({y:-16.75},0).wait(1).to({y:-14.6},0).wait(1).to({y:-12.75},0).wait(1).to({y:-11.25},0).wait(1).to({y:-9.95},0).wait(1).to({y:-8.9},0).wait(1).to({y:-8.05},0).wait(1).to({y:-7.3},0).wait(1).to({y:-6.7},0).wait(1).to({y:-6.25},0).wait(1).to({y:-5.85},0).wait(1).to({y:-5.6},0).wait(1).to({y:-5.35},0).wait(1).to({y:-5.2},0).wait(1).to({y:-5.05},0).wait(1).to({y:-5},0).wait(1).to({y:-4.95},0).wait(1).to({y:-4.9},0).wait(3).to({regY:0,y:-7.9},0).wait(44));

	// txt_qualityCare
	this.instance_5 = new lib.txt_qualityCare();
	this.instance_5.setTransform(127.2,-43.85);
	...
	mask_1._off = true;
	var mask_1_graphics_207 = new cjs.Graphics().p("A1tN6IAA7zMArbAAAIAAbzg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(207).to({graphics:mask_1_graphics_207,x:150,y:99.05}).wait(148));

	// CC_Logo
	this.instance_6 = new lib.CC_Logo();
	this.instance_6.setTransform(55.8,162.35,0.2989,0.2989,0,0,0,0.1,0.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(209).to({_off:false},0).wait(1).to({regY:-102,y:-195.1},0).wait(1).to({y:-134.15},0).wait(1).to({y:-89.95},0).wait(1).to({y:-56.2},0).wait(1).to({y:-29.65},0).wait(1).to({y:-8.3},0).wait(1).to({y:9.1},0).wait(1).to({y:23.5},0).wait(1).to({y:35.4},0).wait(1).to({y:45.4},0).wait(1).to({y:53.8},0).wait(1).to({y:60.85},0).wait(1).to({y:66.8},0).wait(1).to({y:71.8},0).wait(1).to({y:76.05},0).wait(1).to({y:79.6},0).wait(1).to({y:82.6},0).wait(1).to({y:85.1},0).wait(1).to({y:87.15},0).wait(1).to({y:88.9},0).wait(1).to({y:90.3},0).wait(1).to({y:91.45},0).wait(1).to({y:92.4},0).wait(1).to({y:93.1},0).wait(1).to({y:93.7},0).wait(1).to({y:94.15},0).wait(1).to({y:94.45},0).wait(1).to({y:94.7},0).wait(1).to({y:94.85},0).wait(1).to({y:94.95},0).wait(1).to({y:95.05},0).wait(3).to({regY:0,y:197.1},0).wait(112));

	// txt_advancedTreatment
	this.instance_8 = new lib.txt_advancedTreatment();
	this.instance_8.setTransform(127.2,-44.35);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(152).to({_off:false},0).to({y:60.15},26,cjs.Ease.quadOut).wait(177));

	// image_mask (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_142 = new cjs.Graphics().p("A1tN6IAA7zMArbAAAIAAbzg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(142).to({graphics:mask_2_graphics_142,x:150,y:99.05}).wait(213));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(144).to({_off:false},0).wait(1).to({regY:-102,y:-195.1},0).wait(1).to({y:-134.15},0).wait(1).to({y:-89.95},0).wait(1).to({y:-56.2},0).wait(1).to({y:-29.65},0).wait(1).to({y:-8.3},0).wait(1).to({y:9.1},0).wait(1).to({y:23.5},0).wait(1).to({y:35.4},0).wait(1).to({y:45.4},0).wait(1).to({y:53.8},0).wait(1).to({y:60.85},0).wait(1).to({y:66.8},0).wait(1).to({y:71.8},0).wait(1).to({y:76.05},0).wait(1).to({y:79.6},0).wait(1).to({y:82.6},0).wait(1).to({y:85.1},0).wait(1).to({y:87.15},0).wait(1).to({y:88.9},0).wait(1).to({y:90.3},0).wait(1).to({y:91.45},0).wait(1).to({y:92.4},0).wait(1).to({y:93.1},0).wait(1).to({y:93.7},0).wait(1).to({y:94.15},0).wait(1).to({y:94.45},0).wait(1).to({y:94.7},0).wait(1).to({y:94.85},0).wait(1).to({y:94.95},0).wait(1).to({y:95.05},0).wait(3).to({regY:0,y:197.1},0).wait(177));
	...
	mask_3._off = true;
	var mask_3_graphics_77 = new cjs.Graphics().p("A1tN6IAA7zMArbAAAIAAbzg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(77).to({graphics:mask_3_graphics_77,x:150,y:99.05}).wait(278));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(79).to({_off:false},0).wait(1).to({regY:-102,y:-195.1},0).wait(1).to({y:-134.15},0).wait(1).to({y:-89.95},0).wait(1).to({y:-56.2},0).wait(1).to({y:-29.65},0).wait(1).to({y:-8.3},0).wait(1).to({y:9.1},0).wait(1).to({y:23.5},0).wait(1).to({y:35.4},0).wait(1).to({y:45.4},0).wait(1).to({y:53.8},0).wait(1).to({y:60.85},0).wait(1).to({y:66.8},0).wait(1).to({y:71.8},0).wait(1).to({y:76.05},0).wait(1).to({y:79.6},0).wait(1).to({y:82.6},0).wait(1).to({y:85.1},0).wait(1).to({y:87.15},0).wait(1).to({y:88.9},0).wait(1).to({y:90.3},0).wait(1).to({y:91.45},0).wait(1).to({y:92.4},0).wait(1).to({y:93.1},0).wait(1).to({y:93.7},0).wait(1).to({y:94.15},0).wait(1).to({y:94.45},0).wait(1).to({y:94.7},0).wait(1).to({y:94.85},0).wait(1).to({y:94.95},0).wait(1).to({y:95.05},0).wait(3).to({regY:0,y:197.1},0).wait(242));

	// txt_cancerHatesFighters
	this.instance_12 = new lib.txt_cancerHatesFighters();
	this.instance_12.setTransform(127.2,-69.85);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(15).to({regY:-102,y:-195.1},0).wait(1).to({y:-134.15},0).wait(1).to({y:-89.95},0).wait(1).to({y:-56.2},0).wait(1).to({y:-29.65},0).wait(1).to({y:-8.3},0).wait(1).to({y:9.1},0).wait(1).to({y:23.5},0).wait(1).to({y:35.4},0).wait(1).to({y:45.4},0).wait(1).to({y:53.8},0).wait(1).to({y:60.85},0).wait(1).to({y:66.8},0).wait(1).to({y:71.8},0).wait(1).to({y:76.05},0).wait(1).to({y:79.6},0).wait(1).to({y:82.6},0).wait(1).to({y:85.1},0).wait(1).to({y:87.15},0).wait(1).to({y:88.9},0).wait(1).to({y:90.3},0).wait(1).to({y:91.45},0).wait(1).to({y:92.4},0).wait(1).to({y:93.1},0).wait(1).to({y:93.7},0).wait(1).to({y:94.15},0).wait(1).to({y:94.45},0).wait(1).to({y:94.7},0).wait(1).to({y:94.85},0).wait(1).to({y:94.95},0).wait(1).to({y:95.05},0).wait(3).to({regY:0,y:197.1},0).wait(307));
...
p.nominalBounds = new cjs.Rectangle(149,2,152,277.4);
// library properties:
lib.properties = {
