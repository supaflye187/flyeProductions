...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-210,-17);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_staySafe_1, new cjs.Rectangle(-210,-17,419,34), null);
...
}).prototype = getMCSymbolPrototype(lib.cta_txt, new cjs.Rectangle(-120,-10,250,19), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-54.55,-260.15,1.7364,1.7364,-18.9519,0,0,-66.7,16.2);
	this.instance.alpha = 0.0508;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:-67,regY:16.4,scaleX:0.6756,scaleY:0.6756,rotation:-2.4713,x:-54.7,y:-259.85,alpha:1},4).to({regY:16.5,scaleX:0.7071,scaleY:0.7071,rotation:-2.4712,x:-54.8,y:-259.8},4).wait(488));

	// text_Better
	this.instance_1 = new lib.txt_staySafe_1();
	this.instance_1.setTransform(228.05,-189.65);
...
p.nominalBounds = new cjs.Rectangle(-205.9,-383.1,783.9,247.3);
...
p.nominalBounds = new cjs.Rectangle(-150,-300,730,600);
...
p.nominalBounds = new cjs.Rectangle(-150,-314.9,728,614.9);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(51).to({mode:"independent"},0).to({x:-586},23,cjs.Ease.quadInOut).to({_off:true},1).wait(242));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(51).to({_off:false},0).to({x:149.9,y:300.75,mode:"independent"},23,cjs.Ease.quadInOut).wait(67).to({x:150.05,y:300},0).to({x:-532.95},24,cjs.Ease.quadInOut).to({_off:true},1).wait(151));
...
p.nominalBounds = new cjs.Rectangle(-530,-38.8,2612,638.8);
// library properties:
lib.properties = {
