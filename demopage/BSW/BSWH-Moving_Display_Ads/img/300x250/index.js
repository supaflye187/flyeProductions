...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(-156,-335,1.04,1.0994);
...
p.nominalBounds = new cjs.Rectangle(-156,-335,312,199);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(89.4,-228.8,4.1567,4.1567,-20.2207,0,0,-65.8,15);
	this.instance.alpha = 0.0508;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(3).to({_off:false},0).to({regY:15.2,scaleX:0.7678,scaleY:0.7678,rotation:0.5135,x:89.45,y:-228,alpha:1},4).to({regY:15.3,scaleX:0.8089,scaleY:0.8089,rotation:0.5145,x:89.5,y:-227.95},3).wait(465));

	// txt_staySafe
	this.instance_1 = new lib.txt_staySafe_1();
	this.instance_1.setTransform(-55.75,-236.4,0.8444,0.8444,0,0,0,-1.9,-35.6);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:-248.4,alpha:1},10,cjs.Ease.quadOut).wait(465));

	// txt_healthy
	this.instance_2 = new lib.txt_healthy();
	this.instance_2.setTransform(-53.05,-202.05,0.8421,0.8421,0,0,0,-1.2,4.9);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(3).to({_off:false},0).to({y:-214.05,alpha:1},10,cjs.Ease.quadOut).wait(462));

	// txt_withUs
	this.instance_3 = new lib.txt_withUs();
	this.instance_3.setTransform(-66.55,-170.2,0.8414,0.8414,0,0,0,-1.2,42.7);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(6).to({_off:false},0).to({y:-182.2,alpha:1},10,cjs.Ease.quadOut).wait(459));

	// cta_txt
	this.instance_4 = new lib.cta_txt();
	this.instance_4.setTransform(-69.6,-144,0.5941,0.5941,0,0,0,-0.7,-0.1);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(13).to({_off:false},0).to({alpha:1},14).wait(448));

	// white_bg
	this.instance_5 = new lib.white_box();
	this.instance_5.setTransform(2.05,301.05,1,1,0,0,0,0,-0.5);
...
p.nominalBounds = new cjs.Rectangle(-276.7,-522.1,727.4,822.1);
...
p.nominalBounds = new cjs.Rectangle(-442,125,1634,475);
// library properties:
lib.properties = {
