...
p.nominalBounds = new cjs.Rectangle(-166,-41,312,199);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-64.3,-185.45,8.3348,8.3348,-34.2171,0,0,-66,15.6);
	this.instance.alpha = 0.0508;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(3).to({_off:false},0).to({scaleX:0.9336,scaleY:0.9336,rotation:2.0017,x:-64.35,y:-185.3,alpha:1},4).to({scaleX:0.9737,scaleY:0.9737,rotation:2.0019},3).wait(465));

	// txt_staySafe
	this.instance_1 = new lib.txt_staySafe_1();
	this.instance_1.setTransform(-67.85,-67.35,0.7924,0.7924,0,0,0,-1.9,-35.6);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:-84.85,alpha:1},10,cjs.Ease.quadOut).wait(465));

	// txt_healthy
	this.instance_2 = new lib.txt_healthy();
	this.instance_2.setTransform(-67.2,-35.55,0.7902,0.7902,0,0,0,-1.2,5);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(3).to({_off:false},0).to({y:-53.05,alpha:1},10,cjs.Ease.quadOut).wait(462));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(6).to({_off:false},0).to({y:-22.75,alpha:1},10,cjs.Ease.quadOut).wait(459));
	...
	this.instance_5.setTransform(2.05,352.05,1,1,0,0,0,0,-0.5);
...
p.nominalBounds = new cjs.Rectangle(-815.8,-867.5,1498.1999999999998,1385.7);
...
p.nominalBounds = new cjs.Rectangle(-512,300,1704,500.9);
// library properties:
lib.properties = {
