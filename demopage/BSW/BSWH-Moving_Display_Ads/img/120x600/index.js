...
p.nominalBounds = new cjs.Rectangle(0,0,96,113);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("AvCC2IAAlrIeEAAIAAFrg");
	mask.setTransform(-2.2,22.15);
...
}).prototype = getMCSymbolPrototype(lib.txt_withUs, new cjs.Rectangle(-51,4,96,36.4), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AvCFGIAAkiIeEAAIAAEig");
	mask.setTransform(-2.2,32.6);

	// Layer_4
	this.instance = new lib.txt_staySafe();
	this.instance.setTransform(-53,-54);
...
}).prototype = getMCSymbolPrototype(lib.txt_Us, new cjs.Rectangle(-53,36.2,96,22.799999999999997), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AvCCzIAAllIeEAAIAAFlg");
	mask.setTransform(-2.2,-44.075);
...
}).prototype = getMCSymbolPrototype(lib.txt_staySafe_1, new cjs.Rectangle(-53,-55,96,28.8), null);
...
}).prototype = getMCSymbolPrototype(lib.txt_healthy, new cjs.Rectangle(-53,-24.9,96,29.099999999999998), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-82.7,-169.1,5.3404,5.3404,-32.9128,0,0,-65.7,15.6);
	this.instance.alpha = 0.0508;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(3).to({_off:false},0).to({regX:-66.1,regY:15.4,scaleX:0.7199,scaleY:0.7199,rotation:0.2951,x:-84.4,y:-169.8,alpha:1},4).to({regY:15.5,scaleX:0.7452,scaleY:0.7452,rotation:0.2957},3).wait(465));

	// txt_stay
	this.instance_1 = new lib.txt_staySafe_1();
	this.instance_1.setTransform(-87.85,-65.3,1,1,0,0,0,-4.9,-40.6);
	this.instance_1.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:-81.3,alpha:1},10,cjs.Ease.quadOut).wait(465));

	// txt_safe
	this.instance_2 = new lib.txt_healthy();
	this.instance_2.setTransform(-88.15,-36.7,1,1,0,0,0,-5.2,-10.7);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(3).to({_off:false},0).to({y:-52.7,alpha:1},10,cjs.Ease.quadOut).wait(462));

	// txt_healthy
	this.instance_3 = new lib.txt_withUs();
	this.instance_3.setTransform(-87.15,-6.2,1,1,0,0,0,-2.2,20.7);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(6).to({_off:false},0).to({y:-22.2,alpha:1},10,cjs.Ease.quadOut).wait(459));

	// txt_healthy
	this.instance_4 = new lib.txt_Us();
	this.instance_4.setTransform(-87.15,21.7,1,1,0,0,0,-4.7,47.6);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(9).to({_off:false},0).to({y:5.7,alpha:1},10,cjs.Ease.quadOut).wait(456));

	// cta_txt
	this.instance_5 = new lib.cta_txt();
	this.instance_5.setTransform(-87.05,63.8,0.4893,0.4893,0,0,0,-0.6,0.1);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(13).to({_off:false},0).to({alpha:1},14,cjs.Ease.quadOut).wait(448));

	// white_bg
	this.instance_6 = new lib.white_box();
	this.instance_6.setTransform(2.05,352.05,1,1,0,0,0,0,-0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({y:215.05},16,cjs.Ease.quadOut).to({y:219.05},3).wait(456));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-565.7,-601,959.9000000000001,1111.6);
...
p.nominalBounds = new cjs.Rectangle(-532,300,1724,500.9);
// library properties:
lib.properties = {
