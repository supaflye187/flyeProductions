...
(lib.txt_staySafepngcopy = function() {
	this.initialize(img.txt_staySafepngcopy);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,419,34);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_4
	this.instance = new lib.txt_staySafepngcopy();
	this.instance.setTransform(-266,-26,0.6539,0.6471);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_staySafe, new cjs.Rectangle(-266,-26,274,22), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-120,-10);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.cta_txt, new cjs.Rectangle(-120,-10,176,13), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-142,-33,0.7857,0.7857);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.BSWH_staySafe, new cjs.Rectangle(-142,-33,150.1,99), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape,p:{x:-146.65,y:-261.425}}]},47).to({state:[{t:this.shape,p:{x:-146.45,y:-261.575}}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2,p:{x:-144.9,y:-262.825}}]},1).to({state:[{t:this.shape_3,p:{x:-143.5,y:-263.925}}]},1).to({state:[{t:this.shape_2,p:{x:-141.75,y:-265.375}}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5,p:{x:-137.05,y:-269.175}}]},1).to({state:[{t:this.shape_2,p:{x:-134.1,y:-271.525}}]},1).to({state:[{t:this.shape_5,p:{x:-130.75,y:-274.175}}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_6,p:{x:-108.15,y:-292.325}}]},1).to({state:[{t:this.shape_2,p:{x:-102.6,y:-296.825}}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_7,p:{x:-80,y:-314.975}}]},1).to({state:[{t:this.shape_6,p:{x:-76.65,y:-317.625}}]},1).to({state:[{t:this.shape_7,p:{x:-73.7,y:-319.975}}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_6,p:{x:-69,y:-323.775}}]},1).to({state:[{t:this.shape,p:{x:-67.25,y:-325.225}}]},1).to({state:[{t:this.shape_6,p:{x:-65.85,y:-326.325}}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_3,p:{x:-64.3,y:-327.575}}]},1).to({state:[{t:this.shape,p:{x:-64.1,y:-327.725}}]},1).wait(199));
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(49).to({_off:false},0).to({_off:true},1).wait(8).to({_off:false,x:-122.9,y:-280.525},0).wait(1).to({x:-118.4,y:-284.125},0).wait(1).to({x:-113.45,y:-288.075},0).to({_off:true},1).wait(5).to({_off:false,x:-83.75,y:-311.975},0).to({_off:true},1).wait(3).to({_off:false,x:-71.15,y:-322.025},0).to({_off:true},1).wait(204));
	this.timeline.addTween(cjs.Tween.get(this.shape_4).wait(53).to({_off:false},0).to({_off:true},1).wait(3).to({_off:false,x:-127,y:-277.175},0).to({_off:true},1).wait(5).to({_off:false,x:-97.3,y:-301.075},0).wait(1).to({x:-92.35,y:-305.025},0).wait(1).to({x:-87.85,y:-308.625},0).to({_off:true},1).wait(8).to({_off:false,x:-64.9,y:-327.075},0).to({_off:true},1).wait(200));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-84.9,-272.25,1.8163,1.8163,-14.7101,0,0,-66.8,16.3);
	this.instance.alpha = 0.0508;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({regX:-67.2,regY:16.4,scaleX:0.4547,scaleY:0.4547,rotation:-2.4679,x:-85.35,alpha:1},4).to({regX:-67,regY:16.5,scaleX:0.4883,scaleY:0.4883,rotation:-2.4698,x:-85.3},4).wait(488));

	// text_Better
	this.instance_1 = new lib.txt_staySafe();
	this.instance_1.setTransform(228.05,-209.15);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({y:-253.65},12,cjs.Ease.quadOut).wait(484));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-239.7,-393.3,475.79999999999995,243.10000000000002);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(3).to({_off:false},0).to({alpha:1},14).wait(458));
...
p.nominalBounds = new cjs.Rectangle(-120.9,-290,440.9,290);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(233.9991,29.9825,0.9979,0.983);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(51).to({mode:"independent"},0).to({x:-298},23,cjs.Ease.quadInOut).to({_off:true},1).wait(242));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(51).to({_off:false},0).to({x:149.9,y:300.75,mode:"independent"},23,cjs.Ease.quadInOut).wait(67).to({x:150.05,y:300},0).to({x:-288.95},24,cjs.Ease.quadInOut).to({_off:true},1).wait(151));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(141).to({_off:false},0).to({x:148.05,mode:"independent"},24,cjs.Ease.quadInOut).wait(46).to({x:-441.95},24,cjs.Ease.quadInOut).wait(82));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(216).to({_off:false},0).to({x:148.05,mode:"independent"},24,cjs.Ease.quadInOut).wait(77));

	// background
	this.instance_4 = new lib.background();
	this.instance_4.setTransform(596,300,1,1,0,0,0,446,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(51).to({x:294},31,cjs.Ease.quadInOut).wait(59).to({x:4},32,cjs.Ease.quadInOut).wait(43).to({x:-298},31,cjs.Ease.quadInOut).wait(70));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-660,-64,2742,664);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"images/txt_staySafepngcopy.png", id:"txt_staySafepngcopy"},
		{src:"images/txt_weCanMakeItBetter.png", id:"txt_weCanMakeItBetter"},
		{src:"images/white_bgjpgcopy.jpg", id:"white_bgjpgcopy"},
