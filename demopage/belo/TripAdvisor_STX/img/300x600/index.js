...
(lib._300x600_ctaBtn = function() {
	this.initialize(img._300x600_ctaBtn);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,189,29);


(lib._300x600_townsquare1 = function() {
	this.initialize(img._300x600_townsquare1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,589,600);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
...
}).prototype = getMCSymbolPrototype(lib.txt_shortDrive, new cjs.Rectangle(-99.9,-38,200.60000000000002,77.3), null);
...
}).prototype = getMCSymbolPrototype(lib.txt_shopping, new cjs.Rectangle(-67.6,-56,120.8,113), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(-13.1,0.475);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_highestStandard, new cjs.Rectangle(-124.1,-46.7,248.3,93.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(-14.475,0.775);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_escape, new cjs.Rectangle(-67.9,-56,106.9,113.6), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_3
	this.instance = new lib._300x600_townsquare1();
	this.instance.setTransform(-350,-305,1.0272,1.0272);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.townSquare, new cjs.Rectangle(-350,-305,605,616.3), null);
...
}).prototype = getMCSymbolPrototype(lib.STX_Logo, new cjs.Rectangle(-232.5,-63.1,465.1,126.30000000000001), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib._300x600_ctaBtn();
	this.instance.setTransform(-95,-9);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ctaBtn, new cjs.Rectangle(-95,-9,189,29), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#FFFFFF").ss(2,1,1).p("A0Uq3MAopAAAIAAVvMgopAAAg");
	this.shape.setTransform(507.175,187.675);
	this.shape._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(4).to({_off:false},0).wait(1).to({x:480.825},0).wait(1).to({x:455.925},0).wait(1).to({x:432.425},0).wait(1).to({x:410.375},0).wait(1).to({x:389.725},0).wait(1).to({x:370.475},0).wait(1).to({x:352.675},0).wait(1).to({x:336.325},0).wait(1).to({x:321.375},0).wait(1).to({x:307.825},0).wait(1).to({x:295.725},0).wait(1).to({x:285.075},0).wait(1).to({x:275.825},0).wait(1).to({x:267.975},0).wait(1).to({x:261.575},0).wait(1).to({x:256.575},0).wait(1).to({x:253.025},0).wait(1).to({x:250.875},0).wait(1).to({x:250.175},0).wait(89).to({_off:true},1).wait(247));

	// Layer_3
	this.instance_1 = new lib.txt_highestStandard();
	this.instance_1.setTransform(518.2,187.55);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(13).to({_off:false},0).to({x:261.2,alpha:1},19,cjs.Ease.quadOut).wait(80).to({_off:true},1).wait(247));
...
// stage content:
(lib.STX_TripAdvisor_300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// border
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,0,0,3).p("EgXRgutMAujAAAMAAABdbMgujAAAg");
	this.shape.setTransform(150.0071,300.0025,1.0067,1.0033);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(360));

	// ctaBtn
	this.instance = new lib.ctaBtn();
	this.instance.setTransform(149.1,610.1,1,1,0,0,0,0.4,0.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:579.1},13,cjs.Ease.quadOut).wait(347));
	...
	this.instance_3.setTransform(206.15,300.35);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(263).to({_off:false},0).to({scaleX:1.0541,scaleY:1.0541,x:180,y:312.3,alpha:1},22).to({scaleX:1.2361,scaleY:1.2361,x:91.95,y:352.4},74).wait(1));

	// white_Box
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FFFFFF").ss(2,1,1).p("AtIsgIaRAAIAAZBI6RAAg");
	this.shape_2.setTransform(-85.825,133.175);
	this.shape_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(182).to({_off:false},0).wait(1).to({x:-66.425},0).wait(1).to({x:-48.175},0).wait(1).to({x:-31.125},0).wait(1).to({x:-15.225},0).wait(1).to({x:-0.525},0).wait(1).to({x:12.975},0).wait(1).to({x:25.375},0).wait(1).to({x:36.525},0).wait(1).to({x:46.525},0).wait(1).to({x:55.375},0).wait(1).to({x:62.975},0).wait(1).to({x:69.475},0).wait(1).to({x:74.775},0).wait(1).to({x:78.875},0).wait(1).to({x:81.825},0).wait(1).to({x:83.575},0).wait(1).to({x:84.175},0).wait(161));

	// txt_shopping
	this.instance_4 = new lib.txt_escape();
	this.instance_4.setTransform(-81.35,132.45);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(190).to({_off:false},0).to({x:84.65},17,cjs.Ease.quadOut).wait(153));

	// bar
	this.instance_5 = new lib.bar_img_1("synched",0,false);
	this.instance_5.setTransform(98.5,230);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(181).to({_off:false},0).to({scaleX:1.0508,scaleY:1.0508,x:90.4,y:218.15,alpha:1},18).to({scaleX:1.3528,scaleY:1.3528,x:42.4,y:147.85},107).wait(54));

	// server
	this.instance_6 = new lib.server_PX("synched",0);
	this.instance_6.setTransform(246.05,304.15,1,1,0,0,0,319.6,304.6);
	...
	this.shape_3.graphics.f().s("#FFFFFF").ss(2,1,1).p("AtIsgIaRAAIAAZBI6RAAg");
	this.shape_3.setTransform(-85.825,133.175);

	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(1).to({x:-66.425},0).wait(1).to({x:-48.175},0).wait(1).to({x:-31.125},0).wait(1).to({x:-15.225},0).wait(1).to({x:-0.525},0).wait(1).to({x:12.975},0).wait(1).to({x:25.375},0).wait(1).to({x:36.525},0).wait(1).to({x:46.525},0).wait(1).to({x:55.375},0).wait(1).to({x:62.975},0).wait(1).to({x:69.475},0).wait(1).to({x:74.775},0).wait(1).to({x:78.875},0).wait(1).to({x:81.825},0).wait(1).to({x:83.575},0).wait(1).to({x:84.175},0).wait(343));

	// txt_shopping
	this.instance_7 = new lib.txt_shopping();
	this.instance_7.setTransform(-86.35,132.45);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(9).to({_off:false},0).to({x:84.65,alpha:1},17,cjs.Ease.quadOut).wait(334));
	...
	this.instance_8.setTransform(214.2,308,1.254,1.254,0,0,0,128,300);
...
p.nominalBounds = new cjs.Rectangle(-190.7,-74.3,919.7,835.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"_300x600_ctaBtn.png", id:"_300x600_ctaBtn"},
		{src:"_300x600_townsquare1.jpg", id:"_300x600_townsquare1"},
