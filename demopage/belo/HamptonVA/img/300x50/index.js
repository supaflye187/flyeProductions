...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(3.4,-6.25);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_tournamentWht, new cjs.Rectangle(-260.9,-41,528.7,69.5), null);
...
// stage content:
(lib.BELO_HamptonVA_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// border
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(2,0,0,3).p("A3bj5MAu3AAAIAAHzMgu3AAAg");
	...
	mask._off = true;
	var mask_graphics_263 = new cjs.Graphics().p("ANTgGIJeAAIAACvIpeAAg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(263).to({graphics:mask_graphics_263,x:145.7363,y:16.8916}).wait(73));
	...
	this.shape_32.graphics.lf(["rgba(255,255,255,0)","rgba(255,255,255,0.498)","rgba(255,255,255,0)"],[0,0.525,1],-15.3,-10.4,15.3,10.4).s().p("Ao4H8IM/zIIEyDRIs/THg");
	...
	this.instance.setTransform(334.1,24.75,0.1309,0.1309);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:259.85},10,cjs.Ease.quadInOut).to({x:261.1},4).wait(322));

	// txt_yourEvent
	this.instance_1 = new lib.txt_yourEvent();
	this.instance_1.setTransform(36.05,25.05,0.4257,0.4257,0,0,0,0.1,0.1);
	...
	this.instance_2.setTransform(94.8,25.05,0.4257,0.4257,0,0,0,0.1,0.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(227).to({_off:false},0).to({alpha:1},14,cjs.Ease.quadInOut).wait(95));
	...
	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(237).to({graphics:mask_1_graphics_237,x:169.5501,y:22.1112}).wait(99));
	...
	this.shape_33.setTransform(112.725,7.925);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_33).wait(242).to({_off:false},0).wait(1).to({x:112.975,y:7.975},0).wait(1).to({x:113.775,y:8.175},0).wait(1).to({x:115.075,y:8.475},0).wait(1).to({x:116.875,y:8.875},0).wait(1).to({x:119.175,y:9.425},0).wait(1).to({x:122.025,y:10.075},0).wait(1).to({x:125.375,y:10.875},0).wait(1).to({x:129.275,y:11.775},0).wait(1).to({x:133.675,y:12.825},0).wait(1).to({x:138.575,y:13.975},0).wait(1).to({x:144.025,y:15.225},0).wait(1).to({x:149.975,y:16.625},0).wait(1).to({x:156.425,y:18.125},0).wait(1).to({x:163.425,y:19.775},0).wait(1).to({x:170.925,y:21.525},0).wait(1).to({x:178.775,y:23.325},0).wait(1).to({x:186.275,y:25.075},0).wait(1).to({x:193.275,y:26.725},0).wait(1).to({x:199.725,y:28.225},0).wait(1).to({x:205.675,y:29.625},0).wait(1).to({x:211.125,y:30.875},0).wait(1).to({x:216.025,y:32.025},0).wait(1).to({x:220.425,y:33.075},0).wait(1).to({x:224.325,y:33.975},0).wait(1).to({x:227.675,y:34.775},0).wait(1).to({x:230.525,y:35.425},0).wait(1).to({x:232.825,y:35.975},0).wait(1).to({x:234.625,y:36.375},0).wait(1).to({x:235.925,y:36.675},0).wait(1).to({x:236.725,y:36.875},0).wait(1).to({x:236.975,y:36.925},0).wait(63));

	// hampton_logo
	this.instance_3 = new lib.hamptonLogo();
	this.instance_3.setTransform(169.65,22.2,0.4247,0.4247,0,0,0,0.2,0.2);
	...
	this.shape_35.graphics.f("rgba(255,255,255,0.875)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_35.setTransform(160,25);

	this.shape_36 = new cjs.Shape();
	this.shape_36.graphics.f("rgba(255,255,255,0.749)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_36.setTransform(160,25);

	this.shape_37 = new cjs.Shape();
	this.shape_37.graphics.f("rgba(255,255,255,0.624)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_37.setTransform(160,25);

	this.shape_38 = new cjs.Shape();
	this.shape_38.graphics.f("rgba(255,255,255,0.502)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_38.setTransform(160,25);

	this.shape_39 = new cjs.Shape();
	this.shape_39.graphics.f("rgba(255,255,255,0.376)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_39.setTransform(160,25);

	this.shape_40 = new cjs.Shape();
	this.shape_40.graphics.f("rgba(255,255,255,0.251)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_40.setTransform(160,25);

	this.shape_41 = new cjs.Shape();
	this.shape_41.graphics.f("rgba(255,255,255,0.125)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_41.setTransform(160,25);

	this.shape_42 = new cjs.Shape();
	this.shape_42.graphics.f("rgba(255,255,255,0)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_42.setTransform(160,25);

	this.shape_43 = new cjs.Shape();
	this.shape_43.graphics.f("rgba(226,233,237,0.141)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_43.setTransform(160,25);

	this.shape_44 = new cjs.Shape();
	this.shape_44.graphics.f("rgba(197,211,218,0.286)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_44.setTransform(160,25);

	this.shape_45 = new cjs.Shape();
	this.shape_45.graphics.f("rgba(168,189,200,0.427)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_45.setTransform(160,25);

	this.shape_46 = new cjs.Shape();
	this.shape_46.graphics.f("rgba(138,166,181,0.573)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_46.setTransform(160,25);

	this.shape_47 = new cjs.Shape();
	this.shape_47.graphics.f("rgba(109,144,163,0.714)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_47.setTransform(160,25);

	this.shape_48 = new cjs.Shape();
	this.shape_48.graphics.f("rgba(80,122,144,0.859)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_48.setTransform(160,25);

	this.shape_49 = new cjs.Shape();
	this.shape_49.graphics.f("#33647E").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_49.setTransform(160,25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_34}]},147).to({state:[{t:this.shape_35}]},1).to({state:[{t:this.shape_36}]},1).to({state:[{t:this.shape_37}]},1).to({state:[{t:this.shape_38}]},1).to({state:[{t:this.shape_39}]},1).to({state:[{t:this.shape_40}]},1).to({state:[{t:this.shape_41}]},1).to({state:[{t:this.shape_42}]},1).to({state:[{t:this.shape_42}]},62).to({state:[{t:this.shape_43}]},1).to({state:[{t:this.shape_44}]},1).to({state:[{t:this.shape_45}]},1).to({state:[{t:this.shape_46}]},1).to({state:[{t:this.shape_47}]},1).to({state:[{t:this.shape_48}]},1).to({state:[{t:this.shape_49}]},1).wait(112));

	// image_mask (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_147 = new cjs.Graphics().p("AnUEyIAAgaIAAoHIAAhBIOpAAIAABBIAAIHIAAAag");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(147).to({graphics:mask_2_graphics_147,x:175.7,y:23.05}).wait(189));

	// image_03
	this.instance_4 = new lib.image_03_1();
	this.instance_4.setTransform(175.9,27.7,0.3156,0.3156,0,0,0,151,124.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(147).to({_off:false},0).to({regX:151.1,scaleX:0.3402,scaleY:0.3402,x:175.4,y:23.95},84).wait(105));

	// txt_ConventionsWht
	this.instance_5 = new lib.txt_ConventionsWht();
	this.instance_5.setTransform(65.35,11.8,0.4299,0.4299,0,0,0,0.7,0.5);
	...
	this.instance_6.setTransform(65.35,32.95,0.4188,0.4188,0,0,0,0.7,0.8);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(147).to({_off:false},0).wait(189));

	// txt_HamptonRoads
	this.instance_7 = new lib.txt_HamptonRoads();
	this.instance_7.setTransform(64,40.65,0.421,0.4147,0,0,0,0.5,0.8);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(147).to({_off:false},0).wait(189));

	// background_image
	this.shape_50 = new cjs.Shape();
	this.shape_50.graphics.f("#33647E").s().p("A5BD6IAAnzMAyDAAAIAAHzg");
	this.shape_50.setTransform(159.8,25);
	this.shape_50._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_50).wait(147).to({_off:false},0).wait(189));

	// white_BG
	this.shape_51 = new cjs.Shape();
	this.shape_51.graphics.f("#FFFFFF").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_51.setTransform(160,25);

	this.shape_52 = new cjs.Shape();
	this.shape_52.graphics.f("rgba(255,255,255,0.859)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_52.setTransform(160,25);

	this.shape_53 = new cjs.Shape();
	this.shape_53.graphics.f("rgba(255,255,255,0.714)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_53.setTransform(160,25);

	this.shape_54 = new cjs.Shape();
	this.shape_54.graphics.f("rgba(255,255,255,0.573)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_54.setTransform(160,25);

	this.shape_55 = new cjs.Shape();
	this.shape_55.graphics.f("rgba(255,255,255,0.427)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_55.setTransform(160,25);

	this.shape_56 = new cjs.Shape();
	this.shape_56.graphics.f("rgba(255,255,255,0.286)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_56.setTransform(160,25);

	this.shape_57 = new cjs.Shape();
	this.shape_57.graphics.f("rgba(255,255,255,0.141)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_57.setTransform(160,25);

	this.shape_58 = new cjs.Shape();
	this.shape_58.graphics.f("rgba(255,255,255,0)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_58.setTransform(160,25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_51}]},72).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_53}]},1).to({state:[{t:this.shape_54}]},1).to({state:[{t:this.shape_55}]},1).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_57}]},1).to({state:[{t:this.shape_58}]},1).to({state:[{t:this.shape_58}]},63).to({state:[{t:this.shape_57}]},1).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_55}]},1).to({state:[{t:this.shape_54}]},1).to({state:[{t:this.shape_53}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_51}]},1).wait(187));

	// image_mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_72 = new cjs.Graphics().p("AnTEyIAAgaIAAoHIAAhBIOnAAIAABBIAAIHIAAAag");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(72).to({graphics:mask_3_graphics_72,x:175.575,y:23.05}).wait(264));

	// image_02
	this.instance_8 = new lib.image_02_1();
	this.instance_8.setTransform(174.6,17.35,0.3675,0.3675,0,0,0,0.6,0.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(72).to({_off:false},0).to({regX:0.3,regY:0.3,scaleX:0.3252,scaleY:0.3252,x:175.55,y:18.3},82).wait(182));

	// txt_Coliseum_Wht
	this.instance_9 = new lib.txt_AColiseumWht();
	this.instance_9.setTransform(65.85,11.95,0.4477,0.4477,0,0,0,1.4,1.4);
	...
	this.instance_10.setTransform(66.3,33.65,0.4111,0.4111,0,0,0,0.8,1.1);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(72).to({_off:false},0).wait(264));

	// txt_hamptonColiseum
	this.instance_11 = new lib.txt_HamptonColiseum();
	this.instance_11.setTransform(63.4,41.5,0.5292,0.5292,0,0,0,1,1.2);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(72).to({_off:false},0).wait(264));

	// background_image
	this.shape_59 = new cjs.Shape();
	this.shape_59.graphics.f("#33647E").s().p("A5BD6IAAnzMAyDAAAIAAHzg");
	this.shape_59.setTransform(159.8,25);
	this.shape_59._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_59).wait(72).to({_off:false},0).wait(264));
	...
	this.shape_61.graphics.f("rgba(255,255,255,0.859)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_61.setTransform(160,25);

	this.shape_62 = new cjs.Shape();
	this.shape_62.graphics.f("rgba(255,255,255,0.714)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_62.setTransform(160,25);

	this.shape_63 = new cjs.Shape();
	this.shape_63.graphics.f("rgba(255,255,255,0.573)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_63.setTransform(160,25);

	this.shape_64 = new cjs.Shape();
	this.shape_64.graphics.f("rgba(255,255,255,0.427)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_64.setTransform(160,25);

	this.shape_65 = new cjs.Shape();
	this.shape_65.graphics.f("rgba(255,255,255,0.286)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_65.setTransform(160,25);

	this.shape_66 = new cjs.Shape();
	this.shape_66.graphics.f("rgba(255,255,255,0.141)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_66.setTransform(160,25);

	this.shape_67 = new cjs.Shape();
	this.shape_67.graphics.f("rgba(255,255,255,0)").s().p("A4/D6IAAnzMAx/AAAIAAHzg");
	this.shape_67.setTransform(160,25);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_60}]}).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_62}]},1).to({state:[{t:this.shape_63}]},1).to({state:[{t:this.shape_64}]},1).to({state:[{t:this.shape_65}]},1).to({state:[{t:this.shape_66}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_67}]},60).to({state:[{t:this.shape_66}]},1).to({state:[{t:this.shape_65}]},1).to({state:[{t:this.shape_64}]},1).to({state:[{t:this.shape_63}]},1).to({state:[{t:this.shape_62}]},1).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_60}]},1).wait(262));

	// image_mask (mask)
	var mask_4 = new cjs.Shape();
	mask_4._off = true;
	mask_4.graphics.p("AnUEyIAAgaIAAoHIAAhBIOpAAIAABBIAAIHIAAAag");
	mask_4.setTransform(175.7,23.05);

	// image_01
	this.instance_12 = new lib.image_01_1();
	this.instance_12.setTransform(160.85,27.7,0.212,0.212,0,0,0,0.7,0.7);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({regY:0.8,scaleX:0.234,scaleY:0.234,x:154.35,y:25.25},84).wait(252));

	// txt_forMultiple
	this.instance_13 = new lib.txt_forMultiple();
	this.instance_13.setTransform(66.2,34.05,0.3938,0.3938,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(336));

	// txt_booWilliams
	this.instance_14 = new lib.txt_booWilliams();
	this.instance_14.setTransform(65.75,41.8,0.497,0.497,0,0,0,0.3,0.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(336));

	// txt_tournament_White
	this.instance_15 = new lib.txt_tournamentWht();
	this.instance_15.setTransform(66.2,13.8,0.3938,0.3938,0,0,0,0.2,0.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).wait(336));

	// background_image
	this.shape_68 = new cjs.Shape();
	this.shape_68.graphics.f("#33647E").s().p("A5ED6IAAnzMAyJAAAIAAHzg");
	this.shape_68.setTransform(159.55,25.5);

	this.timeline.addTween(cjs.Tween.get(this.shape_68).wait(336));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(91.8,17.5,272.7,36.1);
// library properties:
lib.properties = {
