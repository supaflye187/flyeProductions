...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(164).to({_off:false},0).to({y:333.35,alpha:1},10,cjs.Ease.quadOut).wait(41));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(164).to({_off:false},0).to({alpha:1,startPosition:10},10).wait(40).to({mode:"single",startPosition:50},0).wait(1));
