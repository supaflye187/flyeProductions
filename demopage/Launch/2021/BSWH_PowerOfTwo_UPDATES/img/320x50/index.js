...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(276.2,33.8,0.1203,0.1203,0,0,0,-286.7,51.5);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(164).to({_off:false},0).to({alpha:1,startPosition:10},10).wait(41).to({mode:"single",startPosition:51},0).wait(1));

	// text_animation
	this.instance_3 = new lib.text_animation("synched",0,false);
	this.instance_3.setTransform(84.45,26,0.8071,0.8071,0,0,0,364.6,47.5);
