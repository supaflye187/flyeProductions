...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-282,-19);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_staySafe, new cjs.Rectangle(-282,-19,542,40), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-127,-86);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_moving, new cjs.Rectangle(-127,-86,370,34), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-126,-82);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_makeBetter, new cjs.Rectangle(-126,-82,364,27), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape,p:{x:-146.65,y:-261.425}}]},24).to({state:[{t:this.shape,p:{x:-146.45,y:-261.575}}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2,p:{x:-144.9,y:-262.825}}]},1).to({state:[{t:this.shape_3,p:{x:-143.5,y:-263.925}}]},1).to({state:[{t:this.shape_2,p:{x:-141.75,y:-265.375}}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5,p:{x:-137.05,y:-269.175}}]},1).to({state:[{t:this.shape_2,p:{x:-134.1,y:-271.525}}]},1).to({state:[{t:this.shape_5,p:{x:-130.75,y:-274.175}}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_6,p:{x:-108.15,y:-292.325}}]},1).to({state:[{t:this.shape_2,p:{x:-102.6,y:-296.825}}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_7,p:{x:-80,y:-314.975}}]},1).to({state:[{t:this.shape_6,p:{x:-76.65,y:-317.625}}]},1).to({state:[{t:this.shape_7,p:{x:-73.7,y:-319.975}}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_6,p:{x:-69,y:-323.775}}]},1).to({state:[{t:this.shape,p:{x:-67.25,y:-325.225}}]},1).to({state:[{t:this.shape_6,p:{x:-65.85,y:-326.325}}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_3,p:{x:-64.3,y:-327.575}}]},1).to({state:[{t:this.shape,p:{x:-64.1,y:-327.725}}]},1).wait(222));
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(26).to({_off:false},0).to({_off:true},1).wait(8).to({_off:false,x:-122.9,y:-280.525},0).wait(1).to({x:-118.4,y:-284.125},0).wait(1).to({x:-113.45,y:-288.075},0).to({_off:true},1).wait(5).to({_off:false,x:-83.75,y:-311.975},0).to({_off:true},1).wait(3).to({_off:false,x:-71.15,y:-322.025},0).to({_off:true},1).wait(227));
	this.timeline.addTween(cjs.Tween.get(this.shape_4).wait(30).to({_off:false},0).to({_off:true},1).wait(3).to({_off:false,x:-127,y:-277.175},0).to({_off:true},1).wait(5).to({_off:false,x:-97.3,y:-301.075},0).wait(1).to({x:-92.35,y:-305.025},0).wait(1).to({x:-87.85,y:-308.625},0).to({_off:true},1).wait(8).to({_off:false,x:-64.9,y:-327.075},0).to({_off:true},1).wait(223));
...
if (reversed == null) { reversed = false; }
	...
	// Layer_4
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#008FBE").ss(2,1,1).p("A2JjlMAsTAAAIAAHLMgsTAAAg");
	this.shape.setTransform(-1,-0.75);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AyZCfIAAk9MAkzAAAIAAE9g");
	mask.setTransform(-14,0.125);

	// Layer_2
	this.instance_1 = new lib.ctaTxt();
	this.instance_1.setTransform(-125,-10);
...
}).prototype = getMCSymbolPrototype(lib.cta_txt, new cjs.Rectangle(-143.7,-24.7,285.5,48), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(228.05,-189.65);
...
p.nominalBounds = new cjs.Rectangle(-150,-299,728,130.4);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(14.4,-243.05,1,1,0,0,0,-0.7,-0.1);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("EggBAHpQgUgbAEgaQABgGAUg9IAYhFQAPgaAugUQAYgKgMgOQgIgKghgRQhMgpAGgSIAehQQAFgPAIgrQAJgmASgSQATgTAFhGQADgjgCgfIAtg3IHlhgIAVgQQAZgRATgHQASgGAbADIAtADQATAAAWgbQALgOAIgOQgDgDZrgaIZsgaIAAPjQv9AKwBAFQpJADmkAAQwaAAgOgSg");
	var mask_graphics_1 = new cjs.Graphics().p("");
	var mask_graphics_2 = new cjs.Graphics().p("");
	var mask_graphics_3 = new cjs.Graphics().p("");
	var mask_graphics_4 = new cjs.Graphics().p("");
	var mask_graphics_5 = new cjs.Graphics().p("");
	var mask_graphics_6 = new cjs.Graphics().p("");
	var mask_graphics_7 = new cjs.Graphics().p("");
	var mask_graphics_8 = new cjs.Graphics().p("");
	var mask_graphics_9 = new cjs.Graphics().p("");
	var mask_graphics_10 = new cjs.Graphics().p("");
	var mask_graphics_11 = new cjs.Graphics().p("");
	var mask_graphics_12 = new cjs.Graphics().p("");
	var mask_graphics_13 = new cjs.Graphics().p("EggBAHpQgUgbAEgaQABgGAUg9IAYhFQAPgaAugUQAtgTAQgjQAJgUAKgpQAIgUAJgTQAIgQAFgPQAGgTAqgnIA/g4QAegeBfhaIAtg3IAvgYQAygcANgTQAUgeAFgjIAVgQQAZgRATgHQASgGAbADIAtADQATAAAWgbQALgOAIgOQgDgDZrgaIZsgaIAAPjQv9AKwBAFQpJADmkAAQwaAAgOgSg");
	var mask_graphics_94 = new cjs.Graphics().p("EggBAHpQgUgbAEgaQABgGAUg9IAYhFQAPgaAugUQAtgTAQgjQAJgUAKgpQAIgUAJgTQAIgQAFgPQAGgTAqgnIA/g4QAegeBfhaIAtg3IAvgYQAygcANgTQAUgeAFgjIAVgQQAZgRATgHQASgGAbADIAtADQATAAAWgbQALgOAIgOQgDgDZrgaIZsgaIAAPjQv9AKwBAFQpJADmkAAQwaAAgOgSg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:790.4667,y:-246.3821}).wait(1).to({graphics:mask_graphics_1,x:790.3667,y:-246.3821}).wait(1).to({graphics:mask_graphics_2,x:788.6167,y:-246.3571}).wait(1).to({graphics:mask_graphics_3,x:781.0667,y:-246.2821}).wait(1).to({graphics:mask_graphics_4,x:760.7167,y:-246.2821}).wait(1).to({graphics:mask_graphics_5,x:717.8167,y:-246.3071}).wait(1).to({graphics:mask_graphics_6,x:639.8167,y:-246.3071}).wait(1).to({graphics:mask_graphics_7,x:526.1234,y:-246.3673}).wait(1).to({graphics:mask_graphics_8,x:448.1234,y:-246.3673}).wait(1).to({graphics:mask_graphics_9,x:405.2234,y:-246.3923}).wait(1).to({graphics:mask_graphics_10,x:384.8734,y:-246.3923}).wait(1).to({graphics:mask_graphics_11,x:377.3234,y:-246.3923}).wait(1).to({graphics:mask_graphics_12,x:375.5734,y:-246.3923}).wait(1).to({graphics:mask_graphics_13,x:375.4667,y:-246.3821}).wait(81).to({graphics:mask_graphics_94,x:375.4667,y:-246.3821}).wait(1).to({graphics:null,x:0,y:0}).wait(380));

	// BSWH_LOGO
	this.instance_1 = new lib.white_box("synched",0,false);
	this.instance_1.setTransform(401.75,-244.45,1.1437,1.1437,0,0,0,1.1,-295.4);
	...
	// white_BG
	this.instance_2 = new lib.white_bg();
	this.instance_2.setTransform(174,-290);
...
p.nominalBounds = new cjs.Rectangle(-128.6,-290,708.6,290);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-72.85,-254.65,0.5293,0.5293,0,0,0,-1.1,-194.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},358).wait(1));

	// stair_animation
	this.instance_1 = new lib.stair_animation("synched",0);
	this.instance_1.setTransform(8.15,-253.95,0.5295,0.5295,0,0,0,2.4,-47.3);
	...
	this.instance_2.setTransform(88,-251.05,0.5295,0.5295,0,0,0,1.2,105.5);
...
p.nominalBounds = new cjs.Rectangle(-108.2,-307.7,641.8000000000001,130.1);
...
p.nominalBounds = new cjs.Rectangle(-150,-314.9,728,134.79999999999998);


// stage content:
(lib.BSWH_moving_728x90_v01 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(51).to({mode:"independent"},0).to({x:-586},23,cjs.Ease.quadInOut).to({_off:true},1).wait(260));

	// Frame_02
	this.instance_1 = new lib.Frame_02("single",0);
	this.instance_1.setTransform(881.05,300);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(51).to({_off:false},0).to({x:149.9,y:300.75,mode:"independent"},23,cjs.Ease.quadInOut).wait(67).to({x:150.05,y:300},0).to({x:-552.95},24,cjs.Ease.quadInOut).to({_off:true},1).wait(169));

	// Frame_03
	this.instance_2 = new lib.Frame_04("single",0);
	this.instance_2.setTransform(450.05,309,1,1,0,0,0,0,9.7);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(141).to({_off:false},0).to({x:148.05,mode:"independent"},24,cjs.Ease.quadInOut).wait(46).to({x:-489.95},24,cjs.Ease.quadInOut).wait(100));

	// Frame_04
	this.instance_3 = new lib.Frame_03("single",0);
	this.instance_3.setTransform(880.05,300,1,1,0,0,0,0,9.7);
	this.instance_3._off = true;
...
p.nominalBounds = new cjs.Rectangle(-530,37.3,2612,562.7);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"box_01.jpg", id:"box_01"},
		{src:"box_2.jpg", id:"box_2"},
		{src:"box_outline.png", id:"box_outline"},
		{src:"box_outline_blue.png", id:"box_outline_blue"},
		{src:"brownBG.jpg", id:"brownBG"},
		{src:"clock_arm.png", id:"clock_arm"},
		{src:"clock_BG.png", id:"clock_BG"},
		{src:"clock_ticks.png", id:"clock_ticks"},
		{src:"clock_yellow_bar.png", id:"clock_yellow_bar"},
		{src:"ctaTxt.png", id:"ctaTxt"},
		{src:"dr_image.png", id:"dr_image"},
		{src:"dr_stethoscope.png", id:"dr_stethoscope"},
		{src:"magnifyGlass.png", id:"magnifyGlass"},
		{src:"stairPart.jpg", id:"stairPart"},
		{src:"trashCan.png", id:"trashCan"},
		{src:"trashCan_yellow_bar.png", id:"trashCan_yellow_bar"},
		{src:"txt_changingHealthcare.png", id:"txt_changingHealthcare"},
		{src:"txt_painful.png", id:"txt_painful"},
		{src:"txt_weCanMakeItBetter.png", id:"txt_weCanMakeItBetter"},
		{src:"white_bg.jpg", id:"white_bg"},
		{src:"wht_trashcan.png", id:"wht_trashcan"}
	],
	preloads: []
};
