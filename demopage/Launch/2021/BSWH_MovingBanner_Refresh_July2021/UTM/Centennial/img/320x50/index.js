...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-352,-28,0.799,0.799);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_staySafe, new cjs.Rectangle(-352,-28,273.3,17.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-304,-96,0.7558,0.7558);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_moving, new cjs.Rectangle(-304,-96,179.9,15.900000000000006), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-304,-92,0.7432,0.7432);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_makeBetter, new cjs.Rectangle(-304,-92,173.2,14.099999999999994), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-12.2,-9.1,0.4325,0.4325);
	...
	this.shape.setTransform(-67.35,-9.25);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Ap+BCIAAiTIQ5AAIAACTg");
	mask.setTransform(-63.8981,-8.1827);

	// Layer_2
	this.instance_1 = new lib.ctaTxt();
	this.instance_1.setTransform(-126,-13,0.6734,0.6734);
...
}).prototype = getMCSymbolPrototype(lib.cta_txt, new cjs.Rectangle(-134.4,-21,134.20000000000002,23.5), null);
...
p.nominalBounds = new cjs.Rectangle(-148,-299,320,79.5);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("AyJEVQgLgPACgPQAAgEAMgiIAOgnQAJgPAZgLQAagLAJgUQAFgLAGgXQAEgMAFgKIAIgSQADgLAYgWIAjgfIBHhEIAaggIAbgNQAcgQAHgKQAMgSACgTIAMgJQAPgKAKgEQAKgEAPACIAaACQALAAAMgPQAHgIAEgJQgCgBOkgPIOjgPIAAI0QpDAFpFAEIonACQplAAgIgLg");
	var mask_graphics_1 = new cjs.Graphics().p("AyJEVQgLgPACgPQAAgEAMgiIAOgnQAJgPAZgLQAagLAJgUQAFgLAGgXQAEgMAFgKIAIgSQADgLAYgWIAjgfIBHhEIAaggIAbgNQAcgQAHgKQAMgSACgTIAMgJQAPgKAKgEQAKgEAPACIAaACQALAAAMgPQAHgIAEgJQgCgBOkgPIOjgPIAAI0QpDAFpFAEIonACQplAAgIgLg");
	var mask_graphics_2 = new cjs.Graphics().p("AyIEVQgLgPACgPQAAgEALgiIAOgnQAJgPAZgLQAagLAJgUQAFgLAGgXQAEgMAFgKIAIgSQADgLAYgVIAjggIBHhEIAagfIAbgOQAcgPAHgLQAMgRACgUIAMgJQAPgKAKgEQAKgDAPABIAaACQALAAAMgPQAHgIAEgIQgCgCOjgOIOkgPIAAIzQpDAFpFAEIonABQpkAAgIgKg");
	var mask_graphics_3 = new cjs.Graphics().p("AyIEVQgLgPACgOQAAgEAMgjIAOgnQAJgPAZgLQAagLAJgTQAFgLAGgYQAEgMAFgKIAIgSQADgLAYgVIAjggIBHhEIAZgfIAbgOQAdgPAGgLQAMgRADgUIAMgJQAOgKALgEQAKgDAPABIAaACQAKAAANgPQAGgIAEgIQgBgCOigOIOjgPIAAIzQpCAGpFADIo4ABQpTAAgIgKg");
	var mask_graphics_4 = new cjs.Graphics().p("AyHEUQgLgPACgOQAAgEALgiIAOgnQAJgPAZgLQAagLAJgUQAFgLAGgXQAEgMAGgKIAHgSQADgLAZgWIAjgfIBGhEIAaggIAbgNQAcgPAHgLQAMgRACgUIAMgJQAPgKAKgEQAKgDAPABIAaACQALAAAMgPQAGgIAFgIQgCgCOigOIOigPIAAIyQpCAGpEADIomACQpkAAgIgLg");
	var mask_graphics_5 = new cjs.Graphics().p("AyGEUQgLgPACgOQAAgEAMgjIAOgnQAJgPAZgLQAZgLAJgTQAFgLAGgYQAEgLAGgKIAHgSQADgLAZgWIAjgfIBGhEIAagfIAbgOQAcgPAHgLQAMgRACgUIAMgJQAPgKAKgDQAKgEAPABIAaADQALAAAMgQQAGgHAFgJQgCgBOhgPIOhgPIAAIyQpBAGpEADIolACQpkAAgIgLg");
	var mask_graphics_6 = new cjs.Graphics().p("AyFEUQgLgPACgPQAAgEAMgiIANgnQAJgPAZgLQAagLAJgTQAFgLAGgYQAEgMAGgJQAEgKADgIQADgLAYgWIAjgfIBHhEIAagfIAagOQAdgPAGgLQAMgRADgUIAMgJQAOgKALgDQAJgEAQABIAZADQALAAAMgQQAHgHAEgJQgCgBOggPIOhgPIAAIyQpBAFpDAEIolACQpjAAgIgLg");
	var mask_graphics_7 = new cjs.Graphics().p("AyDETQgLgOACgPQAAgDALgjIAOgnQAJgPAZgLQAagLAJgTQAFgLAGgYQAEgLAFgKIAIgSQADgLAYgWIAjgfIBGhEIAagfIAbgNQAcgQAHgKQALgSADgTIAMgJQAOgKALgEQAKgDAPABIAaACQAKAAANgPQAGgIAEgIQgBgCOegOIOfgPIAAIwQpAAGpCADIo2ACQpQAAgIgLg");
	var mask_graphics_8 = new cjs.Graphics().p("AyCETQgLgOACgPQAAgDAMgjIANgnQAJgOAZgLQAagLAJgUQAFgLAGgXQAEgMAGgKQAEgJADgJQADgLAYgVIAjgfIBGhEIAaggIAbgNQAcgPAHgLQALgRADgUIAMgIQAOgKALgEQAJgEAQACIAZACQALAAAMgPQAHgIAEgJQgCgBOegPIOegPIAAIwQpAAGpBADIo1ACQpQAAgIgLg");
	var mask_graphics_9 = new cjs.Graphics().p("AyBETQgLgPACgOQAAgEAMgjIANgnQAJgOAZgLQAagLAJgUQAFgLAGgXQAEgMAFgJIAIgSQADgLAYgWIAjgfQARgRA1gyIAaggIAagNQAdgQAGgKQAMgSACgTIAMgJQAPgKAKgDQAKgEAPABIAaADQAKAAANgQQAGgHAEgJQgBgBOdgPIOdgPIAAIwQo/AGpBADIo1ACQpPAAgIgLg");
	var mask_graphics_10 = new cjs.Graphics().p("AyAETQgLgPACgPQAAgDAMgjIANgnQAJgOAZgLQAagLAJgUQAFgLAGgXQAEgMAFgJQAFgKACgIQAEgLAYgWIAjgfIBGhDIAaggIAagNQAdgPAGgLQAMgRACgUIAMgIQAPgKAKgEQAKgEAPACIAaACQAKAAANgPQAGgIAEgIQgBgCOcgPIOcgOIAAIvQo/AFpAAEIojABQpgAAgIgKg");
	var mask_graphics_11 = new cjs.Graphics().p("Ax/ETQgLgPACgOQAAgEALgiIAOgnQAJgPAZgLQAZgLAJgTQAFgLAGgYQAEgLAGgKQAEgKADgIQADgLAYgWIAjgfQARgRA1gyIAaggIAagNQAdgPAGgLQAMgRACgUIAMgIQAPgKAKgEQAKgEAPACIAaACQAKAAANgPQAGgIAEgIQgBgCObgPIOcgOIAAIvQo+AGpAADIo0ABQpOAAgIgKg");
	var mask_graphics_12 = new cjs.Graphics().p("Ax/ESQgLgOACgPQAAgDALgjIAOgnQAJgOAZgLQAZgLAJgUQAFgLAGgXQAEgMAGgJQAEgKADgIQADgLAYgWIAjgfQARgRA1gyIAaggIAagNQAdgPAGgLQAMgRACgUIAMgIQAPgKAKgEQAKgEAPACIAaACQAKAAANgPQAGgIAEgIQgBgCObgPIOcgOIAAIuQo+AGpAADIo1ACQpNAAgIgLg");
	var mask_graphics_13 = new cjs.Graphics().p("Ax/ESQgLgOACgPQAAgDAMgjIANgnQAJgOAZgLQAagLAJgUQAFgLAGgXQAEgMAFgJQAFgKACgIQAEgLAYgWIAjgfQAQgRA2gyIAZggIAbgNQAcgPAHgLQALgRADgUIAMgIQAOgKALgEQAJgEAQACIAZACQALAAAMgPQAGgIAFgIQgCgCObgPIOcgOIAAIuQo+AGpAADIo0ACQpOAAgIgLg");
	var mask_graphics_94 = new cjs.Graphics().p("Ax/ESQgLgOACgPQAAgDAMgjIANgnQAJgOAZgLQAagLAJgUQAFgLAGgXQAEgMAFgJQAFgKACgIQAEgLAYgWIAjgfQAQgRA2gyIAZggIAbgNQAcgPAHgLQALgRADgUIAMgIQAOgKALgEQAJgEAQACIAZACQALAAAMgPQAGgIAFgIQgCgCObgPIOcgOIAAIuQo+AGpAADIo0ACQpOAAgIgLg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:290.0346,y:-265.0494}).wait(1).to({graphics:mask_graphics_1,x:287.9096,y:-265.0494}).wait(1).to({graphics:mask_graphics_2,x:281.5846,y:-265.0744}).wait(1).to({graphics:mask_graphics_3,x:270.9846,y:-265.1143}).wait(1).to({graphics:mask_graphics_4,x:256.1596,y:-265.1494}).wait(1).to({graphics:mask_graphics_5,x:237.0846,y:-265.1744}).wait(1).to({graphics:mask_graphics_6,x:213.8096,y:-265.2494}).wait(1).to({graphics:mask_graphics_7,x:187.3096,y:-265.3393}).wait(1).to({graphics:mask_graphics_8,x:164.0346,y:-265.4143}).wait(1).to({graphics:mask_graphics_9,x:144.9846,y:-265.4393}).wait(1).to({graphics:mask_graphics_10,x:130.1346,y:-265.4744}).wait(1).to({graphics:mask_graphics_11,x:119.5596,y:-265.5143}).wait(1).to({graphics:mask_graphics_12,x:113.2096,y:-265.5393}).wait(1).to({graphics:mask_graphics_13,x:111.0846,y:-265.5393}).wait(81).to({graphics:mask_graphics_94,x:111.0846,y:-265.5393}).wait(1).to({graphics:null,x:0,y:0}).wait(380));

	// BSWH_LOGO
	this.instance_1 = new lib.white_box("synched",0,false);
	this.instance_1.setTransform(98.9,-264.05,0.4996,0.4996,0,0,0,1.3,-295.9);
	...
	this.instance_2.setTransform(-4,-290,0.8833,0.8833);
...
p.nominalBounds = new cjs.Rectangle(-135.3,-290,353.9,53);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-124.35,-273.7,0.2495,0.2495,0,0,0,-1.8,-194.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},358).wait(1));

	// stair_animation
	this.instance_1 = new lib.stair_animation("synched",0);
	this.instance_1.setTransform(-85.7,-273.4,0.2496,0.2496,0,0,0,1.6,-47.7);
	...
	this.instance_2.setTransform(-47,-272,0.2496,0.2496,0,0,0,1.6,105);
...
p.nominalBounds = new cjs.Rectangle(-149,-299,320,61.80000000000001);
...
p.nominalBounds = new cjs.Rectangle(-148.2,-302.4,305.4,99.39999999999998);


// stage content:
(lib.BSWH_moving_320x50_v01 = function(mode,startPosition,loop,reversed) {
...
p.nominalBounds = new cjs.Rectangle(-734,24,2816,576);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"white_bgjpgcopy.jpg", id:"white_bgjpgcopy"},
