...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("AqqDHIAAj4IVVAAIAAD4g");
	mask.setTransform(-4.2,19.925);

	// Layer_4
	this.instance = new lib.txt_changingHealthcare();
	this.instance.setTransform(-63,-37);
...
}).prototype = getMCSymbolPrototype(lib.txt_withUs, new cjs.Rectangle(-63,15,120,24.9), null);


(lib.txt_Us = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AvCFcIAAkiIeEAAIAAEig");
	mask.setTransform(-2.2,34.85);

	// Layer_4
	this.instance = new lib.txt_changingHealthcare();
	this.instance.setTransform(-66,-38);
...
}).prototype = getMCSymbolPrototype(lib.txt_Us, new cjs.Rectangle(-66,40.7,120,21.299999999999997), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AvBBuIAAlkIeEAAIAAFkg");
	mask.setTransform(-4.2,-24.725);

	// Layer_4
	this.instance = new lib.txt_changingHealthcare();
	this.instance.setTransform(-65,-39);
...
}).prototype = getMCSymbolPrototype(lib.txt_staySafe, new cjs.Rectangle(-65,-39,120,25.3), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-140,-86);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_moving, new cjs.Rectangle(-140,-86,99,89), null);
...
}).prototype = getMCSymbolPrototype(lib.txt_makeBetter, new cjs.Rectangle(-126,-82,99,81), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AvCCRIAAkhIeEAAIAAEhg");
	mask.setTransform(-4.7,1.125);
...
}).prototype = getMCSymbolPrototype(lib.txt_healthy, new cjs.Rectangle(-65,-13.4,120,29.1), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(-89.8142,16.5199);

	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(1,142,190,0)","#FFFFFF","rgba(1,142,190,0)"],[0,0.463,1],-9.1,8,9.1,-8.1).s().p("AiiAAIC1ihICQCiIi1Chg");
	this.shape.setTransform(-108.15,30.975);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(36).to({_off:false},0).wait(1).to({x:-108.05,y:30.925},0).wait(1).to({x:-107.8,y:30.675},0).wait(1).to({x:-107.35,y:30.325},0).wait(1).to({x:-106.75,y:29.875},0).wait(1).to({x:-105.95,y:29.225},0).wait(1).to({x:-104.95,y:28.425},0).wait(1).to({x:-103.8,y:27.525},0).wait(1).to({x:-102.5,y:26.475},0).wait(1).to({x:-100.95,y:25.275},0).wait(1).to({x:-99.3,y:23.975},0).wait(1).to({x:-97.45,y:22.475},0).wait(1).to({x:-95.4,y:20.875},0).wait(1).to({x:-93.2,y:19.125},0).wait(1).to({x:-90.8,y:17.225},0).wait(1).to({x:-88.25,y:15.225},0).wait(1).to({x:-85.85,y:13.325},0).wait(1).to({x:-83.65,y:11.575},0).wait(1).to({x:-81.6,y:9.975},0).wait(1).to({x:-79.75,y:8.475},0).wait(1).to({x:-78.1,y:7.175},0).wait(1).to({x:-76.55,y:5.975},0).wait(1).to({x:-75.25,y:4.925},0).wait(1).to({x:-74.1,y:4.025},0).wait(1).to({x:-73.1,y:3.225},0).wait(1).to({x:-72.3,y:2.575},0).wait(1).to({x:-71.7,y:2.125},0).wait(1).to({x:-71.25,y:1.775},0).wait(1).to({x:-71,y:1.525},0).wait(1).to({x:-70.9,y:1.475},0).wait(210));

	// Layer_4
	this.instance = new lib.BSWH_Logo();
	this.instance.setTransform(-90.4,26.8,0.2414,0.2414,0,0,0,-0.8,-13.9);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("ArtKyIAA1jIXbAAIAAVjg");
	mask_1.setTransform(-90.95,28.05);
...
p.nominalBounds = new cjs.Rectangle(-165.9,-40.9,150,138);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(89.25,54.75,0.6824,0.6824);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#008FBE").ss(2,1,1).p("Axki8MAjJAAAIAAF6MgjJAAAg");
	this.shape.setTransform(-2.45,55.55);
	...
	mask.setTransform(-13.575,55.525);

	// Layer_1
	this.instance_1 = new lib.ctaTxt();
	this.instance_1.setTransform(-104,47);
...
}).prototype = getMCSymbolPrototype(lib.cta_txt, new cjs.Rectangle(-115.9,35.6,226.9,39.9), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-87.85,-65.3,1,1,0,0,0,-4.9,-40.6);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-81.3,alpha:1},10,cjs.Ease.quadOut).wait(146).to({_off:true},1).wait(318));

	// txt_safe
	this.instance_1 = new lib.txt_healthy();
	this.instance_1.setTransform(-88.15,-36.7,1,1,0,0,0,-5.2,-10.7);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(3).to({_off:false},0).to({y:-52.7,alpha:1},10,cjs.Ease.quadOut).wait(143).to({_off:true},1).wait(318));

	// txt_healthy
	this.instance_2 = new lib.txt_withUs();
	this.instance_2.setTransform(-87.15,-6.2,1,1,0,0,0,-2.2,20.7);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({_off:false},0).to({y:-22.2,alpha:1},10,cjs.Ease.quadOut).wait(140).to({_off:true},1).wait(318));

	// txt_healthy
	this.instance_3 = new lib.txt_Us();
	this.instance_3.setTransform(-87.15,21.7,1,1,0,0,0,-4.7,47.6);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(9).to({_off:false},0).to({y:5.7,alpha:1},10,cjs.Ease.quadOut).wait(137).to({_off:true},1).wait(318));

	// cta_txt
	this.instance_4 = new lib.cta_txt();
	this.instance_4.setTransform(-87.05,63.8,0.4893,0.4893,0,0,0,-0.6,0.1);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(13).to({_off:false},0).to({alpha:1},14,cjs.Ease.quadOut).wait(129).to({_off:true},1).wait(318));

	// white_bg
	this.instance_5 = new lib.white_box();
	this.instance_5.setTransform(2.05,-394.9,1,1,0,0,0,0,-0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({y:-254.9},16,cjs.Ease.quadOut).to({y:-257.9},3).wait(137).to({_off:true},1).wait(318));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-183.9,-435.8,332,537);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-90.75,-147.85,0.7111,0.7111,0,0,0,-0.5,-156);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},358).wait(1));

	// stair_animation
	this.instance_1 = new lib.stair_animation("synched",0);
	this.instance_1.setTransform(-79.65,-25.8,0.7111,0.7111,0,0,0,16.1,18.1);
	...
	this.instance_2.setTransform(-91.2,55.15,0.7111,0.7111,0,0,0,-0.4,131.3);
...
p.nominalBounds = new cjs.Rectangle(-169.7,-300,319.7,600);
...
p.nominalBounds = new cjs.Rectangle(-154.9,-301,304.9,689);


// stage content:
(lib.BSWH_moving_120x600_v01 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	// border
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("EgJNgutISbAAMAAABdbIybAAg");
...
p.nominalBounds = new cjs.Rectangle(-532,155,1724,533.8);
// library properties:
lib.properties = {
