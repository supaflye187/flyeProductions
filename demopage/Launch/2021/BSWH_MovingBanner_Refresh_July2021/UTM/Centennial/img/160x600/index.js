...
p.nominalBounds = new cjs.Rectangle(0,0,114,96);


(lib.txt_weCanMakeItBetter = function() {
	this.initialize(img.txt_weCanMakeItBetter);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,116,88);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("AvCJqIAAnHIeEAAIAAHHg");
	mask.setTransform(-2.2,61.775);

	// Layer_1
	this.instance = new lib.txt_changingHealthCare();
	this.instance.setTransform(-101,-5,1.2638,1.2638);
...
}).prototype = getMCSymbolPrototype(lib.txt_withUs, new cjs.Rectangle(-98.4,78.1,192.5,45.5), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AvCDjIAAnGIeEAAIAAHGg");
	mask.setTransform(-2.2,12.8);

	// Layer_1
	this.instance = new lib.txt_changingHealthCare();
	this.instance.setTransform(-103,-6,1.2644,1.2644);
...
}).prototype = getMCSymbolPrototype(lib.txt_staySafe, new cjs.Rectangle(-98.4,-6,192.5,41.6), null);
...
}).prototype = getMCSymbolPrototype(lib.txt_moving, new cjs.Rectangle(-127,-86,114,96), null);
...
}).prototype = getMCSymbolPrototype(lib.txt_makeBetter, new cjs.Rectangle(-126,-82,116,88), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AvrGdIAAnKIfXAAIAAHKg");
	mask.setTransform(-2.2449,41.269);

	// Layer_1
	this.instance = new lib.txt_changingHealthCare();
	this.instance.setTransform(-103,-4,1.2693,1.2693);
...
}).prototype = getMCSymbolPrototype(lib.txt_healthy, new cjs.Rectangle(-102.6,36.7,200.8,45.89999999999999), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AvCM7IAAnHIeEAAIAAHHg");
	mask.setTransform(-2.2,82.675);
...
}).prototype = getMCSymbolPrototype(lib.txt_better, new cjs.Rectangle(-98.4,119.9,192.5,35.599999999999994), null);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(65).call(this.frame_65).wait(210));

	// Layer_2 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(-69.2798,10.8653);

	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(1,142,190,0)","#FFFFFF","rgba(1,142,190,0)"],[0,0.463,1],-13.3,11.8,13.4,-11.8).s().p("AjvAAIELjtIDTDuIkKDtg");
	this.shape.setTransform(-96.55,33.275);
	this.shape._off = true;

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["rgba(1,142,190,0)","#FFFFFF","rgba(1,142,190,0)"],[0,0.463,1],-13.3,11.8,13.4,-11.8).s().p("AjuAAIEKjtIDTDuIkKDtg");
	this.shape_1.setTransform(-96.4,33.175);
	this.shape_1._off = true;

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["rgba(1,142,190,0)","#FFFFFF","rgba(1,142,190,0)"],[0,0.463,1],-13.3,11.8,13.4,-11.8).s().p("AjuAAIEKjtIDUDuIkLDtg");
	this.shape_2.setTransform(-96.05,32.875);
	this.shape_2._off = true;

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["rgba(1,142,190,0)","#FFFFFF","rgba(1,142,190,0)"],[0,0.463,1],-13.3,11.8,13.4,-11.8).s().p("AjvAAIELjtIDUDuIkLDtg");
	this.shape_3.setTransform(-95.35,32.325);
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(36).to({_off:false},0).to({_off:true},1).wait(4).to({_off:false,x:-93.3,y:30.625},0).to({_off:true},1).wait(1).to({_off:false,x:-90.15,y:28.075},0).to({_off:true},1).wait(3).to({_off:false,x:-80.7,y:20.475},0).to({_off:true},1).wait(2).to({_off:false,x:-70.9,y:12.525},0).wait(1).to({x:-67.2,y:9.525},0).to({_off:true},1).wait(2).to({_off:false,x:-57.4,y:1.575},0).to({_off:true},1).wait(3).to({_off:false,x:-47.95,y:-6.025},0).wait(1).to({x:-46.25,y:-7.425},0).wait(1).to({x:-44.8,y:-8.575},0).to({_off:true},1).wait(4).to({_off:false,x:-41.55,y:-11.225},0).wait(210));
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(37).to({_off:false},0).to({_off:true},1).wait(6).to({_off:false,x:-88.2,y:26.525},0).wait(1).to({x:-85.95,y:24.725},0).to({_off:true},1).wait(7).to({_off:false,x:-60.4,y:4.025},0).to({_off:true},1).wait(7).to({_off:false,x:-43.65,y:-9.525},0).wait(1).to({x:-42.75,y:-10.275},0).to({_off:true},1).wait(212));
	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(38).to({_off:false},0).to({_off:true},1).wait(7).to({_off:false,x:-83.45,y:22.675},0).to({_off:true},1).wait(1).to({_off:false,x:-77.7,y:18.025},0).wait(1).to({x:-74.45,y:15.375},0).to({_off:true},1).wait(2).to({_off:false,x:-63.65,y:6.675},0).to({_off:true},1).wait(2).to({_off:false,x:-54.65,y:-0.625},0).to({_off:true},1).wait(7).to({_off:false,x:-42.05,y:-10.825},0).wait(1).to({x:-41.7,y:-11.125},0).to({_off:true},1).wait(210));
	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(39).to({_off:false},0).wait(1).to({x:-94.45,y:31.575},0).to({_off:true},1).wait(1).to({_off:false,x:-91.85,y:29.475},0).to({_off:true},1).wait(13).to({_off:false,x:-52.15,y:-2.675},0).wait(1).to({x:-49.9,y:-4.475},0).to({_off:true},1).wait(217));

	// Layer_4
	this.instance = new lib.BSWH_Logo();
	this.instance.setTransform(-70.1,25.95,0.3549,0.3549,0,0,0,-0.8,-14.2);
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("A3gO2IAA9rMAvBAAAIAAdrg");
	mask_1.setTransform(-11.45,57.05);

	// Layer_1
	this.instance_1 = new lib.white_bg();
	this.instance_1.setTransform(-166,-41,1.04,1.0994);
...
p.nominalBounds = new cjs.Rectangle(-161.9,-37.9,301,190);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(89.25,169.95,0.6824,0.6824);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#008FBE").ss(2,1,1).p("AxLi1MAiXAAAIAAFrMgiXAAAg");
	this.shape.setTransform(-1.45,169.5);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("At+B3IAAjtIb9AAIAADtg");
	mask.setTransform(-13.575,170.725);

	// Layer_1
	this.instance_1 = new lib.ctaTxt();
	this.instance_1.setTransform(-101,163,0.9851,0.9851);
...
}).prototype = getMCSymbolPrototype(lib.cta_txt, new cjs.Rectangle(-112.4,150.3,221.9,38.39999999999998), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-67.85,-67.35,0.7924,0.7924,0,0,0,-1.9,-35.6);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-84.85,alpha:1},10,cjs.Ease.quadOut).wait(146).to({_off:true},1).wait(318));

	// txt_healthy
	this.instance_1 = new lib.txt_healthy();
	this.instance_1.setTransform(-67.2,-35.55,0.7902,0.7902,0,0,0,-1.2,5);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(3).to({_off:false},0).to({y:-53.05,alpha:1},10,cjs.Ease.quadOut).wait(143).to({_off:true},1).wait(318));

	// txt_withUs
	this.instance_2 = new lib.txt_withUs();
	this.instance_2.setTransform(-67.65,-5.25,0.7896,0.7896,0,0,0,-1.2,42.7);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({_off:false},0).to({y:-22.75,alpha:1},10,cjs.Ease.quadOut).wait(140).to({_off:true},1).wait(318));

	// txt_withUs
	this.instance_3 = new lib.txt_better();
	this.instance_3.setTransform(-67.65,-5.25,0.7896,0.7896,0,0,0,-1.2,42.7);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(9).to({_off:false},0).to({y:-22.75,alpha:1},10,cjs.Ease.quadOut).wait(137).to({_off:true},1).wait(318));

	// cta_txt
	this.instance_4 = new lib.cta_txt();
	this.instance_4.setTransform(-66.55,48.8,0.6548,0.6548,0,0,0,-0.6,0.1);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(13).to({_off:false},0).to({alpha:1},14).wait(129).to({_off:true},1).wait(318));

	// Layer_3 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("AtHKeIAA07IaPAAIAAU7g");
	var mask_graphics_156 = new cjs.Graphics().p("AtHKeIAA07IaPAAIAAU7g");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-66.95,y:-227.95}).wait(156).to({graphics:mask_graphics_156,x:-66.95,y:-227.95}).wait(1).to({graphics:null,x:0,y:0}).wait(318));

	// white_bg
	this.instance_5 = new lib.white_box();
	this.instance_5.setTransform(2.05,-456.95,1,1,0,0,0,0,-0.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({x:3.05,y:-255.9},16,cjs.Ease.quadOut).to({y:-261.9},3).wait(137).to({_off:true},1).wait(318));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-150.9,-294.9,168,467.59999999999997);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-68.65,-158.9,0.7939,0.7939,0,0,0,-0.4,-155.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},358).wait(1));

	// stair_animation
	this.instance_1 = new lib.stair_animation("synched",0);
	this.instance_1.setTransform(-56.3,-22.65,0.7939,0.7939,0,0,0,16.1,18.2);
	...
	this.instance_2.setTransform(-69.15,67.65,0.7939,0.7939,0,0,0,-0.4,131.3);
...
p.nominalBounds = new cjs.Rectangle(-156.9,-300,306.9,600);
...
p.nominalBounds = new cjs.Rectangle(-150,-301,300,691);


// stage content:
(lib.BSWH_moving_160x600_v01 = function(mode,startPosition,loop,reversed) {
...
p.nominalBounds = new cjs.Rectangle(-512,295.4,1704,395.4);
// library properties:
lib.properties = {
