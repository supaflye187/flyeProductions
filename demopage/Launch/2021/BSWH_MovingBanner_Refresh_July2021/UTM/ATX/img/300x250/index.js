...
(lib.txt_changing_Healthcare = function() {
	this.initialize(img.txt_changing_Healthcare);
}).prototype = p = new cjs.Bitmap();
...
p.nominalBounds = new cjs.Rectangle(0,0,186,68);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("A5bDVIAAmpMAy4AAAIAAGpg");
	mask.setTransform(67.7,78.8);

	// Layer_1
	this.instance = new lib.txt_changing_Healthcare();
	this.instance.setTransform(-97,62,1.1885,1.1885);
...
}).prototype = getMCSymbolPrototype(lib.txt_staySafe, new cjs.Rectangle(-95.1,62,319,38.099999999999994), null);
...
}).prototype = getMCSymbolPrototype(lib.txt_moving, new cjs.Rectangle(-127,-86,186,68), null);
...
}).prototype = getMCSymbolPrototype(lib.txt_makeBetter, new cjs.Rectangle(-126,-82,221,62), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AxdC4IAAlvMAi7AAAIAAFvg");
	mask.setTransform(66,117.75);

	// Layer_1
	this.instance = new lib.txt_changing_Healthcare();
	this.instance.setTransform(-99,62,1.1885,1.1885);
...
}).prototype = getMCSymbolPrototype(lib.txt_healthy, new cjs.Rectangle(-45.8,99.4,223.7,31.599999999999994), null);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(76).call(this.frame_76).wait(199));
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("A4SIjIAAxFMAwlAAAIAARFg");
	mask_1.setTransform(2.025,-300.7);

	// Layer_1
	this.instance_1 = new lib.white_bg();
	this.instance_1.setTransform(-154,-385,1.04,1.0994);
...
p.nominalBounds = new cjs.Rectangle(-153.4,-355.4,310.9,109.49999999999997);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(211.65,103.25,0.6824,0.6824);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#008FBE").ss(2,1,1).p("Axli7MAjLAAAIAAF3MgjLAAAg");
	this.shape.setTransform(120.75,102.6);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AuYB0IAAjnIcyAAIAADng");
	mask.setTransform(108.15,102.975);
...
}).prototype = getMCSymbolPrototype(lib.cta_txt, new cjs.Rectangle(7.2,82.8,227.10000000000002,39.60000000000001), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-55.75,-236.4,0.8444,0.8444,0,0,0,-1.9,-35.6);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-248.4,alpha:1},10,cjs.Ease.quadOut).wait(146).to({_off:true},1).wait(318));

	// txt_healthy
	this.instance_1 = new lib.txt_healthy();
	this.instance_1.setTransform(-53.05,-202.05,0.8421,0.8421,0,0,0,-1.2,4.9);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(3).to({_off:false},0).to({y:-214.05,alpha:1},10,cjs.Ease.quadOut).wait(143).to({_off:true},1).wait(318));

	// cta_txt
	this.instance_2 = new lib.cta_txt();
	this.instance_2.setTransform(-69.6,-144,0.5941,0.5941,0,0,0,-0.7,-0.1);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(13).to({_off:false},0).to({alpha:1},14).wait(129).to({_off:true},1).wait(318));

	// white_bg
	this.instance_3 = new lib.white_box();
	this.instance_3.setTransform(1.05,-47.95,1,1,0,0,0,0,-0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:60.55},16,cjs.Ease.quadOut).to({y:58.05},3,cjs.Ease.quadOut).wait(137).to({_off:true},1).wait(318));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-152.9,-432.4,312,361.59999999999997);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-94.7,-212.9,0.6207,0.6207,0,0,0,-1,-194.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},358).wait(1));

	// stair_animation
	this.instance_1 = new lib.stair_animation("synched",0);
	this.instance_1.setTransform(0.3,-212.05,0.621,0.621,0,0,0,2.4,-47.2);
	...
	this.instance_2.setTransform(93.9,-208.7,0.621,0.621,0,0,0,1.2,105.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(359));

	// txt
	this.instance_3 = new lib.txt_moving();
	this.instance_3.setTransform(34,-40.95,1,1,0,0,0,-0.5,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:-60.95},8).to({_off:true},350).wait(1));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(93.1,-213.95,0.621,0.621,0,0,0,-0.1,98.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(494));

	// trashCan_animation
	this.instance_1 = new lib.trashCan_animation("synched",0);
	this.instance_1.setTransform(-6.9,-202.5,0.621,0.621,0,0,0,-10.1,-30.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(494));

	// magnify_animation
	this.instance_2 = new lib.magnify_animation("synched",0);
	this.instance_2.setTransform(-93.6,-214,0.621,0.621,0,0,0,-0.4,-194.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(494));

	// text_Better
	this.instance_3 = new lib.txt_makeBetter();
	this.instance_3.setTransform(15,39.45);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:-65.55},10,cjs.Ease.quadOut).wait(484));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-150.1,-300,300.1,600);


// stage content:
(lib.BSWH_moving_300x250_v01 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(153).to({_off:false},0).to({x:148.05,mode:"synched",loop:false},24,cjs.Ease.quadInOut).wait(157));
...
p.nominalBounds = new cjs.Rectangle(-442,12.4,1634,587.6);
// library properties:
lib.properties = {
	...
	manifest: [
		...
		{src:"txt_changing_Healthcare.png", id:"txt_changing_Healthcare"},
