...
p.nominalBounds = new cjs.Rectangle(0,0,222,179);
...
if (reversed == null) { reversed = false; }
	...
	mask._off = true;
	mask.graphics.p("AvCLkIAAnHIeEAAIAAHHg");
	mask.setTransform(-2.2,74.025);

	// Layer_1
	this.instance = new lib.txt_changing_healthCare();
	this.instance.setTransform(-111,9);
...
}).prototype = getMCSymbolPrototype(lib.txt_withUs, new cjs.Rectangle(-98.4,102.6,192.5,45.5), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("Aw0D/IAAn9MAhpAAAIAAH9g");
	mask.setTransform(2.8,32.55);
...
}).prototype = getMCSymbolPrototype(lib.txt_staySafe, new cjs.Rectangle(-104.9,9,215.5,49.1), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AyKDrIAAnVMAkVAAAIAAHVg");
	mask.setTransform(1.8,78.05);
...
}).prototype = getMCSymbolPrototype(lib.txt_healthy, new cjs.Rectangle(-110,54.6,222,46.99999999999999), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AvCPUIAAnHIeEAAIAAHHg");
	mask.setTransform(-2.2,98.025);
...
}).prototype = getMCSymbolPrototype(lib.txt_Better, new cjs.Rectangle(-98.4,150.6,192.5,37.400000000000006), null);
...
if (reversed == null) { reversed = false; }
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(62).call(this.frame_62).wait(213));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).wait(33).to({_off:false},0).wait(1).to({x:-41.075,y:12.225},0).wait(1).to({x:-40.475,y:11.725},0).wait(1).to({x:-39.475,y:10.875},0).wait(1).to({x:-38.075,y:9.775},0).wait(1).to({x:-36.275,y:8.275},0).wait(1).to({x:-34.025,y:6.475},0).wait(1).to({x:-31.425,y:4.325},0).wait(1).to({x:-28.425,y:1.875},0).wait(1).to({x:-24.975,y:-0.925},0).wait(1).to({x:-21.175,y:-4.025},0).wait(1).to({x:-16.975,y:-7.475},0).wait(1).to({x:-12.325,y:-11.275},0).wait(1).to({x:-7.325,y:-15.375},0).wait(1).to({x:-1.875,y:-19.775},0).wait(1).to({x:3.825,y:-24.475},0).wait(1).to({x:9.275,y:-28.875},0).wait(1).to({x:14.275,y:-32.975},0).wait(1).to({x:18.925,y:-36.775},0).wait(1).to({x:23.125,y:-40.225},0).wait(1).to({x:26.925,y:-43.325},0).wait(1).to({x:30.375,y:-46.125},0).wait(1).to({x:33.375,y:-48.575},0).wait(1).to({x:35.975,y:-50.725},0).wait(1).to({x:38.225,y:-52.525},0).wait(1).to({x:40.025,y:-53.975},0).wait(1).to({x:41.425,y:-55.125},0).wait(1).to({x:42.425,y:-55.975},0).wait(1).to({x:43.025,y:-56.475},0).wait(1).to({x:43.225,y:-56.625},0).wait(213));
	...
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("A/8RMMAAAgiXMA/5AAAMAAAAiXg");
	mask_1.setTransform(11.525,-18.95);
...
p.nominalBounds = new cjs.Rectangle(-156,-100,312,191.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(90.95,151.45,0.6824,0.6824);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#008FBE").ss(2,1,1).p("AxLi1MAiXAAAIAAFrMgiXAAAg");
	this.shape.setTransform(0.25,151);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("At7BwIAAjgIb4AAIAADgg");
	mask.setTransform(-9.25,151.75);

	// Layer_1
	this.instance_1 = new lib.ctaTxt();
	this.instance_1.setTransform(-96,143,0.9676,0.9676);
...
}).prototype = getMCSymbolPrototype(lib.cta_txt, new cjs.Rectangle(-110.7,131.8,221.9,38.39999999999998), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(0.35,-68.75,1,1,0,0,0,-1.7,-35.5);
	this.instance.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-80.75,alpha:1},10,cjs.Ease.quadOut).wait(146).to({_off:true},1).wait(318));

	// txt_healthy
	this.instance_1 = new lib.txt_healthy();
	this.instance_1.setTransform(0.85,-28.05,1,1,0,0,0,-1.2,5);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(3).to({_off:false},0).to({y:-40.05,alpha:1},10,cjs.Ease.quadOut).wait(143).to({_off:true},1).wait(318));

	// txt_withUs
	this.instance_2 = new lib.txt_withUs();
	this.instance_2.setTransform(1.35,10.3,1,1,0,0,0,-1.2,42.8);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(6).to({_off:false},0).to({y:-1.7,alpha:1},10,cjs.Ease.quadOut).wait(140).to({_off:true},1).wait(318));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(9).to({_off:false},0).to({y:-1.7,alpha:1},10,cjs.Ease.quadOut).wait(137).to({_off:true},1).wait(318));
	...
	this.instance_5.setTransform(3.05,-392.9,1,1,0,0,0,0,-0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_5).to({y:-194.9},16,cjs.Ease.quadOut).to({y:-202.9},3,cjs.Ease.quadOut).wait(137).to({_off:true},1).wait(318));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-190.9,-522.3,411,752.5);
...
p.nominalBounds = new cjs.Rectangle(-442,97.9,1634,586.9);
// library properties:
lib.properties = {
