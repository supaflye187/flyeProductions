...
p.nominalBounds = new cjs.Rectangle(0,0,176,13);
...
(lib.txt_changingHealthcare = function() {
	this.initialize(img.txt_changingHealthcare);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,342,22);


(lib.txt_painful = function() {
	this.initialize(img.txt_painful);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,238,21);


(lib.txt_weCanMakeItBetter = function() {
	this.initialize(img.txt_weCanMakeItBetter);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,233,19);


(lib.white_bgjpgcopy = function() {
	this.initialize(img.white_bgjpgcopy);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,252,60);
...
(lib.triangle_shape = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#008FBE").s().p("AhUhPIAKAAICfAAIAACVIAAAKg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.triangle_shape, new cjs.Rectangle(-8.5,-8,17,16), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.instance = new lib.txt_changingHealthcare();
	this.instance.setTransform(-312,-27);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_staySafe, new cjs.Rectangle(-312,-27,342,22), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-238,-95);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_moving, new cjs.Rectangle(-238,-95,238,21), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-239,-91);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_makeBetter, new cjs.Rectangle(-239,-91,233,19), null);
...
if (reversed == null) { reversed = false; }
	...
	// BSWH_Logo
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFB71B").s().p("AANG9IAAmvIDaDZIAADWgAjmjmIAAjVIDZAAIAAGug");
	this.shape.setTransform(-131.4,-89.75);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#003DA6").s().p("");
	this.shape_1.setTransform(171.125,-89.75);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#008FBE").s().p("Am8DnIAAjZIGvAAIjZDZgAAOgNIDajZIDVAAIAADZg");
	this.shape_2.setTransform(-131.425,-89.75);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.BSWH_Logo, new cjs.Rectangle(-195.9,-154.2,734.1,129), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1632,-300);

	this.instance_1 = new lib.brownBG();
	this.instance_1.setTransform(1637,-300,1,1,0,0,180);

	this.instance_2 = new lib.brownBG();
	this.instance_2.setTransform(1038,-300);

	this.instance_3 = new lib.brownBG();
	this.instance_3.setTransform(1040,-300,1,1,0,0,180);

	this.instance_4 = new lib.brownBG();
	this.instance_4.setTransform(444,-300);

	this.instance_5 = new lib.brownBG();
	this.instance_5.setTransform(446,-300,1,1,0,0,180);

	this.instance_6 = new lib.brownBG();
...
}).prototype = getMCSymbolPrototype(lib.background, new cjs.Rectangle(-150,-300,2082,600), null);
...
if (reversed == null) { reversed = false; }
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("");
	mask.setTransform(-106.4628,-294.8927);

	// Layer_3
	this.shape = new cjs.Shape();
	this.shape.graphics.lf(["rgba(1,142,190,0)","#FFFFFF","rgba(1,142,190,0)"],[0,0.463,1],-21.1,18.7,21.3,-18.7).s().p("Al7gBIGnl3IFPF6ImnF3g");
	this.shape.setTransform(-146.65,-261.425);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["rgba(1,142,190,0)","#FFFFFF","rgba(1,142,190,0)"],[0,0.463,1],-21.1,18.7,21.3,-18.7).s().p("Al6gBIGnl3IFOF6ImnF3g");
	this.shape_1.setTransform(-145.85,-262.075);
	this.shape_1._off = true;

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["rgba(1,142,190,0)","#FFFFFF","rgba(1,142,190,0)"],[0,0.463,1],-21.1,18.7,21.3,-18.7).s().p("Al7gBIGnl3IFQF6ImnF3g");
	this.shape_2.setTransform(-144.9,-262.825);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.lf(["rgba(1,142,190,0)","#FFFFFF","rgba(1,142,190,0)"],[0,0.463,1],-21.1,18.7,21.3,-18.7).s().p("Al6gBIGml3IFPF6ImnF3g");
	this.shape_3.setTransform(-143.5,-263.925);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.lf(["rgba(1,142,190,0)","#FFFFFF","rgba(1,142,190,0)"],[0,0.463,1],-21.1,18.7,21.3,-18.7).s().p("Al7gBIGnl3IFQF6ImoF3g");
	this.shape_4.setTransform(-139.6,-267.125);
	this.shape_4._off = true;

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.lf(["rgba(1,142,190,0)","#FFFFFF","rgba(1,142,190,0)"],[0,0.463,1],-21.1,18.7,21.3,-18.7).s().p("Al6gBIGnl3IFPF6ImnF3g");
	this.shape_5.setTransform(-137.05,-269.175);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.lf(["rgba(1,142,190,0)","#FFFFFF","rgba(1,142,190,0)"],[0,0.463,1],-21.1,18.7,21.3,-18.7).s().p("Al6gBIGnl3IFOF6ImmF3g");
	this.shape_6.setTransform(-108.15,-292.325);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.lf(["rgba(1,142,190,0)","#FFFFFF","rgba(1,142,190,0)"],[0,0.463,1],-21.1,18.7,21.3,-18.7).s().p("Al7gBIGol3IFPF6ImnF3g");
	this.shape_7.setTransform(-80,-314.975);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape,p:{x:-146.65,y:-261.425}}]},23).to({state:[{t:this.shape,p:{x:-146.45,y:-261.575}}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_2,p:{x:-144.9,y:-262.825}}]},1).to({state:[{t:this.shape_3,p:{x:-143.5,y:-263.925}}]},1).to({state:[{t:this.shape_2,p:{x:-141.75,y:-265.375}}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5,p:{x:-137.05,y:-269.175}}]},1).to({state:[{t:this.shape_2,p:{x:-134.1,y:-271.525}}]},1).to({state:[{t:this.shape_5,p:{x:-130.75,y:-274.175}}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_6,p:{x:-108.15,y:-292.325}}]},1).to({state:[{t:this.shape_2,p:{x:-102.6,y:-296.825}}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_7,p:{x:-80,y:-314.975}}]},1).to({state:[{t:this.shape_6,p:{x:-76.65,y:-317.625}}]},1).to({state:[{t:this.shape_7,p:{x:-73.7,y:-319.975}}]},1).to({state:[{t:this.shape_1}]},1).to({state:[{t:this.shape_6,p:{x:-69,y:-323.775}}]},1).to({state:[{t:this.shape,p:{x:-67.25,y:-325.225}}]},1).to({state:[{t:this.shape_6,p:{x:-65.85,y:-326.325}}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_3,p:{x:-64.3,y:-327.575}}]},1).to({state:[{t:this.shape,p:{x:-64.1,y:-327.725}}]},1).wait(223));
	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(25).to({_off:false},0).to({_off:true},1).wait(8).to({_off:false,x:-122.9,y:-280.525},0).wait(1).to({x:-118.4,y:-284.125},0).wait(1).to({x:-113.45,y:-288.075},0).to({_off:true},1).wait(5).to({_off:false,x:-83.75,y:-311.975},0).to({_off:true},1).wait(3).to({_off:false,x:-71.15,y:-322.025},0).to({_off:true},1).wait(228));
	this.timeline.addTween(cjs.Tween.get(this.shape_4).wait(29).to({_off:false},0).to({_off:true},1).wait(3).to({_off:false,x:-127,y:-277.175},0).to({_off:true},1).wait(5).to({_off:false,x:-97.3,y:-301.075},0).wait(1).to({x:-92.35,y:-305.025},0).wait(1).to({x:-87.85,y:-308.625},0).to({_off:true},1).wait(8).to({_off:false,x:-64.9,y:-327.075},0).to({_off:true},1).wait(224));

	// Layer_4
	this.instance = new lib.BSWH_Logo();
	this.instance.setTransform(-60.1,-268.05,0.3549,0.3549,0,0,0,-0.8,-14.2);
...
p.nominalBounds = new cjs.Rectangle(-129.5,-317.9,260.7,46.099999999999966);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_5
	this.instance = new lib.triangle_shape();
	this.instance.setTransform(36.5,-3.75,0.5938,0.5938);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_4
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#008FBE").ss(2,1,1).p("AuLiTIcXAAIAAEnI8XAAg");
	this.shape.setTransform(-39.25,-4);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("ArlBlIAAjJIXMAAIAADJg");
	mask.setTransform(-48,-3.625);

	// Layer_2
	this.instance_1 = new lib.ctaTxt();
	this.instance_1.setTransform(-120,-9,0.9245,0.9245);
...
}).prototype = getMCSymbolPrototype(lib.cta_txt, new cjs.Rectangle(-131,-19.7,183.5,31.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(228.05,-209.15);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({y:-253.65},12,cjs.Ease.quadOut).wait(484));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-83.9,-280.6,342,66.50000000000003);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-1.6,-255.8,1,1,0,0,0,-0.7,-0.1);
	this.instance.alpha = 0;
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(3).to({_off:false},0).to({alpha:1},14).wait(77).to({_off:true},1).wait(380));

	// white_BG_Mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_0 = new cjs.Graphics().p("AmtobQgUgaAEgaQAAgHAUg9IAZhEQAOgbAvgUQAXgKgMgOQgIgKghgRQhMgpAHgSIAehQQAEgPAIgqQAJgnASgTQAUgSAEhGQADgjgCggIAtg3IHkhfIAVgQQAZgSATgGQASgGAbACIAtAEQATAAAXgcQALgNAHgOQgDgDZsgbIZsgZIAAPjQv9AKwBAFQpKADmkAAQwZAAgNgSg");
	var mask_graphics_1 = new cjs.Graphics().p("");
	var mask_graphics_2 = new cjs.Graphics().p("");
	var mask_graphics_3 = new cjs.Graphics().p("");
	var mask_graphics_4 = new cjs.Graphics().p("");
	var mask_graphics_5 = new cjs.Graphics().p("");
	var mask_graphics_6 = new cjs.Graphics().p("");
	var mask_graphics_7 = new cjs.Graphics().p("");
	var mask_graphics_8 = new cjs.Graphics().p("");
	var mask_graphics_9 = new cjs.Graphics().p("");
	var mask_graphics_10 = new cjs.Graphics().p("");
	var mask_graphics_11 = new cjs.Graphics().p("");
	var mask_graphics_12 = new cjs.Graphics().p("");
	var mask_graphics_13 = new cjs.Graphics().p("AxNsfQgOgSADgSQAAgFAOgqIARgvQAKgTAggOQAfgNALgYQAHgOAHgdQAFgNAHgNQAFgMAEgKQAEgNAdgbIArgoIBXhTIAfgmIAhgRQAjgTAJgNQAOgVADgYIAPgMQARgMANgEQANgEASABIAgADQANAAAPgTQAIgKAFgJQgCgCR0gTIR1gRIAAKyQrFAHrHAEQmVACkkAAQrZAAgJgNg");
	var mask_graphics_94 = new cjs.Graphics().p("A2OFTQgNgSACgSQABgFAOgqIARgwQAKgSAggOQAfgNALgYQAHgOAGgdQAGgOAGgMIAJgWQAEgNAegbIArgnIBXhTIAfgnIAhgQQAjgTAIgNQAOgWAEgYIAPgLQARgMANgEQAMgFATACIAfADQANAAAQgTQAIgKAFgKQgCgCR0gSIR1gSIAAKyQrFAHrHAEQmWACkjAAQrZAAgKgNg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:368.55,y:-153.525}).wait(1).to({graphics:mask_graphics_1,x:530.3984,y:-256.3821}).wait(1).to({graphics:mask_graphics_2,x:529.0234,y:-256.3821}).wait(1).to({graphics:mask_graphics_3,x:523.1484,y:-256.4196}).wait(1).to({graphics:mask_graphics_4,x:507.3045,y:-256.7423}).wait(1).to({graphics:mask_graphics_5,x:473.9286,y:-257.4383}).wait(1).to({graphics:mask_graphics_6,x:413.2269,y:-258.6816}).wait(1).to({graphics:mask_graphics_7,x:324.7071,y:-260.5107}).wait(1).to({graphics:mask_graphics_8,x:263.9985,y:-261.7539}).wait(1).to({graphics:mask_graphics_9,x:230.6219,y:-262.45}).wait(1).to({graphics:mask_graphics_10,x:214.7792,y:-262.7851}).wait(1).to({graphics:mask_graphics_11,x:208.9042,y:-262.9101}).wait(1).to({graphics:mask_graphics_12,x:207.5542,y:-262.9351}).wait(1).to({graphics:mask_graphics_13,x:175.4343,y:-149.0491}).wait(81).to({graphics:mask_graphics_94,x:207.4555,y:-262.925}).wait(1).to({graphics:null,x:0,y:0}).wait(380));

	// BSWH_LOGO
	this.instance_1 = new lib.white_box("synched",0,false);
	this.instance_1.setTransform(203.75,-260.5,0.695,0.695,0,0,0,1.1,-295.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(94).to({startPosition:94},0).to({_off:true},1).wait(380));

	// white_BG
	this.instance_2 = new lib.white_bgjpgcopy();
	this.instance_2.setTransform(68,-290);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(94).to({_off:true},1).wait(380));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-147,-290,468,60);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-99.65,-270.2,0.3446,0.3446,0,0,0,-1.4,-194.6);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},358).wait(1));

	// stair_animation
	this.instance_1 = new lib.stair_animation("synched",0);
	this.instance_1.setTransform(-46.95,-269.75,0.3447,0.3447,0,0,0,2,-47.6);
	...
	this.instance_2.setTransform(5.05,-267.85,0.3447,0.3447,0,0,0,1.6,105.2);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(359));

	// txt
	this.instance_3 = new lib.txt_moving();
	this.instance_3.setTransform(290.05,-168.95,1,1,0,0,0,-0.5,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:-183.95},8).to({_off:true},350).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-150,-304.6,468,84.70000000000002);
...
if (reversed == null) { reversed = false; }
	...
	// magnify_animation
	this.instance = new lib.magnify_animation("synched",0);
	this.instance.setTransform(-99.2,-270.9,0.3424,0.3424,0,0,0,-0.6,-194.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(494));

	// clock_animation
	this.instance_1 = new lib.clock_animation("synched",0);
	this.instance_1.setTransform(3.7,-270.9,0.3424,0.3424,0,0,0,-0.1,98.3);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(494));

	// trashCan_animation
	this.instance_2 = new lib.trashCan_animation("synched",0);
	this.instance_2.setTransform(-51.4,-264.55,0.3424,0.3424,0,0,0,-10.2,-30.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(494));

	// text_Better
	this.instance_3 = new lib.txt_makeBetter();
	this.instance_3.setTransform(288.05,-125.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({y:-188.6},10,cjs.Ease.quadOut).wait(484));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-130.3,-309.2,412.40000000000003,112.1);


// stage content:
(lib.BSWH_moving_468x60_v01 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(51).to({mode:"independent"},0).to({x:-298},23,cjs.Ease.quadInOut).to({_off:true},1).wait(260));

	// Frame_02
	this.instance_1 = new lib.Frame_02("single",0);
	this.instance_1.setTransform(583.05,300);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(51).to({_off:false},0).to({x:149.9,y:300.75,mode:"independent"},23,cjs.Ease.quadInOut).wait(67).to({x:150.05,y:300},0).to({x:-288.95},24,cjs.Ease.quadInOut).to({_off:true},1).wait(169));

	// Frame_03
	this.instance_2 = new lib.Frame_04("single",0);
	this.instance_2.setTransform(620.05,309,1,1,0,0,0,0,9.7);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(141).to({_off:false},0).to({x:148.05,mode:"independent"},24,cjs.Ease.quadInOut).wait(46).to({x:-441.95},24,cjs.Ease.quadInOut).wait(100));

	// Frame_04
	this.instance_3 = new lib.Frame_03("single",0);
	this.instance_3.setTransform(619.05,300,1,1,0,0,0,0,9.7);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(216).to({_off:false},0).to({x:148.05,mode:"synched",loop:false},24,cjs.Ease.quadInOut).wait(95));

	// background
	this.instance_4 = new lib.background();
	this.instance_4.setTransform(596,300,1,1,0,0,0,446,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(51).to({x:294},31,cjs.Ease.quadInOut).wait(59).to({x:4},32,cjs.Ease.quadInOut).wait(43).to({x:-298},31,cjs.Ease.quadInOut).wait(88));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(-660,25.3,2742,574.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"arrow.png?1625515418300", id:"arrow"},
		{src:"back.png?1625515418300", id:"back"},
		{src:"box_01.jpg?1625515418300", id:"box_01"},
		{src:"box_2.jpg?1625515418300", id:"box_2"},
		{src:"box_outline.png?1625515418300", id:"box_outline"},
		{src:"box_outline_blue.png?1625515418300", id:"box_outline_blue"},
		{src:"brownBG.jpg?1625515418300", id:"brownBG"},
		{src:"clock_arm.png?1625515418300", id:"clock_arm"},
		{src:"clock_BG.png?1625515418300", id:"clock_BG"},
		{src:"clock_ticks.png?1625515418300", id:"clock_ticks"},
		{src:"clock_yellow_bar.png?1625515418300", id:"clock_yellow_bar"},
		{src:"ctaTxt.png?1625515418300", id:"ctaTxt"},
		{src:"dr_image.png?1625515418300", id:"dr_image"},
		{src:"dr_stethoscope.png?1625515418300", id:"dr_stethoscope"},
		{src:"magnifyGlass.png?1625515418300", id:"magnifyGlass"},
		{src:"stairPart.jpg?1625515418300", id:"stairPart"},
		{src:"trashCan.png?1625515418300", id:"trashCan"},
		{src:"trashCan_yellow_bar.png?1625515418300", id:"trashCan_yellow_bar"},
		{src:"txt_changingHealthcare.png?1625515418300", id:"txt_changingHealthcare"},
		{src:"txt_painful.png?1625515418300", id:"txt_painful"},
		{src:"txt_weCanMakeItBetter.png?1625515418300", id:"txt_weCanMakeItBetter"},
		{src:"white_bgjpgcopy.jpg?1625515418300", id:"white_bgjpgcopy"},
		{src:"wht_trashcan.png?1625515418300", id:"wht_trashcan"}
	],
	preloads: []
};
