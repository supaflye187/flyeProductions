...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.beginFill("#008FBE").beginStroke().moveTo(5,8.3).curveTo(3.4,7.6,2.2,6.4).curveTo(1,5.2,0.3,3.5).curveTo(-0.4,1.9,-0.4,0).curveTo(-0.4,-1.9,0.3,-3.5).curveTo(1,-5.1,2.2,-6.3).curveTo(3.4,-7.6,5,-8.3).curveTo(6.7,-9,8.5,-9).curveTo(10.4,-9,12,-8.3).curveTo(13.7,-7.6,14.9,-6.3).curveTo(16.1,-5.1,16.8,-3.5).curveTo(17.5,-1.9,17.5,0).curveTo(17.5,1.9,16.8,3.5).curveTo(16.1,5.2,14.9,6.4).curveTo(13.7,7.6,12.1,8.3).curveTo(10.4,9,8.5,9).curveTo(6.7,9,5,8.3).closePath().moveTo(6.7,-4.5).curveTo(5.8,-4.1,5.2,-3.4).curveTo(4.5,-2.8,4.2,-1.9).curveTo(3.8,-1,3.8,0).curveTo(3.8,1,4.2,1.9).curveTo(4.5,2.8,5.1,3.4).curveTo(5.8,4.1,6.6,4.5).curveTo(7.5,4.9,8.5,4.9).curveTo(9.6,4.9,10.5,4.5).curveTo(11.3,4.1,12,3.4).curveTo(12.6,2.8,13,1.9).curveTo(13.3,1,13.3,0).curveTo(13.3,-1,13,-1.9).curveTo(12.6,-2.8,12,-3.4).curveTo(11.3,-4.1,10.4,-4.5).curveTo(9.6,-4.9,8.5,-4.9).curveTo(7.5,-4.9,6.7,-4.5).closePath().moveTo(-41.7,8.8).curveTo(-42.9,8.5,-43.8,8).curveTo(-44.8,7.6,-45.5,6.9).lineTo(-46.9,5.5).lineTo(-43.3,2.6).curveTo(-42.5,3.8,-41.5,4.5).curveTo(-40.4,5.1,-38.9,5.1).curveTo(-37.9,5.1,-37.3,4.7).curveTo(-36.8,4.2,-36.8,3.5).curveTo(-36.8,3,-37,2.8).curveTo(-37.2,2.5,-37.7,2.2).lineTo(-38.8,1.8).lineTo(-42.3,0.9).curveTo(-43.3,0.6,-44.1,0).curveTo(-44.9,-0.5,-45.4,-1.4).curveTo(-45.9,-2.3,-45.9,-3.7).curveTo(-45.9,-4.8,-45.4,-5.8).curveTo(-44.9,-6.8,-44.1,-7.5).curveTo(-43.3,-8.2,-42.1,-8.6).curveTo(-40.9,-9,-39.5,-9).curveTo(-38.3,-9,-37.3,-8.8).curveTo(-36.3,-8.6,-35.5,-8.2).curveTo(-34.7,-7.8,-33.9,-7.2).lineTo(-32.5,-5.9).lineTo(-35.9,-3.3).curveTo(-36.5,-4.3,-37.4,-4.8).curveTo(-38.3,-5.4,-39.6,-5.4).curveTo(-40.7,-5.4,-41.2,-4.9).curveTo(-41.7,-4.4,-41.7,-3.8).curveTo(-41.7,-3.4,-41.4,-3.1).curveTo(-41.2,-2.9,-40.7,-2.7).lineTo(-36.1,-1.5).curveTo(-35.1,-1.1,-34.3,-0.6).curveTo(-33.5,0,-32.9,0.9).curveTo(-32.4,1.9,-32.4,3.3).curveTo(-32.4,4.5,-32.9,5.6).curveTo(-33.4,6.6,-34.3,7.4).curveTo(-35.2,8.2,-36.4,8.6).curveTo(-37.7,9,-39.1,9).curveTo(-40.6,9,-41.7,8.8).closePath().moveTo(34.8,8.8).lineTo(34.8,-8.7).lineTo(46.9,-8.7).lineTo(46.9,-4.9).lineTo(39,-4.9).lineTo(39,-2).lineTo(46.9,-2).lineTo(46.9,1.9).lineTo(39,1.9).lineTo(39,4.9).lineTo(46.9,4.9).lineTo(46.9,8.8).closePath().moveTo(29.5,8.8).lineTo(25.7,0.5).lineTo(23.4,3.4).lineTo(23.4,8.8).lineTo(19.2,8.8).lineTo(19.2,-8.7).lineTo(23.4,-8.7).lineTo(23.4,-1.6).lineTo(29,-8.7).lineTo(33.9,-8.7).lineTo(28.8,-2.3).lineTo(33.9,8.8).closePath().moveTo(-5.8,8.8).lineTo(-8.3,3.5).lineTo(-11.6,3.5).lineTo(-11.6,8.8).lineTo(-15.8,8.8).lineTo(-15.8,-8.7).lineTo(-8.2,-8.7).curveTo(-6.7,-8.7,-5.4,-8.3).curveTo(-4.2,-7.8,-3.4,-7).curveTo(-2.5,-6.2,-2.1,-5.1).curveTo(-1.7,-4,-1.7,-2.7).curveTo(-1.7,-1,-2.4,0.3).curveTo(-3.2,1.7,-4.5,2.4).lineTo(-1.2,8.8).closePath().moveTo(-11.6,-0.3).lineTo(-8.6,-0.3).curveTo(-7.2,-0.3,-6.6,-1).curveTo(-5.9,-1.6,-5.9,-2.6).curveTo(-5.9,-3.7,-6.6,-4.3).curveTo(-7.2,-4.9,-8.6,-4.9).lineTo(-11.6,-4.9).closePath().moveTo(-26.4,8.8).lineTo(-26.4,-4.9).lineTo(-31.1,-4.9).lineTo(-31.1,-8.7).lineTo(-17.6,-8.7).lineTo(-17.6,-4.9).lineTo(-22.3,-4.9).lineTo(-22.3,8.8).closePath();
	this.shape.setTransform(50.125,17.725);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_Stroke, new cjs.Rectangle(0,0.3,215,35.5), null);


(lib.txt_Spine = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#008FBE").beginStroke().moveTo(61.5,8.4).curveTo(60.8,7.7,60.8,6.7).curveTo(60.8,5.6,61.5,5).curveTo(62.1,4.3,63.2,4.3).curveTo(64.2,4.3,64.9,5).curveTo(65.5,5.6,65.5,6.7).curveTo(65.5,7.7,64.9,8.4).curveTo(64.2,9,63.2,9).curveTo(62.1,9,61.5,8.4).closePath().moveTo(-3.9,8.8).curveTo(-5,8.5,-6,8).curveTo(-6.9,7.6,-7.7,6.9).lineTo(-9.1,5.5).lineTo(-5.5,2.6).curveTo(-4.7,3.8,-3.6,4.5).curveTo(-2.6,5.1,-1.1,5.1).curveTo(-0,5.1,0.5,4.7).curveTo(1.1,4.2,1.1,3.5).curveTo(1.1,3,0.9,2.8).curveTo(0.6,2.5,0.2,2.2).lineTo(-0.9,1.8).lineTo(-4.5,0.9).curveTo(-5.5,0.6,-6.3,0).curveTo(-7.1,-0.5,-7.6,-1.4).curveTo(-8.1,-2.3,-8.1,-3.7).curveTo(-8.1,-4.8,-7.6,-5.8).curveTo(-7.1,-6.8,-6.3,-7.5).curveTo(-5.4,-8.2,-4.3,-8.6).curveTo(-3.1,-9,-1.7,-9).curveTo(-0.5,-9,0.5,-8.8).curveTo(1.5,-8.6,2.3,-8.2).curveTo(3.2,-7.8,3.9,-7.2).lineTo(5.3,-5.9).lineTo(2,-3.3).curveTo(1.3,-4.3,0.5,-4.8).curveTo(-0.4,-5.4,-1.8,-5.4).curveTo(-2.8,-5.4,-3.3,-4.9).curveTo(-3.8,-4.4,-3.8,-3.8).curveTo(-3.8,-3.4,-3.6,-3.1).lineTo(-2.9,-2.7).lineTo(1.7,-1.5).curveTo(2.7,-1.1,3.5,-0.6).curveTo(4.4,0,4.9,0.9).curveTo(5.4,1.9,5.4,3.3).curveTo(5.4,4.5,4.9,5.6).curveTo(4.4,6.6,3.5,7.4).curveTo(2.6,8.2,1.4,8.6).curveTo(0.2,9,-1.3,9).curveTo(-2.7,9,-3.9,8.8).closePath().moveTo(46.9,8.8).lineTo(46.9,-8.7).lineTo(59,-8.7).lineTo(59,-4.9).lineTo(51,-4.9).lineTo(51,-2).lineTo(59,-2).lineTo(59,1.9).lineTo(51,1.9).lineTo(51,4.9).lineTo(59,4.9).lineTo(59,8.8).closePath().moveTo(40.5,8.8).lineTo(33.6,-2.2).lineTo(33.6,8.8).lineTo(29.6,8.8).lineTo(29.6,-8.7).lineTo(34,-8.7).lineTo(40.6,1.8).lineTo(40.6,-8.7).lineTo(44.6,-8.7).lineTo(44.6,8.8).closePath().moveTo(23,8.8).lineTo(23,-8.7).lineTo(27.3,-8.7).lineTo(27.3,8.8).closePath().moveTo(7.3,8.8).lineTo(7.3,-8.7).lineTo(14.3,-8.7).curveTo(15.8,-8.7,17.1,-8.2).curveTo(18.3,-7.7,19.2,-6.8).curveTo(20.1,-5.9,20.6,-4.7).curveTo(21,-3.6,21,-2.2).curveTo(21,-0.9,20.6,0.3).curveTo(20.1,1.5,19.2,2.4).curveTo(18.3,3.3,17.1,3.8).curveTo(15.8,4.4,14.3,4.4).lineTo(11.5,4.4).lineTo(11.5,8.8).closePath().moveTo(11.5,0.5).lineTo(14.1,0.5).curveTo(15.2,0.5,16,-0.2).curveTo(16.8,-1,16.8,-2.2).curveTo(16.8,-3.4,16,-4.2).curveTo(15.2,-4.9,14.1,-4.9).lineTo(11.5,-4.9).closePath().moveTo(-30.1,8.8).lineTo(-30.1,-8.7).lineTo(-23.9,-8.7).curveTo(-21.8,-8.7,-20.1,-8.1).curveTo(-18.5,-7.4,-17.3,-6.2).curveTo(-16.1,-5.1,-15.4,-3.4).curveTo(-14.7,-1.9,-14.7,0).curveTo(-14.7,1.9,-15.4,3.5).curveTo(-16.1,5.1,-17.3,6.3).curveTo(-18.5,7.4,-20.2,8.1).curveTo(-21.8,8.8,-23.8,8.8).closePath().moveTo(-25.9,4.9).lineTo(-24,4.9).curveTo(-22.8,4.9,-21.9,4.5).curveTo(-21,4.1,-20.3,3.5).curveTo(-19.7,2.8,-19.3,1.9).curveTo(-19,1,-19,0).curveTo(-19,-1,-19.3,-1.9).curveTo(-19.6,-2.8,-20.3,-3.4).curveTo(-20.9,-4.1,-21.9,-4.5).curveTo(-22.8,-4.9,-24.1,-4.9).lineTo(-25.9,-4.9).closePath().moveTo(-36.4,8.8).lineTo(-43.3,-2.2).lineTo(-43.3,8.8).lineTo(-47.3,8.8).lineTo(-47.3,-8.7).lineTo(-43,-8.7).lineTo(-36.4,1.8).lineTo(-36.4,-8.7).lineTo(-32.4,-8.7).lineTo(-32.4,8.8).closePath().moveTo(-52.8,8.8).lineTo(-53.7,6.2).lineTo(-60.4,6.2).lineTo(-61.3,8.8).lineTo(-65.5,8.8).lineTo(-59.1,-8.7).lineTo(-55,-8.7).lineTo(-48.5,8.8).closePath().moveTo(-55,2.5).lineTo(-57,-3.4).lineTo(-59.1,2.5).lineTo(-55,2.5).closePath();
	this.shape.setTransform(69.225,17.175);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_Spine, new cjs.Rectangle(1.4,-0.2,136.2,35.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#008FBE").beginStroke().moveTo(68.9,9.4).curveTo(70.1,8.6,70.6,7.8).curveTo(71.1,7,71.2,6.3).curveTo(70.8,6.9,70,6.9).curveTo(69.2,6.9,68.7,6.3).curveTo(68.2,5.7,68.1,4.8).curveTo(68.1,3.8,68.8,3.1).curveTo(69.5,2.5,70.6,2.5).curveTo(71.9,2.5,72.6,3.3).curveTo(73.2,4.2,73.3,5.4).curveTo(73.3,7,72.4,8.3).curveTo(71.6,9.5,70.1,10.6).closePath().moveTo(-15.8,9.4).curveTo(-14.8,8.6,-14.2,7.8).curveTo(-13.7,7,-13.6,6.3).curveTo(-14,6.9,-14.8,6.9).curveTo(-15.6,6.9,-16.1,6.3).curveTo(-16.6,5.7,-16.7,4.8).curveTo(-16.7,3.8,-15.9,3.1).curveTo(-15.3,2.5,-14.2,2.5).curveTo(-12.9,2.5,-12.2,3.3).curveTo(-11.5,4.2,-11.5,5.4).curveTo(-11.5,7,-12.4,8.3).curveTo(-13.2,9.5,-14.7,10.6).closePath().moveTo(62,6.9).lineTo(55.2,-4.1).lineTo(55.2,6.9).lineTo(51.1,6.9).lineTo(51.1,-10.6).lineTo(55.5,-10.6).lineTo(62.1,-0.1).lineTo(62.1,-10.6).lineTo(66.1,-10.6).lineTo(66.1,6.9).closePath().moveTo(44.5,6.9).lineTo(44.5,-10.6).lineTo(48.8,-10.6).lineTo(48.8,6.9).closePath().moveTo(39,6.9).lineTo(38,4.3).lineTo(31.3,4.3).lineTo(30.4,6.9).lineTo(26.2,6.9).lineTo(32.7,-10.6).lineTo(36.7,-10.6).lineTo(43.2,6.9).closePath().moveTo(36.7,0.7).lineTo(34.7,-5.2).lineTo(32.6,0.7).lineTo(36.7,0.7).closePath().moveTo(21.2,6.9).lineTo(18.7,1.7).lineTo(15.4,1.7).lineTo(15.4,6.9).lineTo(11.2,6.9).lineTo(11.2,-10.6).lineTo(18.8,-10.6).curveTo(20.3,-10.6,21.6,-10.1).curveTo(22.8,-9.6,23.7,-8.8).curveTo(24.5,-8,24.9,-6.9).curveTo(25.4,-5.8,25.4,-4.6).curveTo(25.4,-2.9,24.6,-1.5).curveTo(23.9,-0.2,22.5,0.6).lineTo(25.8,6.9).closePath().moveTo(15.4,-2.1).lineTo(18.4,-2.1).curveTo(19.8,-2.1,20.4,-2.8).curveTo(21.1,-3.5,21.1,-4.5).curveTo(21.1,-5.6,20.4,-6.2).curveTo(19.8,-6.8,18.4,-6.8).lineTo(15.4,-6.8).closePath().moveTo(-4.4,6.9).lineTo(-4.4,-10.6).lineTo(2.5,-10.6).curveTo(5.8,-10.6,7.3,-9.3).curveTo(8.9,-8.1,8.9,-5.6).curveTo(8.9,-4.4,8.5,-3.5).curveTo(8,-2.7,7.1,-2.1).curveTo(8.1,-1.6,8.7,-0.6).curveTo(9.2,0.3,9.3,1.6).curveTo(9.2,4.4,7.5,5.6).curveTo(5.7,6.9,2.5,6.9).closePath().moveTo(-0.3,3.3).lineTo(2.6,3.3).curveTo(3.8,3.3,4.4,2.8).curveTo(5,2.4,5,1.5).curveTo(5,0.7,4.4,0.3).curveTo(3.9,-0.2,2.5,-0.2).lineTo(-0.3,-0.2).closePath().moveTo(-0.3,-3.8).lineTo(2.8,-3.8).curveTo(3.8,-3.8,4.3,-4.3).curveTo(4.7,-4.7,4.8,-5.4).curveTo(4.7,-6.2,4.3,-6.6).curveTo(3.8,-6.9,2.7,-6.9).lineTo(-0.3,-6.9).closePath().moveTo(-22.8,6.9).lineTo(-29.6,-4.1).lineTo(-29.6,6.9).lineTo(-33.7,6.9).lineTo(-33.7,-10.6).lineTo(-29.3,-10.6).lineTo(-22.7,-0.1).lineTo(-22.7,-10.6).lineTo(-18.7,-10.6).lineTo(-18.7,6.9).closePath().moveTo(-40.3,6.9).lineTo(-40.3,-10.6).lineTo(-36.1,-10.6).lineTo(-36.1,6.9).closePath().moveTo(-45.8,6.9).lineTo(-46.8,4.3).lineTo(-53.5,4.3).lineTo(-54.4,6.9).lineTo(-58.6,6.9).lineTo(-52.1,-10.6).lineTo(-48.1,-10.6).lineTo(-41.6,6.9).closePath().moveTo(-48.1,0.7).lineTo(-50.1,-5.2).lineTo(-52.2,0.7).lineTo(-48.1,0.7).closePath().moveTo(-73.3,6.9).lineTo(-73.3,-10.6).lineTo(-66.2,-10.6).curveTo(-64.7,-10.6,-63.5,-10.1).curveTo(-62.2,-9.6,-61.4,-8.7).curveTo(-60.4,-7.8,-59.9,-6.6).curveTo(-59.5,-5.4,-59.5,-4.1).curveTo(-59.5,-2.7,-59.9,-1.5).curveTo(-60.4,-0.4,-61.3,0.6).curveTo(-62.2,1.5,-63.5,2).curveTo(-64.7,2.5,-66.2,2.5).lineTo(-69,2.5).lineTo(-69,6.9).closePath().moveTo(-69,-1.4).lineTo(-66.4,-1.4).curveTo(-65.3,-1.4,-64.5,-2.1).curveTo(-63.7,-2.8,-63.7,-4.1).curveTo(-63.7,-5.3,-64.5,-6).curveTo(-65.3,-6.8,-66.4,-6.8).lineTo(-69,-6.8).closePath();
	this.shape.setTransform(76.05,19.025);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_painBrain, new cjs.Rectangle(0,0.3,215,35.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#008FBE").beginStroke().moveTo(24.1,8.3).curveTo(22.4,7.6,21.3,6.3).curveTo(20.1,5.2,19.4,3.5).curveTo(18.8,1.9,18.8,0).curveTo(18.7,-2,19.5,-3.6).curveTo(20.1,-5.2,21.3,-6.5).curveTo(22.5,-7.7,24.2,-8.3).curveTo(25.8,-9,27.8,-9).curveTo(29,-9,30.2,-8.7).curveTo(31.3,-8.4,32.3,-7.8).curveTo(33.3,-7.2,34.1,-6.5).curveTo(35,-5.6,35.6,-4.7).lineTo(31.8,-2.3).curveTo(31.2,-3.5,30.3,-4.2).curveTo(29.2,-4.9,27.8,-4.9).curveTo(26.7,-4.9,25.9,-4.6).curveTo(25,-4.1,24.3,-3.4).curveTo(23.8,-2.8,23.4,-1.9).curveTo(23,-1,23.1,0).curveTo(23.1,1,23.3,1.8).curveTo(23.7,2.7,24.3,3.4).curveTo(25,4,25.8,4.4).curveTo(26.7,4.9,27.7,4.9).curveTo(29.3,4.8,30.4,4.1).curveTo(31.4,3.2,32,2).lineTo(35.9,4.1).curveTo(35.3,5.1,34.4,6).curveTo(33.7,7,32.6,7.6).curveTo(31.6,8.3,30.4,8.7).curveTo(29.2,9,27.8,9).curveTo(25.7,9,24.1,8.3).closePath().moveTo(51.2,8.7).lineTo(51.2,-8.7).lineTo(57.4,-8.7).curveTo(59.4,-8.8,61.1,-8.1).curveTo(62.8,-7.4,63.9,-6.3).curveTo(65.1,-5.1,65.8,-3.4).curveTo(66.5,-1.9,66.5,0).curveTo(66.5,1.8,65.8,3.4).curveTo(65.1,5.1,63.9,6.2).curveTo(62.7,7.4,61.1,8.1).curveTo(59.4,8.7,57.5,8.7).closePath().moveTo(55.3,4.9).lineTo(57.3,4.9).curveTo(58.4,4.9,59.3,4.4).curveTo(60.3,4.1,60.9,3.4).curveTo(61.6,2.8,61.9,1.9).curveTo(62.3,1,62.2,0).curveTo(62.3,-1,61.9,-2).curveTo(61.6,-2.8,61,-3.4).curveTo(60.3,-4.2,59.3,-4.5).curveTo(58.4,-4.9,57.2,-4.9).lineTo(55.3,-4.9).closePath().moveTo(37.1,8.7).lineTo(37.1,-8.7).lineTo(49.3,-8.7).lineTo(49.3,-4.9).lineTo(41.3,-4.9).lineTo(41.3,-2).lineTo(49.3,-2).lineTo(49.3,1.9).lineTo(41.3,1.9).lineTo(41.3,4.9).lineTo(49.3,4.9).lineTo(49.3,8.7).closePath().moveTo(12.3,8.7).lineTo(5.4,-2.2).lineTo(5.4,8.7).lineTo(1.4,8.7).lineTo(1.4,-8.7).lineTo(5.7,-8.7).lineTo(12.4,1.7).lineTo(12.4,-8.7).lineTo(16.3,-8.7).lineTo(16.3,8.7).closePath().moveTo(-4,8.7).lineTo(-5,6.1).lineTo(-11.7,6.1).lineTo(-12.6,8.7).lineTo(-16.8,8.7).lineTo(-10.3,-8.7).lineTo(-6.3,-8.7).lineTo(0.2,8.7).closePath().moveTo(-6.3,2.5).lineTo(-8.3,-3.4).lineTo(-10.4,2.5).lineTo(-6.3,2.5).closePath().moveTo(-26.2,8.7).lineTo(-32.6,-8.7).lineTo(-28.3,-8.7).lineTo(-24.2,3.1).lineTo(-20,-8.7).lineTo(-15.6,-8.7).lineTo(-22.2,8.7).closePath().moveTo(-48.6,8.7).lineTo(-48.6,-8.7).lineTo(-42.4,-8.7).curveTo(-40.3,-8.8,-38.6,-8.1).curveTo(-37,-7.4,-35.8,-6.3).curveTo(-34.6,-5.1,-33.9,-3.4).curveTo(-33.2,-1.9,-33.2,0).curveTo(-33.2,1.8,-33.9,3.4).curveTo(-34.6,5.1,-35.8,6.2).curveTo(-37,7.4,-38.7,8.1).curveTo(-40.3,8.7,-42.3,8.7).closePath().moveTo(-44.4,4.9).lineTo(-42.4,4.9).curveTo(-41.3,4.9,-40.4,4.4).curveTo(-39.5,4.1,-38.8,3.4).curveTo(-38.2,2.8,-37.8,1.9).curveTo(-37.5,1,-37.5,0).curveTo(-37.5,-1,-37.8,-2).curveTo(-38.1,-2.8,-38.8,-3.4).curveTo(-39.4,-4.2,-40.4,-4.5).curveTo(-41.3,-4.9,-42.5,-4.9).lineTo(-44.4,-4.9).closePath().moveTo(-53.8,8.7).lineTo(-54.7,6.1).lineTo(-61.3,6.1).lineTo(-62.3,8.7).lineTo(-66.5,8.7).lineTo(-60.1,-8.7).lineTo(-56,-8.7).lineTo(-49.5,8.7).closePath().moveTo(-55.9,2.5).lineTo(-58,-3.4).lineTo(-60.1,2.5).lineTo(-55.9,2.5).closePath();
	this.shape.setTransform(68.9,17.45);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_healthySpines, new cjs.Rectangle(0.2,0,137.70000000000002,35.6), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#008FBE").beginStroke().moveTo(4.2,8.8).lineTo(3.3,6.2).lineTo(-3.3,6.2).lineTo(-4.3,8.8).lineTo(-8.5,8.8).lineTo(-2.1,-8.8).lineTo(2,-8.8).lineTo(8.5,8.8).closePath().moveTo(2.1,2.5).lineTo(0,-3.4).lineTo(-2.1,2.5).lineTo(2.1,2.5).closePath();
	this.shape.setTransform(56.1,17.7);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#008FBE").beginStroke().moveTo(76.2,8.3).curveTo(74.5,7.6,73.4,6.4).curveTo(72.2,5.2,71.4,3.5).curveTo(70.8,1.9,70.8,0).curveTo(70.8,-1.9,71.4,-3.5).curveTo(72.2,-5.1,73.4,-6.3).curveTo(74.5,-7.6,76.2,-8.3).curveTo(77.8,-9,79.7,-9).curveTo(81.6,-9,83.2,-8.3).curveTo(84.8,-7.6,86.1,-6.3).curveTo(87.3,-5.1,88,-3.5).curveTo(88.7,-1.9,88.7,0).curveTo(88.7,1.9,88,3.5).curveTo(87.3,5.2,86.1,6.4).curveTo(84.8,7.6,83.3,8.3).curveTo(81.6,9,79.7,9).curveTo(77.8,9,76.2,8.3).closePath().moveTo(77.9,-4.5).curveTo(76.9,-4.1,76.4,-3.4).curveTo(75.7,-2.8,75.4,-1.9).curveTo(75,-1,75,0).curveTo(75,1,75.4,1.9).curveTo(75.7,2.8,76.3,3.4).curveTo(76.9,4.1,77.8,4.5).curveTo(78.7,4.9,79.7,4.9).curveTo(80.7,4.9,81.7,4.5).curveTo(82.5,4.1,83.1,3.4).curveTo(83.7,2.8,84.2,1.9).curveTo(84.5,1,84.5,0).curveTo(84.5,-1,84.2,-1.9).curveTo(83.7,-2.8,83.1,-3.4).curveTo(82.5,-4.1,81.6,-4.5).curveTo(80.8,-4.9,79.7,-4.9).curveTo(78.7,-4.9,77.9,-4.5).closePath().moveTo(41.3,8.8).curveTo(40.2,8.5,39.3,8).curveTo(38.3,7.6,37.6,6.9).lineTo(36.1,5.5).lineTo(39.7,2.6).curveTo(40.6,3.8,41.6,4.5).curveTo(42.7,5.1,44.1,5.1).curveTo(45.2,5.1,45.8,4.7).curveTo(46.3,4.2,46.3,3.5).curveTo(46.3,3,46.1,2.8).curveTo(45.9,2.5,45.4,2.2).lineTo(44.3,1.8).lineTo(40.7,0.9).curveTo(39.8,0.6,38.9,0).curveTo(38.2,-0.5,37.7,-1.4).curveTo(37.2,-2.3,37.1,-3.7).curveTo(37.2,-4.8,37.7,-5.8).curveTo(38.2,-6.8,38.9,-7.5).curveTo(39.8,-8.2,41,-8.6).curveTo(42.1,-9,43.5,-9).curveTo(44.7,-9,45.8,-8.8).curveTo(46.7,-8.6,47.6,-8.2).curveTo(48.4,-7.8,49.2,-7.2).lineTo(50.5,-5.9).lineTo(47.2,-3.3).curveTo(46.6,-4.3,45.7,-4.8).curveTo(44.8,-5.4,43.4,-5.4).curveTo(42.4,-5.4,41.9,-4.9).curveTo(41.4,-4.4,41.4,-3.8).curveTo(41.4,-3.4,41.6,-3.1).lineTo(42.3,-2.7).lineTo(46.9,-1.5).curveTo(48,-1.1,48.7,-0.6).curveTo(49.6,0,50.2,0.9).curveTo(50.6,1.9,50.6,3.3).curveTo(50.6,4.5,50.2,5.6).curveTo(49.6,6.6,48.7,7.4).curveTo(47.9,8.2,46.7,8.6).curveTo(45.4,9,44,9).curveTo(42.5,9,41.3,8.8).closePath().moveTo(100.4,8.8).lineTo(97.9,3.5).lineTo(94.5,3.5).lineTo(94.5,8.8).lineTo(90.4,8.8).lineTo(90.4,-8.7).lineTo(98,-8.7).curveTo(99.5,-8.7,100.8,-8.3).curveTo(101.9,-7.8,102.8,-7).curveTo(103.6,-6.2,104.1,-5.1).curveTo(104.5,-4,104.5,-2.7).curveTo(104.5,-1,103.7,0.3).curveTo(103,1.7,101.6,2.4).lineTo(105,8.8).closePath().moveTo(94.5,-0.3).lineTo(97.6,-0.3).curveTo(99,-0.3,99.6,-1).curveTo(100.3,-1.6,100.2,-2.6).curveTo(100.3,-3.7,99.6,-4.3).curveTo(99,-4.9,97.6,-4.9).lineTo(94.5,-4.9).closePath().moveTo(57.2,8.8).lineTo(57.2,-8.7).lineTo(69.2,-8.7).lineTo(69.2,-4.8).lineTo(61.3,-4.8).lineTo(61.3,-1.7).lineTo(69.2,-1.7).lineTo(69.2,2.2).lineTo(61.3,2.2).lineTo(61.3,8.8).closePath().moveTo(27,8.8).lineTo(27,-4.9).lineTo(22.2,-4.9).lineTo(22.2,-8.7).lineTo(35.8,-8.7).lineTo(35.8,-4.9).lineTo(31.1,-4.9).lineTo(31.1,8.8).closePath().moveTo(16.4,8.8).lineTo(9.5,-2.2).lineTo(9.5,8.8).lineTo(5.5,8.8).lineTo(5.5,-8.7).lineTo(9.9,-8.7).lineTo(16.4,1.8).lineTo(16.4,-8.7).lineTo(20.5,-8.7).lineTo(20.5,8.8).closePath().moveTo(-8.8,8.8).lineTo(-8.8,-8.7).lineTo(3.4,-8.7).lineTo(3.4,-4.9).lineTo(-4.6,-4.9).lineTo(-4.6,-2).lineTo(3.4,-2).lineTo(3.4,1.9).lineTo(-4.6,1.9).lineTo(-4.6,4.9).lineTo(3.4,4.9).lineTo(3.4,8.8).closePath().moveTo(-15.6,8.8).lineTo(-15.6,-2.3).lineTo(-20.2,3.9).lineTo(-24.9,-2.3).lineTo(-24.9,8.8).lineTo(-28.9,8.8).lineTo(-28.9,-8.7).lineTo(-25,-8.7).lineTo(-20.2,-2.2).lineTo(-15.4,-8.7).lineTo(-11.6,-8.7).lineTo(-11.6,8.8).closePath().moveTo(-39.3,8.8).lineTo(-39.3,-4.9).lineTo(-44.1,-4.9).lineTo(-44.1,-8.7).lineTo(-30.5,-8.7).lineTo(-30.5,-4.9).lineTo(-35.2,-4.9).lineTo(-35.2,8.8).closePath().moveTo(-73.8,8.8).lineTo(-73.8,-8.7).lineTo(-61.8,-8.7).lineTo(-61.8,-4.9).lineTo(-69.7,-4.9).lineTo(-69.7,-2).lineTo(-61.8,-2).lineTo(-61.8,1.9).lineTo(-69.7,1.9).lineTo(-69.7,4.9).lineTo(-61.8,4.9).lineTo(-61.8,8.8).closePath().moveTo(-79.6,8.8).lineTo(-82.1,3.5).lineTo(-85.5,3.5).lineTo(-85.5,8.8).lineTo(-89.6,8.8).lineTo(-89.6,-8.7).lineTo(-82,-8.7).curveTo(-80.5,-8.7,-79.3,-8.3).curveTo(-78.1,-7.8,-77.2,-7).curveTo(-76.4,-6.2,-75.9,-5.1).curveTo(-75.5,-4,-75.5,-2.7).curveTo(-75.5,-1,-76.3,0.3).curveTo(-77,1.7,-78.4,2.4).lineTo(-75,8.8).closePath().moveTo(-85.5,-0.3).lineTo(-82.4,-0.3).curveTo(-81,-0.3,-80.4,-1).curveTo(-79.7,-1.6,-79.8,-2.6).curveTo(-79.7,-3.7,-80.4,-4.3).curveTo(-81,-4.9,-82.4,-4.9).lineTo(-85.5,-4.9).closePath().moveTo(-100.2,8.8).lineTo(-100.2,-4.9).lineTo(-105,-4.9).lineTo(-105,-8.7).lineTo(-91.4,-8.7).lineTo(-91.4,-4.9).lineTo(-96.1,-4.9).lineTo(-96.1,8.8).closePath();
	this.shape_1.setTransform(108.05,17.675);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_happenHere, new cjs.Rectangle(0,0.3,215,35.5), null);
...
}).prototype = getMCSymbolPrototype(lib.image_01_1, new cjs.Rectangle(0,4,300,431), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(87.475,23.75);
	...
	this.shape_1.setTransform(87.525,23.75);
	...
	this.shape_2.setTransform(87.525,23.75);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.ctaBtn, new cjs.Rectangle(-1,0,177.1,47.5), null);
...
if (reversed == null) { reversed = false; }
	...
	// _Layer_
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#3C8EBA").beginStroke().moveTo(-27.6,51.7).curveTo(-28.5,50.8,-28.5,49.3).curveTo(-28.5,47.8,-27.6,46.9).curveTo(-26.8,45.9,-25.4,45.9).curveTo(-24.3,45.9,-23.6,46.6).curveTo(-22.8,47.1,-22.7,48.2).lineTo(-24,48.2).curveTo(-24.2,47.7,-24.5,47.4).curveTo(-24.9,47.2,-25.4,47.2).curveTo(-26,47.2,-26.4,47.5).curveTo(-26.8,47.7,-27,48.3).lineTo(-27.1,49.3).curveTo(-27.1,50.2,-26.7,50.9).curveTo(-26.2,51.4,-25.4,51.4).curveTo(-24.7,51.5,-24.3,51.1).curveTo(-24,50.8,-23.8,50.1).lineTo(-25.3,50.1).lineTo(-25.3,49).lineTo(-22.6,49).lineTo(-22.6,52.5).lineTo(-23.5,52.5).lineTo(-23.6,51.8).curveTo(-24.3,52.6,-25.4,52.7).curveTo(-26.9,52.7,-27.6,51.7).closePath().moveTo(23.6,52.5).lineTo(23.6,46.1).lineTo(28.4,46.1).lineTo(28.4,47.3).lineTo(25,47.3).lineTo(25,48.6).lineTo(28.2,48.6).lineTo(28.2,49.7).lineTo(25,49.7).lineTo(25,51.3).lineTo(28.5,51.3).lineTo(28.5,52.5).closePath().moveTo(20.3,52.5).lineTo(17.6,48.2).lineTo(17.6,52.5).lineTo(16.2,52.5).lineTo(16.2,46.1).lineTo(17.6,46.1).lineTo(20.3,50.4).lineTo(20.3,50.4).lineTo(20.3,46.1).lineTo(21.6,46.1).lineTo(21.6,52.5).closePath().moveTo(12.9,52.5).lineTo(12.9,46.1).lineTo(14.3,46.1).lineTo(14.3,52.5).closePath().moveTo(7.9,52.5).lineTo(5.9,46.1).lineTo(7.3,46.1).lineTo(8.7,50.6).lineTo(8.7,50.6).lineTo(10.2,46.1).lineTo(11.6,46.1).lineTo(9.5,52.5).closePath().moveTo(0,52.5).lineTo(0,46.1).lineTo(4.8,46.1).lineTo(4.8,47.3).lineTo(1.4,47.3).lineTo(1.4,48.6).lineTo(4.5,48.6).lineTo(4.5,49.7).lineTo(1.4,49.7).lineTo(1.4,51.3).lineTo(4.9,51.3).lineTo(4.9,52.5).closePath().moveTo(-6.7,52.5).lineTo(-6.7,46.1).lineTo(-3.8,46.1).curveTo(-3.1,46.1,-2.5,46.4).curveTo(-1.9,46.7,-1.8,47.2).curveTo(-1.6,47.6,-1.6,48.2).curveTo(-1.6,48.6,-1.8,49.2).curveTo(-2,49.6,-2.5,49.9).curveTo(-3,50.2,-3.8,50.2).lineTo(-5.3,50.2).lineTo(-5.3,52.5).closePath().moveTo(-5.3,49.1).lineTo(-4.2,49.1).curveTo(-3.6,49.1,-3.3,48.9).curveTo(-3,48.7,-3,48.2).curveTo(-3,47.6,-3.3,47.4).curveTo(-3.6,47.2,-4.2,47.2).lineTo(-5.3,47.2).closePath().moveTo(-9.4,52.5).lineTo(-9.9,51.1).lineTo(-12.3,51.1).lineTo(-12.8,52.5).lineTo(-14.2,52.5).lineTo(-11.8,46.1).lineTo(-10.3,46.1).lineTo(-7.9,52.5).closePath().moveTo(-11.9,50).lineTo(-10.2,50).lineTo(-11.1,47.6).lineTo(-11.1,47.6).closePath().moveTo(-16.6,52.5).lineTo(-16.7,52).lineTo(-16.8,51).curveTo(-16.9,50.5,-17.2,50.2).curveTo(-17.5,50,-17.9,50).lineTo(-19.3,50).lineTo(-19.3,52.5).lineTo(-20.8,52.5).lineTo(-20.8,46.1).lineTo(-17.3,46.1).curveTo(-16.4,46.1,-15.9,46.6).curveTo(-15.4,47.1,-15.4,47.8).curveTo(-15.4,49.1,-16.4,49.4).lineTo(-16.4,49.5).curveTo(-15.6,49.7,-15.5,51).lineTo(-15.4,51.9).lineTo(-15.4,52.2).lineTo(-15.2,52.5).closePath().moveTo(-19.3,49).lineTo(-17.8,49).curveTo(-16.8,49,-16.8,48.1).curveTo(-16.8,47.2,-17.8,47.2).lineTo(-19.3,47.2).closePath().moveTo(-18.8,-33.2).lineTo(-18.8,-42.4).lineTo(-0.7,-42.4).lineTo(-9.9,-33.2).closePath().moveTo(0.5,-43.5).lineTo(9.6,-52.6).lineTo(18.6,-52.6).lineTo(18.6,-43.5).closePath();
	this.shape.setTransform(149.3,349.65);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.beginFill("#F5B846").beginStroke().moveTo(0.6,18.7).lineTo(0.6,0.6).lineTo(9.7,9.8).lineTo(9.7,18.7).closePath().moveTo(-9.7,-9.7).lineTo(-9.7,-18.7).lineTo(-0.6,-18.7).lineTo(-0.6,-0.6).closePath();
	this.shape_1.setTransform(149.175,306.725);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.beginFill("#1140A0").beginStroke().moveTo(8.5,50.9).curveTo(7.4,49.6,7.4,47.6).curveTo(7.4,45.5,8.5,44.2).curveTo(9.8,42.9,11.8,42.9).curveTo(13.3,42.9,14.4,43.8).curveTo(15.5,44.7,15.6,46.1).lineTo(13.8,46.1).curveTo(13.7,45.5,13,45).curveTo(12.6,44.6,11.8,44.6).curveTo(10.9,44.6,10.4,45).curveTo(9.8,45.5,9.6,46.1).curveTo(9.4,46.7,9.3,47.6).curveTo(9.3,48.8,10,49.7).curveTo(10.5,50.6,11.8,50.6).curveTo(12.6,50.6,13.2,50).curveTo(13.7,49.5,13.8,48.6).lineTo(15.7,48.6).curveTo(15.5,50.3,14.5,51.2).curveTo(13.4,52.2,11.8,52.2).curveTo(9.8,52.2,8.5,50.9).closePath().moveTo(-25.1,50.9).curveTo(-26.3,49.6,-26.3,47.6).curveTo(-26.3,45.5,-25.1,44.2).curveTo(-23.9,42.9,-21.9,42.9).curveTo(-20.4,42.9,-19.3,43.8).curveTo(-18.2,44.7,-18,46.1).lineTo(-20,46.1).curveTo(-20,45.5,-20.6,45).curveTo(-21.2,44.6,-21.9,44.6).curveTo(-22.7,44.6,-23.3,45).curveTo(-23.8,45.5,-24.1,46.1).curveTo(-24.3,46.8,-24.3,47.6).curveTo(-24.3,48.9,-23.7,49.7).curveTo(-23.1,50.6,-21.9,50.6).curveTo(-21,50.6,-20.5,50).curveTo(-20,49.6,-19.8,48.6).lineTo(-18,48.6).curveTo(-18.1,50.3,-19.2,51.2).curveTo(-20.2,52.2,-21.9,52.2).curveTo(-23.9,52.2,-25.1,50.9).closePath().moveTo(62.1,52).lineTo(61.9,51.4).lineTo(61.7,49.9).curveTo(61.6,49.2,61.3,48.9).curveTo(61,48.5,60.3,48.5).lineTo(58.3,48.5).lineTo(58.3,52).lineTo(56.3,52).lineTo(56.3,43.1).lineTo(61.2,43.1).curveTo(62.3,43.1,63.1,43.8).curveTo(63.7,44.5,63.7,45.5).curveTo(63.7,47.3,62.4,47.8).lineTo(62.4,47.9).curveTo(63.6,48.2,63.6,49.9).lineTo(63.9,51.7).lineTo(64,52).closePath().moveTo(58.3,47.2).lineTo(60.5,47.2).curveTo(61.8,47.1,61.8,45.8).curveTo(61.8,44.6,60.5,44.6).lineTo(58.3,44.6).closePath().moveTo(47,52).lineTo(47,43.1).lineTo(53.6,43.1).lineTo(53.6,44.7).lineTo(49,44.7).lineTo(49,46.6).lineTo(53.3,46.6).lineTo(53.3,48.2).lineTo(49,48.2).lineTo(49,50.4).lineTo(53.7,50.4).lineTo(53.7,52).closePath().moveTo(40.1,52).lineTo(40.1,44.7).lineTo(37.4,44.7).lineTo(37.4,43.1).lineTo(44.7,43.1).lineTo(44.7,44.7).lineTo(42,44.7).lineTo(42,52).closePath().moveTo(33.2,52).lineTo(29.5,46.1).lineTo(29.4,46.1).lineTo(29.4,52).lineTo(27.6,52).lineTo(27.6,43.1).lineTo(29.6,43.1).lineTo(33.3,49.1).lineTo(33.3,43.1).lineTo(35.2,43.1).lineTo(35.2,52).closePath().moveTo(18.3,52).lineTo(18.3,43.1).lineTo(24.9,43.1).lineTo(24.9,44.7).lineTo(20.2,44.7).lineTo(20.2,46.6).lineTo(24.6,46.6).lineTo(24.6,48.2).lineTo(20.2,48.2).lineTo(20.2,50.4).lineTo(25,50.4).lineTo(25,52).closePath().moveTo(-5.6,52).lineTo(-5.6,43.1).lineTo(-3.6,43.1).lineTo(-3.6,50.4).lineTo(0.7,50.4).lineTo(0.7,52).closePath().moveTo(-9.6,52).lineTo(-10.3,50).lineTo(-13.7,50).lineTo(-14.3,52).lineTo(-16.4,52).lineTo(-13,43.1).lineTo(-11,43.1).lineTo(-7.6,52).closePath().moveTo(-13.2,48.5).lineTo(-10.8,48.5).lineTo(-12,45.3).lineTo(-12,45.3).closePath().moveTo(-30.9,52).lineTo(-30.9,43.1).lineTo(-28.8,43.1).lineTo(-28.8,52).closePath().moveTo(-41.3,52).lineTo(-41.3,43.1).lineTo(-37.5,43.1).curveTo(-35.7,43.1,-34.6,44.3).curveTo(-33.5,45.3,-33.5,47.5).curveTo(-33.5,49.5,-34.5,50.8).curveTo(-35.4,52.1,-37.5,52).closePath().moveTo(-39.4,50.4).lineTo(-37.6,50.4).curveTo(-36.7,50.4,-36,49.7).curveTo(-35.4,49.1,-35.4,47.7).curveTo(-35.4,46.3,-35.9,45.5).curveTo(-36.6,44.8,-38,44.7).lineTo(-39.4,44.7).closePath().moveTo(-50.7,52).lineTo(-50.7,43.1).lineTo(-44,43.1).lineTo(-44,44.7).lineTo(-48.7,44.7).lineTo(-48.7,46.6).lineTo(-44.4,46.6).lineTo(-44.4,48.2).lineTo(-48.7,48.2).lineTo(-48.7,50.4).lineTo(-43.9,50.4).lineTo(-43.9,52).closePath().moveTo(-55.5,52).lineTo(-55.5,45.7).lineTo(-57.7,52).lineTo(-59.2,52).lineTo(-61.4,45.8).lineTo(-61.4,52).lineTo(-63.3,52).lineTo(-63.3,43.1).lineTo(-60.5,43.1).lineTo(-58.4,49.2).lineTo(-58.3,49.2).lineTo(-56.4,43.1).lineTo(-53.6,43.1).lineTo(-53.6,52).closePath().moveTo(-89.8,38.8).curveTo(-90.2,38.3,-90.2,37.7).curveTo(-90.2,37,-89.8,36.6).curveTo(-89.4,36.3,-88.8,36.3).lineTo(-88.1,36.3).curveTo(-87.4,36.3,-87,35.6).curveTo(-85.7,33.8,-85.2,32.4).curveTo(-84.8,31.4,-84.9,30.9).curveTo(-84.8,30.2,-85.5,28.4).lineTo(-88.2,20.9).curveTo(-88.7,19.3,-89,19).curveTo(-89.5,18.3,-90.3,18.2).lineTo(-91.2,18).curveTo(-91.3,17.9,-91.3,17.5).curveTo(-91.3,17.4,-91.3,17.3).curveTo(-91.3,17.3,-91.2,17.2).curveTo(-91.2,17.2,-91.2,17.1).curveTo(-91.1,17.1,-91.1,17.1).lineTo(-87.8,17.2).lineTo(-84.6,17.1).curveTo(-84.6,17.1,-84.6,17.1).curveTo(-84.5,17.2,-84.5,17.2).curveTo(-84.5,17.3,-84.4,17.3).curveTo(-84.4,17.4,-84.4,17.5).curveTo(-84.4,17.9,-84.6,18).lineTo(-85.5,18.2).curveTo(-86.2,18.3,-86.2,18.6).curveTo(-86.2,19,-85.2,21.9).lineTo(-84.1,25.2).curveTo(-83.2,27.6,-83.1,27.7).curveTo(-82.9,27.6,-81.7,25).lineTo(-80.6,22.2).curveTo(-79.3,19.4,-79.3,18.7).curveTo(-79.3,18.3,-80.1,18.2).lineTo(-81.3,18).curveTo(-81.4,17.9,-81.4,17.5).curveTo(-81.4,17.4,-81.4,17.3).curveTo(-81.4,17.3,-81.3,17.2).curveTo(-81.3,17.2,-81.3,17.1).curveTo(-81.2,17.1,-81.2,17.1).lineTo(-78,17.2).lineTo(-75.4,17.1).curveTo(-75.4,17.1,-75.3,17.2).curveTo(-75.3,17.2,-75.2,17.2).curveTo(-75.2,17.3,-75.2,17.4).curveTo(-75.2,17.4,-75.2,17.5).curveTo(-75.1,17.8,-75.3,18).lineTo(-76,18).curveTo(-76.7,18.2,-77.4,19.1).curveTo(-78,19.8,-78.9,21.9).lineTo(-80.9,25.9).curveTo(-84.2,32.8,-86.4,37.6).curveTo(-87.1,39.2,-88.7,39.3).curveTo(-89.4,39.2,-89.8,38.8).closePath().moveTo(66.4,31.6).curveTo(65.8,29.6,64.3,26.3).lineTo(62.2,21.5).curveTo(59.2,27.7,57.8,31.6).lineTo(57.3,31.7).lineTo(56.8,31.6).lineTo(47.6,11.2).curveTo(47,9.8,46.6,9.4).curveTo(46,8.7,45.1,8.6).lineTo(44.2,8.5).curveTo(44.2,8.5,44.1,8.4).curveTo(44.1,8.4,44.1,8.3).curveTo(44.1,8.3,44.1,8.2).curveTo(44.1,8.2,44.1,8.1).curveTo(44.1,8,44.1,8).curveTo(44.1,7.9,44.1,7.9).curveTo(44.2,7.8,44.2,7.8).curveTo(44.2,7.7,44.3,7.7).lineTo(48,7.8).lineTo(51.9,7.7).curveTo(52,7.7,52.1,7.7).curveTo(52.1,7.8,52.1,7.8).curveTo(52.2,7.9,52.2,7.9).curveTo(52.2,8,52.2,8).curveTo(52.2,8.1,52.2,8.2).curveTo(52.2,8.3,52.2,8.3).curveTo(52.2,8.4,52.1,8.4).curveTo(52.1,8.5,52,8.5).lineTo(51.3,8.6).curveTo(50.1,8.7,50,9.2).curveTo(50,9.8,51.9,14).lineTo(58,27.1).lineTo(60.7,21.4).lineTo(61.3,20).curveTo(61.3,19.7,61,19.1).curveTo(59.8,16.2,57.1,10.5).curveTo(56.7,9.6,56.2,9.2).curveTo(55.7,8.6,54.9,8.6).lineTo(54.1,8.5).curveTo(54,8.4,53.9,8.4).curveTo(53.9,8.3,53.9,8.3).curveTo(53.8,8.2,53.8,8.2).curveTo(53.8,8.1,53.8,8).curveTo(53.9,8,53.9,7.9).curveTo(53.9,7.9,53.9,7.8).curveTo(54,7.8,54,7.8).curveTo(54,7.7,54.1,7.7).lineTo(57.9,7.8).lineTo(61.7,7.7).curveTo(61.8,7.7,61.8,7.7).curveTo(61.9,7.8,61.9,7.8).curveTo(61.9,7.9,62,7.9).curveTo(62,8,62,8).curveTo(62,8.1,62,8.2).curveTo(62,8.2,62,8.3).curveTo(61.9,8.3,61.9,8.4).curveTo(61.9,8.4,61.8,8.5).lineTo(60.9,8.6).curveTo(59.8,8.6,59.8,9).curveTo(59.7,9.3,60.1,10.5).lineTo(62.9,16.7).lineTo(65,12.1).curveTo(65.9,9.9,65.9,9.3).curveTo(65.8,8.6,65,8.6).lineTo(63.9,8.5).lineTo(63.7,8).curveTo(63.7,7.9,63.7,7.9).curveTo(63.8,7.8,63.8,7.8).curveTo(63.8,7.8,63.9,7.7).curveTo(63.9,7.7,64,7.7).lineTo(67.3,7.8).lineTo(70.6,7.7).curveTo(70.7,7.7,70.7,7.7).curveTo(70.8,7.8,70.8,7.8).curveTo(70.8,7.9,70.9,7.9).curveTo(70.9,8,70.9,8).curveTo(70.9,8.1,70.9,8.2).curveTo(70.9,8.2,70.9,8.3).curveTo(70.8,8.3,70.8,8.4).curveTo(70.8,8.4,70.7,8.5).lineTo(69.7,8.6).curveTo(68.7,8.6,68,9.6).lineTo(66.8,11.7).curveTo(65.7,13.7,64.1,17.4).curveTo(63.8,17.9,63.7,18.2).curveTo(63.7,18.5,64,19.1).lineTo(67.6,27.1).curveTo(69.4,23.1,70.7,19.6).curveTo(72.8,15,73.6,12.6).curveTo(74.7,9.8,74.7,9.5).curveTo(74.7,8.6,73.5,8.6).lineTo(72.5,8.5).curveTo(72.2,8.3,72.3,8).curveTo(72.3,8,72.3,7.9).curveTo(72.3,7.9,72.3,7.8).curveTo(72.3,7.8,72.4,7.8).curveTo(72.4,7.7,72.5,7.7).lineTo(75.9,7.8).lineTo(76,7.8).lineTo(76.2,7.8).curveTo(77.9,7.7,78.9,7.1).lineTo(80.7,5.9).lineTo(81,5.9).lineTo(81.1,6).lineTo(81,10.4).lineTo(81,17.8).curveTo(81,18.4,81.1,18.5).curveTo(83.5,16.7,85.9,16.7).curveTo(88.3,16.7,89.4,18).curveTo(90.4,19.2,90.4,21.3).lineTo(90.4,27.2).curveTo(90.5,29.1,90.6,29.6).curveTo(90.8,30.1,91.8,30.3).lineTo(92.7,30.3).curveTo(92.7,30.4,92.8,30.4).curveTo(92.8,30.5,92.8,30.5).curveTo(92.9,30.6,92.9,30.6).curveTo(92.9,30.7,92.9,30.8).curveTo(92.9,30.9,92.8,31).curveTo(92.8,31,92.8,31.1).curveTo(92.8,31.1,92.7,31.2).curveTo(92.7,31.2,92.7,31.2).curveTo(90.9,31.1,89.1,31.1).curveTo(87.1,31.1,85.8,31.2).curveTo(85.8,31.2,85.7,31.2).curveTo(85.7,31.1,85.7,31.1).curveTo(85.6,31,85.6,31).curveTo(85.6,30.9,85.6,30.8).curveTo(85.6,30.7,85.6,30.6).curveTo(85.6,30.6,85.6,30.5).curveTo(85.7,30.5,85.7,30.4).curveTo(85.7,30.4,85.8,30.3).lineTo(86.5,30.3).curveTo(87.4,30.1,87.6,29.6).curveTo(87.8,29.1,87.8,27.2).lineTo(87.8,22.1).curveTo(87.8,20.4,86.9,19.4).curveTo(86.1,18.3,84.4,18.4).curveTo(82.8,18.4,81.7,19.3).curveTo(81.2,19.7,81.1,20).curveTo(81,20.3,81,21.2).lineTo(81,27.2).curveTo(81,29.1,81.2,29.6).curveTo(81.4,30.1,82.3,30.3).lineTo(83.1,30.3).curveTo(83.1,30.4,83.1,30.4).curveTo(83.2,30.5,83.2,30.5).curveTo(83.2,30.6,83.2,30.6).curveTo(83.2,30.7,83.1,30.8).curveTo(83.1,30.9,83.1,31).curveTo(83.1,31,83.1,31.1).curveTo(83.1,31.1,83,31.2).curveTo(83,31.2,83,31.2).curveTo(81.6,31.1,79.6,31.1).curveTo(77.7,31.1,76.2,31.2).curveTo(76.2,31.2,76.1,31.2).curveTo(76.1,31.1,76.1,31.1).curveTo(76,31,76,31).curveTo(76,30.9,76,30.8).curveTo(76,30.7,76,30.6).curveTo(76,30.6,76,30.5).curveTo(76,30.5,76,30.4).curveTo(76.1,30.4,76.1,30.3).lineTo(77,30.3).curveTo(77.9,30.1,78.1,29.6).curveTo(78.4,29.1,78.4,27.2).lineTo(78.4,11.2).curveTo(78.4,9.5,78.2,9.1).curveTo(78.2,9,78.1,9).curveTo(78.1,8.9,78.1,8.9).curveTo(78,8.8,78,8.8).curveTo(77.9,8.8,77.8,8.8).curveTo(77.1,9.1,76.6,9.9).curveTo(76.2,10.6,74.4,14.8).lineTo(71.8,20.7).curveTo(69.5,26.2,67.4,31.6).lineTo(67,31.7).lineTo(66.4,31.6).closePath().moveTo(-39.9,30.4).curveTo(-40.1,29.8,-40.4,28.3).curveTo(-40.8,26.8,-40.8,25.4).lineTo(-40.4,25.2).curveTo(-40.3,25.2,-40.3,25.2).curveTo(-40.2,25.2,-40.1,25.2).curveTo(-40.1,25.3,-40,25.3).curveTo(-40,25.3,-40,25.4).curveTo(-38.4,30.6,-33.9,30.6).curveTo(-31.7,30.6,-30.5,29.3).curveTo(-29.5,28.2,-29.5,26.6).curveTo(-29.5,25.1,-30,24.1).curveTo(-30.6,22.7,-32.3,21.5).lineTo(-35.7,19.4).curveTo(-39.5,16.9,-39.5,13.3).curveTo(-39.5,10.7,-37.6,9).curveTo(-35.7,7.3,-32.3,7.2).curveTo(-30.7,7.2,-29.1,7.7).lineTo(-27.8,7.9).curveTo(-27.6,8.5,-27.4,9.8).lineTo(-27.2,12.2).curveTo(-27.2,12.2,-27.2,12.3).curveTo(-27.3,12.3,-27.3,12.3).curveTo(-27.4,12.4,-27.4,12.4).curveTo(-27.5,12.4,-27.6,12.4).curveTo(-27.7,12.4,-27.8,12.4).curveTo(-27.8,12.4,-27.9,12.4).curveTo(-27.9,12.4,-28,12.4).curveTo(-28,12.3,-28.1,12.3).curveTo(-28.5,10.6,-29.4,9.6).curveTo(-30.6,8.3,-32.9,8.3).curveTo(-35.2,8.3,-36.3,9.6).curveTo(-37,10.7,-37.1,12.3).curveTo(-37,14.8,-34,16.6).lineTo(-31.2,18.4).curveTo(-26.8,21.1,-26.8,25.1).curveTo(-26.8,28.1,-28.8,29.9).curveTo(-30.9,31.7,-34.4,31.7).curveTo(-37.5,31.7,-39.9,30.4).closePath().moveTo(115.5,31).curveTo(114.3,30.3,113.5,29.3).curveTo(112,27.3,112,24.7).curveTo(111.9,21.3,113.9,19.1).curveTo(116,16.7,119.1,16.7).curveTo(121.2,16.7,122.7,18).curveTo(124,19.2,124,20.9).lineTo(123.9,21.9).curveTo(123.8,22.1,121.8,22.1).lineTo(115.3,22.1).curveTo(114.6,22,114.5,22.2).curveTo(114.4,22.3,114.4,23).curveTo(114.4,25.9,115.9,27.6).curveTo(117.5,29.6,120.2,29.6).curveTo(121.1,29.6,121.8,29.3).curveTo(122.7,28.9,123.5,27.9).curveTo(123.5,27.9,123.6,27.9).curveTo(123.6,27.9,123.7,27.9).curveTo(123.7,27.9,123.8,27.9).curveTo(123.9,27.9,123.9,27.9).lineTo(124.1,28.4).curveTo(123.3,30,121.6,30.9).curveTo(120.1,31.6,118.5,31.6).curveTo(116.9,31.6,115.5,31).closePath().moveTo(115.9,18.8).curveTo(114.8,19.9,114.7,20.9).curveTo(114.7,20.9,114.8,20.9).curveTo(114.8,20.9,114.8,21).curveTo(114.8,21,114.9,21).curveTo(114.9,21,115,21).lineTo(117.5,21).curveTo(120.7,21,121.1,20.6).curveTo(121.3,20.6,121.3,20).curveTo(121.4,19.1,120.8,18.5).curveTo(120.1,17.8,118.6,17.7).curveTo(117.2,17.8,115.9,18.8).closePath().moveTo(104.6,30.5).curveTo(103.8,29.6,103.8,27.8).lineTo(103.8,19.7).curveTo(103.8,19,103.8,18.8).curveTo(103.6,18.7,103.1,18.7).lineTo(102.1,18.7).lineTo(102,18.4).curveTo(101.9,18.3,101.9,18.2).curveTo(101.9,18.2,101.9,18.1).curveTo(101.9,18.1,102,18).curveTo(102,18,102,17.9).curveTo(103.6,17.5,104.2,16.8).curveTo(105.1,16.2,105.7,14.8).curveTo(106.3,14.6,106.5,14.9).lineTo(106.5,16.5).curveTo(106.5,17,106.6,17.1).curveTo(106.7,17.2,107.2,17.2).lineTo(111.1,17.2).curveTo(111.4,17.4,111.3,18).curveTo(111.3,18.5,111.1,18.7).lineTo(107.1,18.7).curveTo(106.7,18.7,106.6,18.8).curveTo(106.5,18.9,106.5,19.5).lineTo(106.5,26.1).curveTo(106.5,28,106.9,28.8).curveTo(107.5,30,109.1,30.1).curveTo(109.5,30,110,29.9).lineTo(110.9,29.4).curveTo(110.9,29.4,111,29.4).curveTo(111,29.4,111.1,29.5).curveTo(111.1,29.5,111.1,29.5).curveTo(111.2,29.6,111.2,29.6).lineTo(111.2,30).curveTo(110.7,30.7,109.8,31.1).curveTo(108.7,31.6,107.5,31.6).curveTo(105.4,31.6,104.6,30.5).closePath().moveTo(18.2,30.5).curveTo(17.5,29.6,17.5,27.8).lineTo(17.5,19.7).curveTo(17.5,19,17.4,18.8).curveTo(17.2,18.7,16.7,18.7).lineTo(15.7,18.7).lineTo(15.6,18.4).curveTo(15.5,18.3,15.5,18.2).curveTo(15.5,18.2,15.6,18.1).curveTo(15.6,18.1,15.6,18).curveTo(15.6,18,15.6,17.9).curveTo(17.2,17.5,17.9,16.8).curveTo(18.7,16.2,19.4,14.8).curveTo(19.9,14.6,20.1,14.9).lineTo(20.1,16.5).curveTo(20.1,17,20.2,17.1).curveTo(20.3,17.2,20.8,17.2).lineTo(24.7,17.2).curveTo(24.9,17.4,24.9,18).curveTo(24.9,18.5,24.7,18.7).lineTo(20.7,18.7).curveTo(20.3,18.7,20.2,18.8).curveTo(20.1,18.9,20.1,19.5).lineTo(20.1,26.1).curveTo(20.1,28,20.5,28.8).curveTo(21,30,22.7,30.1).curveTo(23.2,30,23.6,29.9).lineTo(24.5,29.4).curveTo(24.5,29.4,24.6,29.4).curveTo(24.6,29.4,24.7,29.5).curveTo(24.7,29.5,24.7,29.5).curveTo(24.8,29.6,24.8,29.6).lineTo(24.8,30).curveTo(23.5,31.6,21.1,31.6).curveTo(19.1,31.6,18.2,30.5).closePath().moveTo(7.5,30.5).curveTo(6.8,29.6,6.8,27.8).lineTo(6.8,19.7).curveTo(6.8,19,6.7,18.8).curveTo(6.6,18.7,6,18.7).lineTo(5.1,18.7).curveTo(5.1,18.7,5,18.6).curveTo(5,18.6,4.9,18.5).curveTo(4.9,18.5,4.9,18.4).curveTo(4.9,18.4,4.8,18.4).lineTo(4.9,17.9).curveTo(6.5,17.5,7.2,16.8).curveTo(8,16.2,8.7,14.8).lineTo(9.1,14.7).lineTo(9.4,14.9).lineTo(9.4,16.5).curveTo(9.4,17,9.5,17.1).curveTo(9.6,17.2,10.1,17.2).lineTo(14,17.2).curveTo(14.3,17.4,14.3,18).curveTo(14.3,18.5,14,18.7).lineTo(10.1,18.7).curveTo(9.6,18.7,9.5,18.8).curveTo(9.4,18.9,9.4,19.5).lineTo(9.4,26.1).curveTo(9.4,28,9.8,28.8).curveTo(10.4,30,12,30.1).curveTo(12.5,30,13,29.9).lineTo(13.8,29.4).curveTo(13.9,29.4,13.9,29.4).curveTo(14,29.4,14,29.5).curveTo(14,29.5,14.1,29.5).curveTo(14.1,29.6,14.1,29.6).lineTo(14.2,30).curveTo(12.8,31.6,10.5,31.6).curveTo(8.3,31.6,7.5,30.5).closePath().moveTo(-9.3,29.6).curveTo(-11.4,27.6,-11.4,24.3).curveTo(-11.4,21.1,-9.2,18.8).curveTo(-7,16.7,-3.9,16.7).curveTo(-0.8,16.7,1.3,18.7).curveTo(3.4,20.8,3.3,24).curveTo(3.4,27.4,1.3,29.4).curveTo(-0.9,31.6,-4.1,31.6).curveTo(-7.3,31.6,-9.3,29.6).closePath().moveTo(-7.1,19.4).curveTo(-8.3,21,-8.3,23.9).curveTo(-8.3,26.6,-7.2,28.4).curveTo(-5.9,30.5,-3.8,30.5).curveTo(-1.6,30.5,-0.5,28.6).curveTo(0.3,27,0.3,24.6).curveTo(0.3,21.9,-0.7,20.1).curveTo(-1.9,17.7,-4.2,17.7).curveTo(-6.1,17.8,-7.1,19.4).closePath().moveTo(-22.5,29.8).curveTo(-24.6,27.9,-24.6,24.6).curveTo(-24.6,21.4,-22.5,19.2).curveTo(-20.1,16.7,-16,16.7).curveTo(-14.3,16.7,-12.9,17.3).curveTo(-12.4,17.7,-12.3,18.7).curveTo(-12.4,19.2,-12.6,19.6).curveTo(-12.9,20,-13.2,20).curveTo(-13.4,20,-13.7,19.8).curveTo(-14.3,19,-15.1,18.5).curveTo(-16.2,17.9,-17.1,17.9).curveTo(-19.2,17.9,-20.5,19.4).curveTo(-22.1,20.9,-22.1,23.6).curveTo(-22.1,25.9,-20.6,27.6).curveTo(-19,29.6,-16.4,29.6).curveTo(-15,29.6,-14,29).curveTo(-13.2,28.6,-12.4,27.5).curveTo(-12.4,27.5,-12.3,27.5).curveTo(-12.3,27.5,-12.2,27.5).curveTo(-12.2,27.5,-12.1,27.5).curveTo(-12,27.6,-12,27.6).curveTo(-11.9,27.6,-11.9,27.7).curveTo(-11.9,27.7,-11.8,27.8).curveTo(-11.8,27.8,-11.8,27.9).curveTo(-11.8,27.9,-11.8,28).curveTo(-12.6,29.8,-14.4,30.8).curveTo(-16,31.6,-17.7,31.6).curveTo(-20.7,31.6,-22.5,29.8).closePath().moveTo(-66.3,29.6).curveTo(-68.4,27.6,-68.4,24.3).curveTo(-68.4,21.1,-66.2,18.8).curveTo(-64.1,16.7,-60.9,16.7).curveTo(-57.8,16.7,-55.8,18.7).curveTo(-53.7,20.8,-53.7,24).curveTo(-53.7,27.4,-55.7,29.4).curveTo(-57.9,31.6,-61.1,31.6).curveTo(-64.3,31.6,-66.3,29.6).closePath().moveTo(-64.2,19.4).curveTo(-65.4,21,-65.4,23.9).curveTo(-65.4,26.6,-64.3,28.4).curveTo(-63,30.5,-60.8,30.5).curveTo(-58.7,30.5,-57.6,28.6).curveTo(-56.7,27,-56.7,24.6).curveTo(-56.7,21.9,-57.8,20.1).curveTo(-59,17.7,-61.3,17.7).curveTo(-63.1,17.8,-64.2,19.4).closePath().moveTo(-95.4,30.5).curveTo(-95.8,30.1,-96,30.1).lineTo(-96.6,30.3).lineTo(-97.4,30.8).lineTo(-98.6,31.3).curveTo(-99.3,31.6,-99.9,31.6).curveTo(-101.5,31.6,-102.4,30.8).curveTo(-103.5,29.8,-103.5,28.4).curveTo(-103.5,27.3,-102.9,26.6).curveTo(-102.2,25.9,-100.6,25.4).lineTo(-96.4,23.8).curveTo(-96,23.7,-95.9,23.4).lineTo(-95.8,22.8).lineTo(-95.8,21.2).curveTo(-95.7,19.9,-96.2,19.2).curveTo(-96.8,18,-98.3,18).curveTo(-99.1,18.1,-99.8,18.5).curveTo(-100.5,18.9,-100.6,19.6).curveTo(-100.6,20.6,-101,20.9).curveTo(-101.8,21.5,-103,21.5).curveTo(-103.4,21.5,-103.4,21.1).curveTo(-103.4,19.7,-101.2,18.2).curveTo(-98.8,16.7,-96.9,16.7).curveTo(-95,16.7,-94.1,17.8).curveTo(-93.1,18.8,-93.2,20.9).lineTo(-93.4,26.9).curveTo(-93.6,30.1,-91.8,30.1).curveTo(-91.4,30.1,-90.9,29.9).lineTo(-90.5,29.6).curveTo(-90.2,29.6,-90.2,30.1).curveTo(-90.2,30.3,-91.1,30.9).curveTo(-92,31.6,-93.2,31.6).curveTo(-94.7,31.6,-95.4,30.5).closePath().moveTo(-97.7,25.3).curveTo(-99.4,25.9,-100.1,26.4).curveTo(-100.8,26.9,-100.8,27.9).curveTo(-100.8,28.6,-100.4,29.2).curveTo(-99.7,30.1,-98.6,30.1).curveTo(-98.1,30.1,-97.4,29.7).curveTo(-96.8,29.4,-96.5,29.2).curveTo(-96.1,28.9,-96,28.4).lineTo(-96,27.5).lineTo(-95.9,25.4).curveTo(-95.9,25,-96.2,24.9).curveTo(-96.8,25,-97.7,25.3).closePath().moveTo(30.2,29.6).curveTo(28.1,27.7,28.1,25.1).curveTo(28.1,21.1,32.1,19.4).curveTo(30.8,17.9,30.8,16.4).curveTo(30.8,14.6,32,13.3).curveTo(33.3,12,35.2,12).curveTo(36.4,12,37.4,12.7).curveTo(38.4,13.5,38.4,14.7).curveTo(38.4,15.8,37.5,16.6).curveTo(36.7,17.1,36.1,17.1).curveTo(35.3,17.1,35.7,16.6).lineTo(36.1,16).curveTo(36.2,15.6,36.1,15).curveTo(35.9,14.4,35.4,14.1).curveTo(34.8,13.6,34.2,13.7).curveTo(33.2,13.6,32.5,14.1).curveTo(31.9,14.7,31.8,15.6).curveTo(31.9,16.4,32.5,17.1).curveTo(33.2,17.8,34.9,18.8).curveTo(38,20.4,39.3,21.5).curveTo(41.6,23.5,43.1,26.6).curveTo(44.3,25.2,44.3,23.3).curveTo(44.3,21.9,43.5,20.9).curveTo(43.1,20.4,42.2,20.2).curveTo(41.2,20.1,40.5,20.7).curveTo(40.4,20.8,40.3,20.8).curveTo(40.3,20.9,40.2,20.9).curveTo(40.2,20.9,40.1,20.9).curveTo(40.1,20.9,40,20.9).curveTo(39.6,20.7,39.8,20.1).curveTo(39.9,19.1,40.8,18.5).curveTo(41.7,18,42.9,17.9).curveTo(43.4,17.9,44.7,18.2).lineTo(46.1,18.4).curveTo(46.6,18.4,46.9,18).lineTo(47.1,17.9).curveTo(47.2,17.9,47.2,17.9).curveTo(47.3,17.9,47.4,18).curveTo(47.4,18,47.4,18).curveTo(47.5,18.1,47.5,18.2).curveTo(47.5,19.1,46.9,19.7).curveTo(46.4,20.4,45.1,20.7).curveTo(45.5,21.7,45.5,23).curveTo(45.6,25.4,43.6,27.6).curveTo(44.5,29.1,45.3,29.6).curveTo(46.2,30.3,47.5,30.3).curveTo(48,30.2,48.4,30.1).lineTo(49,30).curveTo(49,30,49.1,30).curveTo(49.1,30,49.1,30.1).curveTo(49.2,30.1,49.2,30.1).curveTo(49.2,30.2,49.2,30.3).curveTo(49.2,30.7,48.2,31.1).curveTo(47.2,31.4,45.8,31.4).curveTo(44.5,31.4,43.5,31).curveTo(42.7,30.7,41.5,29.6).curveTo(39.7,30.7,38.4,31.1).curveTo(37.1,31.4,35.6,31.4).curveTo(32.4,31.4,30.2,29.6).closePath().moveTo(30.8,23).curveTo(30.8,25.8,32.8,27.8).curveTo(34.7,29.9,37.3,29.9).curveTo(38.2,29.8,39,29.6).curveTo(39.7,29.5,40.8,28.8).curveTo(40,28,39.3,26.8).lineTo(38.5,25.8).curveTo(37.2,23.9,35.8,22.5).curveTo(35.1,21.8,33.6,20.7).lineTo(32.8,20.2).curveTo(30.8,20.6,30.8,23).closePath().moveTo(97.3,31.1).curveTo(95.3,31.1,94,31.2).curveTo(94,31.2,93.9,31.2).curveTo(93.9,31.1,93.8,31.1).curveTo(93.8,31,93.8,31).curveTo(93.8,30.9,93.8,30.8).curveTo(93.8,30.7,93.8,30.6).curveTo(93.8,30.6,93.8,30.5).curveTo(93.8,30.5,93.9,30.4).curveTo(93.9,30.4,94,30.3).lineTo(94.7,30.3).curveTo(95.7,30.1,95.8,29.6).curveTo(96,29.1,96,27.2).lineTo(96,21).curveTo(96,19.9,95.9,19.6).curveTo(95.8,19.2,95,18.8).lineTo(94.7,18.5).lineTo(94.7,18.3).curveTo(94.7,18.2,94.7,18.1).curveTo(94.7,18.1,94.7,18).curveTo(94.7,18,94.7,18).curveTo(94.8,17.9,94.8,17.9).lineTo(96.6,17.1).lineTo(98.4,16.2).curveTo(98.5,16.2,98.5,16.2).curveTo(98.6,16.2,98.7,16.3).curveTo(98.7,16.3,98.7,16.3).curveTo(98.8,16.4,98.8,16.5).curveTo(98.7,18.5,98.6,20.8).lineTo(98.6,27.2).curveTo(98.6,29.1,98.8,29.6).curveTo(99.1,30.1,100,30.3).lineTo(100.7,30.3).curveTo(100.7,30.4,100.8,30.4).curveTo(100.8,30.5,100.8,30.5).curveTo(100.9,30.6,100.9,30.7).curveTo(100.9,30.7,100.9,30.8).curveTo(100.9,30.9,100.8,31).curveTo(100.8,31,100.8,31.1).curveTo(100.8,31.1,100.7,31.2).curveTo(100.7,31.2,100.6,31.2).curveTo(99.2,31.1,97.3,31.1).closePath().moveTo(-48.5,31.1).curveTo(-50.6,31.1,-51.9,31.2).curveTo(-51.9,31.2,-51.9,31.2).curveTo(-51.9,31.1,-52,31.1).curveTo(-52,31,-52,31).curveTo(-52,30.9,-52,30.8).curveTo(-52,30.7,-52,30.6).curveTo(-52,30.6,-52,30.5).curveTo(-52,30.5,-52,30.4).curveTo(-51.9,30.4,-51.9,30.3).lineTo(-51.2,30.3).curveTo(-50.3,30.1,-50,29.6).curveTo(-49.9,29.1,-49.9,27.2).lineTo(-49.9,21).curveTo(-49.8,19.9,-50,19.6).curveTo(-50.2,19.2,-50.9,18.8).lineTo(-51.1,18.5).curveTo(-51.2,18.5,-51.2,18.5).curveTo(-51.2,18.5,-51.3,18.4).curveTo(-51.3,18.4,-51.3,18.3).curveTo(-51.3,18.3,-51.3,18.3).lineTo(-51.1,17.9).curveTo(-50.6,17.8,-49.3,17.1).lineTo(-47.5,16.2).curveTo(-47.5,16.2,-47.4,16.3).curveTo(-47.4,16.3,-47.3,16.3).curveTo(-47.3,16.3,-47.3,16.4).curveTo(-47.3,16.4,-47.3,16.5).lineTo(-47.3,18.5).curveTo(-47.3,18.6,-47.2,18.6).curveTo(-47.2,18.7,-47.2,18.7).curveTo(-47.2,18.8,-47.2,18.8).curveTo(-47.2,18.8,-47.2,18.8).lineTo(-45.3,17.4).curveTo(-44.2,16.7,-43.3,16.7).curveTo(-42.6,16.7,-42.1,17.1).curveTo(-41.7,17.5,-41.7,18.1).curveTo(-41.7,18.9,-42.2,19.4).curveTo(-42.6,19.7,-43.2,19.7).curveTo(-43.5,19.7,-44,19.5).curveTo(-44.8,18.9,-45.5,18.9).curveTo(-46.3,18.9,-46.8,19.6).curveTo(-47.2,20.3,-47.3,22.3).lineTo(-47.3,27.2).curveTo(-47.3,29.1,-47.1,29.6).curveTo(-46.8,30.1,-45.8,30.3).lineTo(-44.6,30.3).curveTo(-44.5,30.4,-44.5,30.4).curveTo(-44.5,30.5,-44.5,30.5).curveTo(-44.4,30.6,-44.4,30.6).curveTo(-44.4,30.7,-44.5,30.8).curveTo(-44.5,30.9,-44.5,31).curveTo(-44.5,31,-44.5,31.1).curveTo(-44.5,31.1,-44.6,31.2).curveTo(-44.6,31.2,-44.6,31.2).lineTo(-48.5,31.1).closePath().moveTo(-73.1,31.1).curveTo(-75.1,31.1,-76.4,31.2).curveTo(-76.5,31.2,-76.5,31.2).curveTo(-76.6,31.1,-76.6,31.1).curveTo(-76.6,31,-76.6,31).curveTo(-76.7,30.9,-76.7,30.8).curveTo(-76.7,30.7,-76.7,30.6).curveTo(-76.7,30.6,-76.6,30.5).curveTo(-76.6,30.5,-76.6,30.4).curveTo(-76.6,30.4,-76.5,30.3).lineTo(-75.7,30.3).curveTo(-74.7,30.1,-74.5,29.6).curveTo(-74.4,29.1,-74.4,27.2).lineTo(-74.4,11.2).curveTo(-74.4,9.6,-74.5,9.2).curveTo(-74.7,8.7,-75.4,8.3).lineTo(-75.8,8).curveTo(-75.8,8,-75.9,8).curveTo(-75.9,8,-75.9,7.9).curveTo(-75.9,7.9,-75.9,7.8).curveTo(-76,7.8,-76,7.7).curveTo(-76,7.6,-75.9,7.6).curveTo(-75.9,7.5,-75.9,7.5).curveTo(-75.9,7.4,-75.9,7.4).curveTo(-75.8,7.4,-75.8,7.4).curveTo(-73.2,6.4,-72,5.9).curveTo(-71.9,5.9,-71.9,5.9).curveTo(-71.8,5.9,-71.8,5.9).curveTo(-71.7,5.9,-71.7,6).curveTo(-71.7,6,-71.6,6).lineTo(-71.7,10.4).lineTo(-71.7,27.2).curveTo(-71.7,29.1,-71.6,29.6).curveTo(-71.4,30.1,-70.4,30.3).lineTo(-69.6,30.3).curveTo(-69.5,30.4,-69.5,30.4).curveTo(-69.5,30.5,-69.4,30.5).curveTo(-69.4,30.6,-69.4,30.7).curveTo(-69.4,30.7,-69.4,30.8).curveTo(-69.5,31.1,-69.7,31.2).curveTo(-71.2,31.1,-73.1,31.1).closePath().moveTo(-119.4,31.1).lineTo(-123.6,31.2).curveTo(-123.6,31.2,-123.6,31.2).curveTo(-123.7,31.1,-123.7,31.1).curveTo(-123.7,31,-123.7,31).curveTo(-123.7,30.9,-123.8,30.8).curveTo(-123.8,30.7,-123.7,30.7).curveTo(-123.7,30.6,-123.7,30.5).curveTo(-123.7,30.5,-123.7,30.4).curveTo(-123.6,30.4,-123.6,30.3).lineTo(-122.9,30.3).curveTo(-121.6,30,-121.3,29.3).curveTo(-121,28.7,-121.1,25.8).lineTo(-121.1,12.4).curveTo(-121,10.3,-121.3,9.7).curveTo(-121.6,9.1,-122.8,8.9).lineTo(-123.9,8.8).curveTo(-124,8.8,-124,8.8).curveTo(-124,8.7,-124.1,8.7).curveTo(-124.1,8.6,-124.1,8.5).curveTo(-124.1,8.5,-124.1,8.4).curveTo(-124.1,8.1,-123.9,7.9).curveTo(-120.9,7.7,-116.3,7.7).curveTo(-112.3,7.7,-110.3,8.6).curveTo(-107.6,10,-107.7,13.1).curveTo(-107.6,14.9,-108.6,16.1).curveTo(-109.5,17.2,-111.3,17.9).curveTo(-111.3,18.3,-110.5,18.5).curveTo(-108.8,18.8,-107.5,20.2).curveTo(-105.8,21.8,-105.8,24.3).curveTo(-105.8,27.6,-108.2,29.3).curveTo(-110.5,31.2,-115.2,31.2).lineTo(-119.4,31.1).closePath().moveTo(-117.8,19.4).curveTo(-118.1,19.5,-118.1,20.1).lineTo(-118.1,25.3).curveTo(-118.1,28.3,-117.4,29.2).curveTo(-116.6,30.1,-114.6,30.1).curveTo(-112,30.1,-110.6,29).curveTo(-109.1,27.7,-109.1,25.2).curveTo(-109.1,22.6,-110.4,21.1).curveTo(-112.3,19.2,-116,19.2).curveTo(-117.5,19.2,-117.8,19.4).closePath().moveTo(-117.6,9).curveTo(-118.1,9.1,-118.1,9.9).lineTo(-118.1,17.1).curveTo(-118.1,17.8,-117.9,18).curveTo(-117.6,18.2,-116.3,18).curveTo(-113.5,17.9,-112.2,17).curveTo(-110.7,15.9,-110.7,13.5).curveTo(-110.7,11.1,-112.3,9.8).curveTo(-113.7,8.8,-116,8.8).curveTo(-117.2,8.8,-117.6,9).closePath().moveTo(95.8,13.3).curveTo(95.3,12.9,95.2,12.1).curveTo(95.2,11.3,95.8,10.7).curveTo(96.3,10.2,97.2,10.2).curveTo(98,10.2,98.5,10.7).curveTo(98.9,11.3,99,12).curveTo(99,13,98.4,13.4).curveTo(97.9,13.9,97,13.9).curveTo(96.3,13.9,95.8,13.3).closePath().moveTo(-9.6,2.1).lineTo(-9.6,-15.4).lineTo(-0.5,-24.6).lineTo(-0.5,2.1).closePath().moveTo(1.1,-3.2).curveTo(0.7,-3.6,0.7,-4).curveTo(0.7,-4.5,1.1,-4.9).curveTo(1.4,-5.2,1.9,-5.2).curveTo(2.4,-5.2,2.8,-4.9).curveTo(3.1,-4.5,3.1,-4).curveTo(3.1,-3.6,2.8,-3.2).curveTo(2.4,-2.9,1.9,-2.9).curveTo(1.4,-2.9,1.1,-3.2).closePath().moveTo(1.3,-4.8).curveTo(1,-4.4,1,-4).curveTo(1,-3.7,1.3,-3.3).curveTo(1.5,-3.1,1.9,-3.1).curveTo(2.3,-3.1,2.6,-3.3).curveTo(2.8,-3.7,2.9,-4).curveTo(2.8,-4.4,2.6,-4.8).curveTo(2.3,-5,1.9,-5).curveTo(1.5,-5,1.3,-4.8).closePath().moveTo(2.2,-3.4).lineTo(1.9,-4).lineTo(1.6,-4).lineTo(1.6,-3.4).lineTo(1.4,-3.4).lineTo(1.4,-4.8).lineTo(2,-4.8).curveTo(2.4,-4.8,2.4,-4.3).curveTo(2.5,-4,2.1,-4).lineTo(2.5,-3.4).closePath().moveTo(1.6,-4.1).lineTo(1.9,-4.1).curveTo(2,-4.1,2.1,-4.2).curveTo(2.1,-4.2,2.2,-4.2).curveTo(2.2,-4.2,2.2,-4.3).curveTo(2.2,-4.3,2.2,-4.3).curveTo(2.2,-4.4,2.2,-4.4).curveTo(2.2,-4.5,2.2,-4.5).curveTo(2.1,-4.5,2.1,-4.5).curveTo(2,-4.6,2,-4.6).lineTo(1.6,-4.6).closePath().moveTo(9.9,-15.4).lineTo(0.7,-24.6).lineTo(27.3,-24.6).lineTo(27.3,-15.4).closePath().moveTo(0.7,-52.3).lineTo(9.9,-52.3).lineTo(9.9,-34.8).lineTo(0.7,-25.7).closePath().moveTo(-27,-25.7).lineTo(-27,-34.8).lineTo(-9.6,-34.8).lineTo(-0.5,-25.7).closePath();
	this.shape_2.setTransform(149.05,331.85);
...
// stage content:
(lib._21_BAY_030_cmp_bnr_NTXNeuro_OverarchingGrapevine_300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(163).to({_off:false},0).to({x:141.5},9,cjs.Ease.quadOut).wait(53));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(165).to({_off:false},0).to({x:140.5},9,cjs.Ease.quadOut).wait(51));

	// Layer_3
	this.instance_4 = new lib.txt_Spine();
	this.instance_4.setTransform(110.5,176.1,1,1,0,0,0,108,17.7);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(167).to({_off:false},0).to({x:140.5},9,cjs.Ease.quadOut).wait(49));
	...
	this.instance_9.setTransform(84.8,119.1,1,1,0,0,0,81.4,21.1);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(55).to({_off:false},0).to({alpha:1},9).wait(86).to({x:384.8,alpha:0},9,cjs.Ease.quadIn).wait(66));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(106).to({_off:false},0).to({alpha:1},9,cjs.Ease.quadOut).wait(35).to({x:505.75,alpha:0},9,cjs.Ease.quadIn).wait(66));
	...
	this.instance_13.setTransform(150,821,1,1,0,0,0,150,217);
...
p.nominalBounds = new cjs.Rectangle(149,299,425.20000000000005,742);
// library properties:
lib.properties = {
