...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#008FBE").s().p("");
	this.shape.setTransform(-118.2,-259.95);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_safe, new cjs.Rectangle(-315.6,-278.6,394.3,38.50000000000003), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#008FBE").s().p("");
	this.shape.setTransform(-184.675,-259.475);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_mammogram, new cjs.Rectangle(-490.8,-280.1,612.3,38.50000000000003), null);
...
// stage content:
(lib.BAY_PowerOfTwo_320x50 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(35.3,25.3,0.4422,0.4422,-12.2428,0,0,-101.5,5.3);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(220).to({_off:false},0).to({regY:5.2,scaleX:0.6611,scaleY:0.6611,rotation:0,x:35.35,alpha:1},4,cjs.Ease.quadOut).to({regX:-101.7,regY:5,scaleX:0.5726,scaleY:0.5726,x:35.25,y:25.15},7,cjs.Ease.quadOut).wait(32));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(164).to({_off:false},0).to({alpha:1,startPosition:10},10).wait(46).to({mode:"single",startPosition:56},0).wait(43));

	// text_animation
	this.instance_5 = new lib.text_animation("synched",0,false);
	this.instance_5.setTransform(84.45,26,0.8071,0.8071,0,0,0,364.6,47.5);
...
p.nominalBounds = new cjs.Rectangle(159,24,162,357.8);
// library properties:
lib.properties = {
