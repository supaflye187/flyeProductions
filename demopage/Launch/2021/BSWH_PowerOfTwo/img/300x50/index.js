...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#008FBE").s().p("");
	this.shape.setTransform(-126.85,-259.625);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(222.85,18.1,0.4313,0.4313,0,0,0,137.6,-35.8);
	...
	this.instance_4.setTransform(212,37.8,0.1126,0.1126,0,0,0,-286.9,51.5);
	...
	this.instance_5.setTransform(74.8,26.05,0.7036,0.7036,0,0,0,364.4,47.4);
