...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#008FBE").s().p("");
	this.shape.setTransform(53.05,-240.3);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_safe, new cjs.Rectangle(-278.3,-247.7,420.5,157), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#008FBE").s().p("");
	this.shape.setTransform(16,-239.15);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_mammogram, new cjs.Rectangle(-425.1,-248.6,618,157), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-154.35,-30.75,0.5013,0.5013);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.safeCare_logo_1, new cjs.Rectangle(-154.3,-30.7,102.70000000000002,69.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-241.2,-43.7,0.4055,0.4055);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.powerBadge_1, new cjs.Rectangle(-241.2,-43.7,78.69999999999999,79.9), null);
...
// stage content:
(lib.BAY_PowerOfTwo_728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance_1.setTransform(61.2,44.55,0.7,0.7,-4.9997,0,0,-101.5,5.1);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(220).to({_off:false},0).to({regY:5.2,scaleX:1.094,scaleY:1.094,rotation:0,x:61.15,y:44.6},4,cjs.Ease.quadOut).to({regX:-101.7,regY:5,scaleX:1,scaleY:1,y:44.5},7,cjs.Ease.quadOut).wait(32));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(220).to({_off:false},0).to({y:319.35,alpha:1},8,cjs.Ease.quadOut).wait(35));
	...
	this.instance_4.setTransform(46.85,46.15,0.9,0.9,0,0,0,-202.1,-4.1);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(164).to({_off:false},0).to({regX:-202.2,regY:-4.2,scaleX:1,scaleY:1,x:46.8,y:46.1,alpha:1},10,cjs.Ease.quadOut).wait(37).to({regX:-202.1,scaleX:0.67,scaleY:0.67,x:46.85,y:46.15,alpha:0},9,cjs.Ease.quadIn).to({_off:true},1).wait(42));
	...
	var mask = new cjs.Shape();
	mask._off = true;
	mask.graphics.p("AzuInIAAxNMAndAAAIAARNg");
	mask.setTransform(117.5,47.075);

	// paperDoll_group
	this.instance_6 = new lib.paperDoll_group();
	this.instance_6.setTransform(213.8,45.65,0.3739,0.3739,0,0,0,-531.8,99.9);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(5).to({_off:false},0).to({y:333.85,alpha:1},14).wait(139).to({alpha:0},6).to({_off:true},1).wait(98));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(5).to({_off:false},0).to({y:369.6,alpha:1},14).wait(34).to({x:109.6},6,cjs.Ease.quadOut).wait(31).to({x:119.7},6,cjs.Ease.quadInOut).wait(29).to({x:119.5},6,cjs.Ease.quadInOut).wait(27).to({alpha:0},6).to({_off:true},1).wait(98));

	// underline
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#018EBE").ss(1,1,1).p("AgKAAIAVAA");
	this.shape_1.setTransform(402.75,65.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#018EBE").ss(1,1,1).p("AgVAAIArAA");
	this.shape_2.setTransform(403.775,65.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#018EBE").ss(1,1,1).p("Ag0AAIBpAA");
	this.shape_3.setTransform(406.85,65.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#018EBE").ss(1,1,1).p("AhnAAIDPAA");
	this.shape_4.setTransform(411.975,65.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#018EBE").ss(1,1,1).p("AiaAAIE1AA");
	this.shape_5.setTransform(417.1,65.5);
	this.shape_5._off = true;

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#018EBE").ss(1,1,1).p("Ai5AAIFzAA");
	this.shape_6.setTransform(420.175,65.5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#018EBE").ss(1,1,1).p("AjDAAIGHAA");
	this.shape_7.setTransform(421.2,65.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#018EBE").ss(1,1,1).p("AjGAAIGNAA");
	this.shape_8.setTransform(421.225,65.5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#018EBE").ss(1,1,1).p("AjPAAIGfAA");
	this.shape_9.setTransform(421.325,65.5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#018EBE").ss(1,1,1).p("AjfAAIG/AA");
	this.shape_10.setTransform(421.475,65.5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f().s("#018EBE").ss(1,1,1).p("AjuAAIHdAA");
	this.shape_11.setTransform(421.625,65.5);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#018EBE").ss(1,1,1).p("Aj3AAIHvAA");
	this.shape_12.setTransform(421.725,65.5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f().s("#018EBE").ss(1,1,1).p("Aj6AAIH1AA");
	this.shape_13.setTransform(421.75,65.5);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f().s("#018EBE").ss(1,1,1).p("Aj1AAIHrAA");
	this.shape_14.setTransform(421.75,65.5);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f().s("#018EBE").ss(1,1,1).p("AjlAAIHLAA");
	this.shape_15.setTransform(421.7,65.5);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f().s("#018EBE").ss(1,1,1).p("AjKAAIGVAA");
	this.shape_16.setTransform(421.65,65.5);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f().s("#018EBE").ss(1,1,1).p("AivAAIFfAA");
	this.shape_17.setTransform(421.6,65.5);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f().s("#018EBE").ss(1,1,1).p("AifAAIE/AA");
	this.shape_18.setTransform(421.55,65.5);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f().s("#018EBE").ss(1,1,1).p("AiZAAIEzAA");
	this.shape_19.setTransform(421.55,65.5);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f().s("rgba(1,142,190,0.831)").ss(1,1,1).p("AiaAAIE1AA");
	this.shape_20.setTransform(421.4,65.5);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f().s("rgba(1,142,190,0.667)").ss(1,1,1).p("AiaAAIE1AA");
	this.shape_21.setTransform(421.4,65.5);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f().s("rgba(1,142,190,0.502)").ss(1,1,1).p("AiaAAIE1AA");
	this.shape_22.setTransform(421.4,65.5);

	this.shape_23 = new cjs.Shape();
	this.shape_23.graphics.f().s("rgba(1,142,190,0.333)").ss(1,1,1).p("AiaAAIE1AA");
	this.shape_23.setTransform(421.4,65.5);

	this.shape_24 = new cjs.Shape();
	this.shape_24.graphics.f().s("rgba(1,142,190,0.169)").ss(1,1,1).p("AiaAAIE1AA");
	this.shape_24.setTransform(421.4,65.5);

	this.shape_25 = new cjs.Shape();
	this.shape_25.graphics.f().s("rgba(1,142,190,0)").ss(1,1,1).p("AiaAAIE1AA");
	this.shape_25.setTransform(421.4,65.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1}]},17).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_7}]},30).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_12}]},1).to({state:[{t:this.shape_13}]},1).to({state:[{t:this.shape_13}]},31).to({state:[{t:this.shape_14}]},1).to({state:[{t:this.shape_15}]},1).to({state:[{t:this.shape_16}]},1).to({state:[{t:this.shape_17}]},1).to({state:[{t:this.shape_18}]},1).to({state:[{t:this.shape_19}]},1).to({state:[{t:this.shape_19}]},29).to({state:[{t:this.shape_19}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_5}]},27).to({state:[{t:this.shape_20}]},1).to({state:[{t:this.shape_21}]},1).to({state:[{t:this.shape_22}]},1).to({state:[{t:this.shape_23}]},1).to({state:[{t:this.shape_24}]},1).to({state:[{t:this.shape_25}]},1).to({state:[]},1).wait(98));
	this.timeline.addTween(cjs.Tween.get(this.shape_5).wait(21).to({_off:false},0).to({_off:true},1).wait(105).to({_off:false,x:421.525},0).wait(1).to({x:421.475},0).wait(1).to({x:421.425},0).wait(1).to({x:421.4},0).wait(28).to({_off:true},1).wait(104));

	// txt_mask (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_5 = new cjs.Graphics().p("EAjGAFGImcAAIm0AAIAAjIINQAAIBiAAIAADIg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(5).to({graphics:mask_1_graphics_5,x:234.425,y:32.625}).wait(160).to({graphics:null,x:0,y:0}).wait(98));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(5).to({_off:false},0).to({alpha:1},5).to({y:364.2},9,cjs.Ease.quadInOut).wait(34).to({y:364.4},0).to({y:334},6,cjs.Ease.quadOut).to({_off:true},1).wait(203));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(53).to({_off:false},0).to({y:364.6},6,cjs.Ease.quadOut).wait(31).to({y:328.4},6,cjs.Ease.quadOut).to({_off:true},1).wait(166));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(90).to({_off:false},0).to({y:364.2},6,cjs.Ease.quadOut).wait(29).to({y:328.4},6,cjs.Ease.quadOut).to({_off:true},1).wait(131));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(125).to({_off:false},0).to({y:364.4},6,cjs.Ease.quadOut).wait(27).to({alpha:0},6).to({_off:true},1).wait(98));

	// background_Color
	this.shape_26 = new cjs.Shape();
	this.shape_26.graphics.f("#FFFFFF").s().p("Eg43AHCIAAuDMBxvAAAIAAODg");
	this.shape_26.setTransform(364,45);

	this.timeline.addTween(cjs.Tween.get(this.shape_26).wait(263));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(355.2,44,373.8,337.8);
// library properties:
lib.properties = {
