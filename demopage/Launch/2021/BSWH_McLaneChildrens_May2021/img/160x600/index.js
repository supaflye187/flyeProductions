...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-201.9,-6.95,0.6413,0.6413);
...
if (reversed == null) { reversed = false; }
	...
	// orange_BG
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#1D459A").s().p("AuNG5IAAtxIcbAAIAANxg");
	...
	// orange_BG
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#1D459A").s().p("EgZJAwJMAAAhgRMAyUAAAMAAABgRg");
