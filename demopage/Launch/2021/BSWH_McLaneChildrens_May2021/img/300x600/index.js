...
if (reversed == null) { reversed = false; }
	...
	// steam_engine_Loop
	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#EDB634").s().p("");
	this.shape_5.setTransform(160.5862,270.1678);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#233FA2").s().p("Ah4AxQAsgMAAgCIAaB1IgpAOgAg0ATQAsgNAAgCIAZB1IgoANgAgUiRIBfgUIAuEKQACAChOATgAAmhmIAAACIABAAIAAgBIABABIABAAIAAgBIABgBIgBAAIgBAAIAAgBIgBAAIAAAAIAAABIgBAAIgBAAIABAAg");
	this.shape_6.setTransform(188.7525,305.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Train_mc_static, new cjs.Rectangle(83.8,245.3,135.60000000000002,109.39999999999998), null);
...
if (reversed == null) { reversed = false; }
	...
	// orange_BG
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#323232").ss(1,1,1).p("EgZKgwIMAyVAAAMAAABgRMgyVAAAg");
	this.shape_1.setTransform(-269.05,272.075);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#F26923").s().p("EgZJAwJMAAAhgRMAyUAAAMAAABgRg");
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_2},{t:this.shape_1}]},123).wait(97));
	...
	// Layer_51
	this.instance_2 = new lib.Train_mc_static();
	this.instance_2.setTransform(66.6,482,0.571,0.571,0,0,0,151.5,300);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(122).to({_off:false},0).wait(98));
	...
	// orange_BG
	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F26923").s().p("EgZJAwJMAAAhgRMAyUAAAMAAABgRg");
	this.shape_3.setTransform(151.05,302.075);
	this.shape_3._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_3).wait(57).to({_off:false},0).wait(163));
	...
	this.timeline.addTween(cjs.Tween.get(this.shape_4).wait(220));
