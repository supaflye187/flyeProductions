...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.beginFill("#008FBE").beginStroke().moveTo(75.7,4.6).curveTo(75.4,4.2,75.4,3.6).curveTo(75.4,3,75.7,2.7).curveTo(76,2.4,76.6,2.3).curveTo(77.2,2.4,77.5,2.7).curveTo(77.9,3,77.9,3.6).curveTo(77.9,4.2,77.5,4.6).curveTo(77.2,4.9,76.6,4.9).curveTo(76,4.9,75.7,4.6).closePath().moveTo(59.6,4.5).curveTo(58.8,4.1,58.2,3.4).curveTo(57.5,2.8,57.2,1.9).curveTo(56.8,1,56.8,-0).curveTo(56.8,-1.1,57.2,-2).curveTo(57.5,-2.8,58.2,-3.4).curveTo(58.8,-4.2,59.7,-4.5).curveTo(60.6,-4.8,61.7,-4.9).curveTo(62.4,-4.8,62.9,-4.7).curveTo(63.6,-4.5,64.1,-4.2).lineTo(65.2,-3.5).lineTo(65.9,-2.5).lineTo(63.9,-1.3).curveTo(63.5,-1.9,63,-2.3).curveTo(62.4,-2.7,61.7,-2.6).curveTo(61.1,-2.6,60.7,-2.4).curveTo(60.1,-2.3,59.8,-1.8).lineTo(59.3,-1.1).curveTo(59.1,-0.5,59.1,-0).curveTo(59.1,0.6,59.3,1).curveTo(59.5,1.5,59.8,1.9).curveTo(60.2,2.2,60.6,2.4).curveTo(61,2.7,61.7,2.7).curveTo(62.5,2.7,63,2.2).curveTo(63.7,1.7,63.9,1.1).lineTo(66.1,2.2).curveTo(65.8,2.8,65.3,3.3).lineTo(64.3,4.1).curveTo(63.7,4.5,63.1,4.7).curveTo(62.4,4.9,61.7,4.9).curveTo(60.6,4.9,59.6,4.5).closePath().moveTo(21,4.6).curveTo(20.3,4.3,19.8,3.9).curveTo(19.4,3.4,19,2.7).curveTo(18.7,1.9,18.7,1).lineTo(18.7,-4.8).lineTo(21.1,-4.8).lineTo(21.1,1).curveTo(21.1,1.8,21.5,2.2).curveTo(21.9,2.6,22.6,2.7).curveTo(23.3,2.6,23.7,2.2).curveTo(24.1,1.8,24.1,1).lineTo(24.1,-4.8).lineTo(26.5,-4.8).lineTo(26.5,1).curveTo(26.4,1.9,26.1,2.7).curveTo(25.9,3.4,25.4,3.9).curveTo(24.9,4.3,24.2,4.6).curveTo(23.5,4.9,22.6,4.9).curveTo(21.7,4.9,21,4.6).closePath().moveTo(11,4.5).curveTo(10.1,4.1,9.5,3.4).curveTo(8.8,2.8,8.4,1.9).curveTo(8.1,1,8,-0).curveTo(8.1,-1,8.4,-1.9).curveTo(8.8,-2.8,9.5,-3.4).curveTo(10.1,-4.1,11,-4.5).curveTo(11.9,-4.8,12.9,-4.9).curveTo(13.9,-4.8,14.8,-4.5).curveTo(15.7,-4.1,16.3,-3.4).curveTo(17,-2.8,17.4,-1.9).curveTo(17.7,-1,17.8,-0).curveTo(17.7,1,17.4,1.9).curveTo(17,2.8,16.3,3.4).curveTo(15.7,4.1,14.8,4.5).curveTo(13.9,4.9,12.9,4.9).curveTo(11.9,4.9,11,4.5).closePath().moveTo(11.8,-2.4).curveTo(11.4,-2.3,11,-1.8).curveTo(10.7,-1.5,10.6,-1).curveTo(10.4,-0.6,10.4,-0).curveTo(10.4,0.6,10.5,1).curveTo(10.7,1.5,11,1.9).curveTo(11.4,2.2,11.8,2.4).curveTo(12.4,2.6,12.9,2.7).curveTo(13.4,2.6,14,2.4).curveTo(14.4,2.2,14.8,1.9).curveTo(15.1,1.5,15.3,1).curveTo(15.5,0.6,15.5,-0).curveTo(15.5,-0.6,15.3,-1).curveTo(15.1,-1.5,14.8,-1.8).curveTo(14.4,-2.3,13.9,-2.4).curveTo(13.4,-2.6,12.9,-2.6).curveTo(12.4,-2.6,11.8,-2.4).closePath().moveTo(-19.4,4.5).curveTo(-20.3,4.1,-21,3.4).curveTo(-21.6,2.8,-22,1.9).curveTo(-22.4,1,-22.4,-0).curveTo(-22.4,-1,-22,-1.9).curveTo(-21.6,-2.8,-21,-3.4).curveTo(-20.3,-4.1,-19.4,-4.5).curveTo(-18.6,-4.8,-17.5,-4.9).curveTo(-16.6,-4.8,-15.6,-4.5).curveTo(-14.8,-4.1,-14.1,-3.4).curveTo(-13.5,-2.8,-13,-1.9).curveTo(-12.7,-1,-12.7,-0).curveTo(-12.7,1,-13,1.9).curveTo(-13.5,2.8,-14.1,3.4).curveTo(-14.8,4.1,-15.6,4.5).curveTo(-16.6,4.9,-17.5,4.9).curveTo(-18.6,4.9,-19.4,4.5).closePath().moveTo(-18.6,-2.4).curveTo(-19.1,-2.3,-19.4,-1.8).curveTo(-19.7,-1.5,-19.9,-1).curveTo(-20.1,-0.6,-20.1,-0).curveTo(-20.1,0.6,-19.9,1).curveTo(-19.7,1.5,-19.4,1.9).curveTo(-19.1,2.2,-18.6,2.4).curveTo(-18.1,2.6,-17.5,2.7).curveTo(-17,2.6,-16.5,2.4).curveTo(-16,2.2,-15.7,1.9).curveTo(-15.4,1.5,-15.2,1).curveTo(-15,0.6,-14.9,-0).curveTo(-15,-0.6,-15.2,-1).curveTo(-15.4,-1.5,-15.7,-1.8).curveTo(-16.1,-2.3,-16.5,-2.4).curveTo(-17,-2.6,-17.5,-2.6).curveTo(-18.1,-2.6,-18.6,-2.4).closePath().moveTo(-29.9,4.5).curveTo(-30.9,4.1,-31.5,3.4).curveTo(-32.2,2.7,-32.5,1.9).curveTo(-32.9,1,-32.8,-0).curveTo(-32.9,-1,-32.5,-1.9).curveTo(-32.1,-2.8,-31.5,-3.4).curveTo(-30.9,-4.1,-29.9,-4.5).curveTo(-29,-4.8,-28,-4.9).curveTo(-26.6,-4.9,-25.6,-4.3).curveTo(-24.6,-3.8,-23.9,-3).lineTo(-25.8,-1.6).curveTo(-26.2,-2.1,-26.7,-2.4).curveTo(-27.2,-2.7,-28,-2.7).curveTo(-28.5,-2.7,-29,-2.5).curveTo(-29.4,-2.3,-29.8,-2).curveTo(-30.2,-1.6,-30.4,-1.1).curveTo(-30.6,-0.6,-30.6,-0).curveTo(-30.6,0.6,-30.4,1.1).curveTo(-30.2,1.6,-29.8,2).curveTo(-29.5,2.3,-29,2.5).curveTo(-28.5,2.8,-27.9,2.8).curveTo(-27.1,2.8,-26.5,2.3).curveTo(-26,2,-25.7,1.2).lineTo(-28.3,1.2).lineTo(-28.3,-0.8).lineTo(-23.3,-0.8).lineTo(-23.3,0.2).curveTo(-23.3,1.2,-23.6,2).curveTo(-24,2.9,-24.5,3.5).curveTo(-25.2,4.1,-26,4.5).curveTo(-26.9,4.9,-27.9,4.9).curveTo(-29,4.9,-29.9,4.5).closePath().moveTo(72.5,4.8).lineTo(70.4,0.3).lineTo(69.2,1.9).lineTo(69.2,4.8).lineTo(66.9,4.8).lineTo(66.9,-4.8).lineTo(69.2,-4.8).lineTo(69.2,-0.8).lineTo(72.2,-4.8).lineTo(74.8,-4.8).lineTo(72,-1.3).lineTo(74.8,4.8).closePath().moveTo(54,4.8).lineTo(53.5,3.3).lineTo(49.9,3.3).lineTo(49.4,4.8).lineTo(47.1,4.8).lineTo(50.6,-4.8).lineTo(52.8,-4.8).lineTo(56.3,4.8).closePath().moveTo(52.8,1.3).lineTo(51.7,-1.8).lineTo(50.6,1.3).lineTo(52.8,1.3).closePath().moveTo(39.3,4.8).lineTo(39.3,-4.8).lineTo(43,-4.8).curveTo(44.8,-4.7,45.6,-4.1).curveTo(46.5,-3.3,46.5,-2).curveTo(46.4,-1.4,46.2,-0.9).curveTo(46,-0.5,45.5,-0.2).curveTo(46,0.2,46.4,0.6).curveTo(46.6,1.2,46.6,1.9).curveTo(46.6,3.4,45.7,4).curveTo(44.7,4.8,43,4.8).closePath().moveTo(41.4,2.8).lineTo(43.1,2.8).curveTo(43.7,2.8,44,2.5).curveTo(44.3,2.3,44.3,1.8).curveTo(44.3,1.4,44,1.2).curveTo(43.8,0.9,43.1,0.9).lineTo(41.4,0.9).closePath().moveTo(41.4,-1.1).lineTo(43.1,-1.1).curveTo(43.7,-1.1,44,-1.3).curveTo(44.2,-1.6,44.2,-2).curveTo(44.2,-2.4,44,-2.5).curveTo(43.7,-2.7,43.1,-2.7).lineTo(41.4,-2.7).closePath().moveTo(33.1,4.8).lineTo(31.7,1.9).lineTo(29.9,1.9).lineTo(29.9,4.8).lineTo(27.7,4.8).lineTo(27.7,-4.8).lineTo(31.8,-4.8).curveTo(32.7,-4.8,33.3,-4.5).curveTo(34,-4.2,34.4,-3.8).curveTo(34.9,-3.3,35.1,-2.7).curveTo(35.3,-2.1,35.3,-1.5).curveTo(35.3,-0.6,35,0.2).curveTo(34.6,0.9,33.8,1.3).lineTo(35.6,4.8).closePath().moveTo(29.9,-0.2).lineTo(31.6,-0.2).curveTo(32.3,-0.2,32.7,-0.5).curveTo(33,-0.9,33.1,-1.5).curveTo(33,-2,32.7,-2.4).curveTo(32.3,-2.6,31.6,-2.6).lineTo(29.9,-2.6).closePath().moveTo(2.1,4.8).lineTo(2.1,0.7).lineTo(-1,-4.8).lineTo(1.5,-4.8).lineTo(3.3,-1.4).lineTo(5.1,-4.8).lineTo(7.5,-4.8).lineTo(4.4,0.8).lineTo(4.4,4.8).closePath().moveTo(-9.2,4.8).lineTo(-9.2,-2.6).lineTo(-11.8,-2.6).lineTo(-11.8,-4.8).lineTo(-4.5,-4.8).lineTo(-4.5,-2.6).lineTo(-7,-2.6).lineTo(-7,4.8).closePath().moveTo(-43.3,4.8).lineTo(-43.3,-4.8).lineTo(-36.7,-4.8).lineTo(-36.7,-2.6).lineTo(-41,-2.6).lineTo(-41,-1.1).lineTo(-36.7,-1.1).lineTo(-36.7,1.1).lineTo(-41,1.1).lineTo(-41,2.7).lineTo(-36.7,2.7).lineTo(-36.7,4.8).closePath().moveTo(-49.7,4.8).lineTo(-53.2,-4.8).lineTo(-50.8,-4.8).lineTo(-48.6,1.6).lineTo(-46.3,-4.8).lineTo(-44,-4.8).lineTo(-47.5,4.8).closePath().moveTo(-64,4.8).lineTo(-64,-4.8).lineTo(-57.4,-4.8).lineTo(-57.4,-2.6).lineTo(-61.7,-2.6).lineTo(-61.7,-1.1).lineTo(-57.4,-1.1).lineTo(-57.4,1.1).lineTo(-61.7,1.1).lineTo(-61.7,2.7).lineTo(-57.4,2.7).lineTo(-57.4,4.8).closePath().moveTo(-69.7,4.8).lineTo(-71.4,-1.3).lineTo(-73.1,4.8).lineTo(-75.3,4.8).lineTo(-77.9,-4.8).lineTo(-75.6,-4.8).lineTo(-74.1,1.1).lineTo(-72.4,-4.8).lineTo(-70.3,-4.8).lineTo(-68.6,1.2).lineTo(-67.1,-4.8).lineTo(-64.9,-4.8).lineTo(-67.6,4.8).closePath().moveTo(-55.9,-1.2).lineTo(-55.1,-2).curveTo(-54.8,-2.4,-54.7,-2.9).curveTo(-54.9,-2.5,-55.3,-2.5).curveTo(-55.8,-2.5,-56,-2.8).curveTo(-56.3,-3.2,-56.3,-3.6).curveTo(-56.3,-4.2,-56,-4.5).curveTo(-55.6,-4.9,-55.1,-4.9).curveTo(-54.3,-4.9,-54,-4.4).curveTo(-53.6,-3.9,-53.6,-3.3).curveTo(-53.6,-2.4,-54.1,-1.7).curveTo(-54.5,-1.1,-55.2,-0.5).closePath();
	this.shape.setTransform(53.7,-24.2);
