...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.beginFill("#008FBE").beginStroke().moveTo(58.7,7).curveTo(58.2,6.5,58.2,5.5).curveTo(58.2,4.7,58.8,4.1).curveTo(59.3,3.6,60.2,3.6).curveTo(61.1,3.6,61.6,4.1).curveTo(62.1,4.7,62.1,5.5).curveTo(62.1,6.5,61.6,7).curveTo(61.1,7.5,60.2,7.5).curveTo(59.3,7.5,58.7,7).closePath().moveTo(33.5,6.9).curveTo(32.1,6.3,31.1,5.3).curveTo(30.1,4.3,29.6,2.9).curveTo(29,1.5,29,-0).curveTo(29,-1.6,29.6,-2.9).curveTo(30.2,-4.3,31.2,-5.3).curveTo(32.2,-6.3,33.5,-7).curveTo(34.9,-7.5,36.5,-7.5).curveTo(37.6,-7.5,38.5,-7.2).curveTo(39.5,-7,40.3,-6.5).curveTo(41.2,-6.1,41.9,-5.3).curveTo(42.5,-4.7,43,-3.9).lineTo(40,-1.9).curveTo(39.5,-2.9,38.6,-3.5).curveTo(37.7,-4.1,36.5,-4.1).curveTo(35.7,-4.1,34.9,-3.7).curveTo(34.2,-3.4,33.7,-2.9).curveTo(33.2,-2.3,32.9,-1.6).curveTo(32.6,-0.8,32.6,-0).curveTo(32.6,0.8,32.9,1.6).curveTo(33.2,2.3,33.7,2.8).curveTo(34.2,3.4,34.9,3.7).curveTo(35.6,4.1,36.5,4).curveTo(37.8,4,38.7,3.4).curveTo(39.6,2.7,40,1.7).lineTo(43.3,3.4).curveTo(42.8,4.3,42.1,5).curveTo(41.4,5.8,40.6,6.4).curveTo(39.7,6.9,38.7,7.2).curveTo(37.7,7.5,36.5,7.5).curveTo(34.8,7.5,33.5,6.9).closePath().moveTo(-27.5,7.1).curveTo(-28.6,6.7,-29.4,5.9).curveTo(-30.1,5.2,-30.6,4.1).curveTo(-31,3,-31,1.6).lineTo(-31,-7.3).lineTo(-27.4,-7.3).lineTo(-27.4,1.6).curveTo(-27.4,2.8,-26.8,3.5).curveTo(-26.2,4.1,-25.1,4.1).curveTo(-24,4.1,-23.4,3.5).curveTo(-22.7,2.8,-22.7,1.6).lineTo(-22.7,-7.3).lineTo(-19.2,-7.3).lineTo(-19.2,1.6).curveTo(-19.2,3,-19.6,4.1).curveTo(-20,5.2,-20.8,5.9).curveTo(-21.5,6.7,-22.6,7.1).curveTo(-23.7,7.5,-25.1,7.5).curveTo(-26.4,7.5,-27.5,7.1).closePath().moveTo(-43.3,6.9).curveTo(-44.7,6.3,-45.7,5.3).curveTo(-46.7,4.3,-47.3,2.9).curveTo(-47.9,1.5,-47.9,-0).curveTo(-47.9,-1.6,-47.3,-2.9).curveTo(-46.7,-4.3,-45.7,-5.3).curveTo(-44.7,-6.3,-43.3,-6.9).curveTo(-42,-7.5,-40.4,-7.5).curveTo(-38.8,-7.5,-37.5,-6.9).curveTo(-36.1,-6.3,-35.1,-5.3).curveTo(-34.1,-4.3,-33.5,-2.9).curveTo(-32.9,-1.6,-32.9,-0).curveTo(-32.9,1.5,-33.5,2.9).curveTo(-34.1,4.3,-35.1,5.3).curveTo(-36.1,6.3,-37.5,6.9).curveTo(-38.8,7.5,-40.4,7.5).curveTo(-42,7.5,-43.3,6.9).closePath().moveTo(-42,-3.7).curveTo(-42.7,-3.4,-43.2,-2.9).curveTo(-43.7,-2.3,-44,-1.6).curveTo(-44.3,-0.8,-44.3,-0).curveTo(-44.3,0.8,-44.1,1.6).curveTo(-43.8,2.3,-43.2,2.8).curveTo(-42.7,3.4,-42,3.8).curveTo(-41.3,4,-40.4,4).curveTo(-39.5,4,-38.8,3.8).curveTo(-38.1,3.4,-37.6,2.8).curveTo(-37,2.3,-36.7,1.6).curveTo(-36.4,0.8,-36.4,-0).curveTo(-36.4,-0.8,-36.7,-1.6).curveTo(-37,-2.3,-37.6,-2.9).curveTo(-38.1,-3.4,-38.8,-3.7).curveTo(-39.6,-4.1,-40.4,-4.1).curveTo(-41.2,-4.1,-42,-3.7).closePath().moveTo(53.4,7.3).lineTo(50.3,0.4).lineTo(48.4,2.8).lineTo(48.4,7.3).lineTo(44.9,7.3).lineTo(44.9,-7.3).lineTo(48.4,-7.3).lineTo(48.4,-1.4).lineTo(53.1,-7.3).lineTo(57.1,-7.3).lineTo(52.8,-1.9).lineTo(57.2,7.3).closePath().moveTo(24.5,7.3).lineTo(23.7,5.1).lineTo(18.1,5.1).lineTo(17.4,7.3).lineTo(13.8,7.3).lineTo(19.2,-7.3).lineTo(22.6,-7.3).lineTo(28,7.3).closePath().moveTo(22.6,2.1).lineTo(20.9,-2.8).lineTo(19.2,2.1).lineTo(22.6,2.1).closePath().moveTo(1.4,7.3).lineTo(1.4,-7.3).lineTo(7.2,-7.3).curveTo(9.8,-7.3,11.2,-6.2).curveTo(12.5,-5.2,12.5,-3.1).curveTo(12.5,-2.1,12.1,-1.4).curveTo(11.7,-0.7,11,-0.2).curveTo(11.9,0.2,12.3,1).curveTo(12.8,1.8,12.8,2.9).curveTo(12.8,5.1,11.3,6.3).curveTo(9.8,7.3,7.2,7.3).closePath().moveTo(4.8,4.3).lineTo(7.3,4.3).curveTo(8.3,4.2,8.8,3.8).curveTo(9.2,3.5,9.2,2.8).curveTo(9.2,2.1,8.8,1.8).curveTo(8.3,1.4,7.2,1.4).lineTo(4.8,1.4).closePath().moveTo(4.8,-1.7).lineTo(7.3,-1.7).curveTo(8.3,-1.7,8.7,-2).curveTo(9,-2.4,9,-3).curveTo(9,-3.6,8.6,-4).curveTo(8.2,-4.3,7.3,-4.3).lineTo(4.8,-4.3).closePath().moveTo(-8.7,7.3).lineTo(-10.7,2.9).lineTo(-13.5,2.9).lineTo(-13.5,7.3).lineTo(-16.9,7.3).lineTo(-16.9,-7.3).lineTo(-10.7,-7.3).curveTo(-9.3,-7.3,-8.3,-6.9).curveTo(-7.3,-6.5,-6.6,-5.8).curveTo(-5.9,-5.2,-5.5,-4.3).curveTo(-5.2,-3.3,-5.2,-2.3).curveTo(-5.2,-0.9,-5.8,0.2).curveTo(-6.4,1.4,-7.5,2).lineTo(-4.8,7.3).closePath().moveTo(-13.5,-0.2).lineTo(-10.9,-0.2).curveTo(-9.8,-0.2,-9.3,-0.8).curveTo(-8.7,-1.4,-8.7,-2.2).curveTo(-8.7,-3.1,-9.3,-3.6).curveTo(-9.8,-4.1,-10.9,-4.1).lineTo(-13.5,-4.1).closePath().moveTo(-57.3,7.3).lineTo(-57.3,1.2).lineTo(-62.1,-7.3).lineTo(-58.3,-7.3).lineTo(-55.5,-2).lineTo(-52.8,-7.3).lineTo(-49,-7.3).lineTo(-53.8,1.2).lineTo(-53.8,7.3).closePath();
	this.shape.setTransform(76.675,0.5);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_yourBack, new cjs.Rectangle(12.2,-14.1,129.70000000000002,30.299999999999997), null);
