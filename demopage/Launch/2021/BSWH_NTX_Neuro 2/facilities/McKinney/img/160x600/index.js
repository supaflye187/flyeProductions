...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.beginFill("#008FBE").beginStroke().moveTo(51.8,6.2).curveTo(51.3,5.8,51.3,5).curveTo(51.3,4.2,51.8,3.7).curveTo(52.3,3.2,53,3.2).curveTo(53.8,3.2,54.4,3.7).curveTo(54.8,4.2,54.8,5).curveTo(54.8,5.8,54.4,6.2).curveTo(53.8,6.8,53,6.8).curveTo(52.3,6.8,51.8,6.2).closePath().moveTo(29.5,6.2).curveTo(28.3,5.6,27.4,4.8).curveTo(26.5,3.9,26,2.6).curveTo(25.5,1.4,25.6,0).curveTo(25.6,-1.4,26,-2.7).curveTo(26.6,-3.9,27.5,-4.8).curveTo(28.4,-5.7,29.6,-6.3).curveTo(30.8,-6.7,32.2,-6.7).curveTo(33.2,-6.7,34.1,-6.5).curveTo(34.9,-6.3,35.7,-5.9).curveTo(36.5,-5.4,37.1,-4.8).curveTo(37.7,-4.3,38.1,-3.6).lineTo(35.4,-1.8).curveTo(34.9,-2.6,34.1,-3.2).curveTo(33.4,-3.7,32.3,-3.7).curveTo(31.5,-3.7,30.9,-3.4).curveTo(30.2,-3.1,29.7,-2.6).curveTo(29.2,-2.1,29,-1.4).curveTo(28.7,-0.8,28.7,0).curveTo(28.7,0.7,29,1.4).curveTo(29.3,2.1,29.7,2.5).curveTo(30.2,3,30.8,3.3).curveTo(31.5,3.6,32.2,3.6).curveTo(33.5,3.6,34.2,3).curveTo(35,2.4,35.5,1.5).lineTo(38.4,3.1).curveTo(37.9,3.8,37.3,4.5).curveTo(36.7,5.2,35.9,5.7).curveTo(35.2,6.2,34.2,6.4).curveTo(33.3,6.8,32.2,6.8).curveTo(30.8,6.7,29.5,6.2).closePath().moveTo(-24.1,6.3).curveTo(-25.2,6,-25.8,5.3).curveTo(-26.5,4.7,-26.9,3.6).curveTo(-27.2,2.7,-27.3,1.4).lineTo(-27.3,-6.6).lineTo(-24.1,-6.6).lineTo(-24.1,1.4).curveTo(-24.1,2.5,-23.5,3.1).curveTo(-23,3.7,-22,3.6).curveTo(-21,3.7,-20.4,3.1).curveTo(-19.8,2.5,-19.9,1.4).lineTo(-19.9,-6.6).lineTo(-16.6,-6.6).lineTo(-16.6,1.4).curveTo(-16.7,2.7,-17,3.6).curveTo(-17.4,4.7,-18.1,5.3).curveTo(-18.8,6,-19.8,6.3).curveTo(-20.7,6.8,-22,6.8).curveTo(-23.2,6.8,-24.1,6.3).closePath().moveTo(-38.1,6.2).curveTo(-39.4,5.6,-40.2,4.8).curveTo(-41.2,3.9,-41.7,2.6).curveTo(-42.2,1.4,-42.2,0).curveTo(-42.2,-1.4,-41.7,-2.7).curveTo(-41.2,-3.9,-40.2,-4.8).curveTo(-39.4,-5.7,-38.1,-6.3).curveTo(-36.9,-6.7,-35.5,-6.7).curveTo(-34.1,-6.7,-32.8,-6.3).curveTo(-31.6,-5.7,-30.8,-4.8).curveTo(-29.8,-3.9,-29.3,-2.7).curveTo(-28.7,-1.4,-28.8,0).curveTo(-28.7,1.4,-29.3,2.6).curveTo(-29.8,3.9,-30.8,4.8).curveTo(-31.6,5.6,-32.8,6.2).curveTo(-34.1,6.7,-35.5,6.8).curveTo(-36.9,6.7,-38.1,6.2).closePath().moveTo(-36.9,-3.4).curveTo(-37.6,-3.1,-38.1,-2.6).curveTo(-38.5,-2.1,-38.8,-1.4).curveTo(-39,-0.8,-39.1,0).curveTo(-39,0.7,-38.8,1.4).curveTo(-38.5,2.1,-38.1,2.5).curveTo(-37.6,3,-36.9,3.3).curveTo(-36.3,3.6,-35.5,3.6).curveTo(-34.8,3.6,-34,3.3).curveTo(-33.4,3,-32.9,2.5).curveTo(-32.5,2.1,-32.2,1.4).curveTo(-31.9,0.7,-31.9,0).curveTo(-31.9,-0.8,-32.2,-1.4).curveTo(-32.5,-2.1,-32.9,-2.6).curveTo(-33.5,-3.1,-34.1,-3.4).curveTo(-34.7,-3.7,-35.5,-3.7).curveTo(-36.3,-3.7,-36.9,-3.4).closePath().moveTo(47.3,6.6).lineTo(44.5,0.4).lineTo(42.7,2.5).lineTo(42.7,6.6).lineTo(39.6,6.6).lineTo(39.6,-6.6).lineTo(42.7,-6.6).lineTo(42.7,-1.2).lineTo(46.9,-6.6).lineTo(50.6,-6.6).lineTo(46.7,-1.8).lineTo(50.6,6.6).closePath().moveTo(21.6,6.6).lineTo(21,4.6).lineTo(15.9,4.6).lineTo(15.2,6.6).lineTo(12.1,6.6).lineTo(16.9,-6.6).lineTo(20,-6.6).lineTo(24.9,6.6).closePath().moveTo(20,1.8).lineTo(18.5,-2.6).lineTo(16.9,1.8).lineTo(20,1.8).closePath().moveTo(1.2,6.6).lineTo(1.2,-6.6).lineTo(6.3,-6.6).curveTo(8.8,-6.6,9.9,-5.7).curveTo(11.1,-4.7,11.2,-2.9).curveTo(11.1,-1.9,10.8,-1.3).curveTo(10.5,-0.6,9.8,-0.3).curveTo(10.6,0.2,11,0.8).curveTo(11.4,1.5,11.4,2.5).curveTo(11.4,4.7,10.1,5.6).curveTo(8.8,6.6,6.3,6.6).closePath().moveTo(4.2,3.8).lineTo(6.5,3.8).curveTo(7.3,3.8,7.8,3.4).curveTo(8.2,3.1,8.2,2.5).curveTo(8.2,1.8,7.8,1.5).curveTo(7.4,1.3,6.4,1.3).lineTo(4.2,1.3).closePath().moveTo(4.2,-1.5).lineTo(6.5,-1.5).curveTo(7.4,-1.5,7.7,-1.9).curveTo(8.1,-2.2,8,-2.7).curveTo(8.1,-3.2,7.7,-3.6).curveTo(7.4,-3.8,6.5,-3.8).lineTo(4.2,-3.8).closePath().moveTo(-7.5,6.6).lineTo(-9.3,2.6).lineTo(-11.8,2.6).lineTo(-11.8,6.6).lineTo(-14.8,6.6).lineTo(-14.8,-6.6).lineTo(-9.2,-6.6).curveTo(-8,-6.6,-7.1,-6.3).curveTo(-6.2,-5.8,-5.6,-5.3).curveTo(-4.9,-4.7,-4.6,-3.8).curveTo(-4.3,-3,-4.3,-2).curveTo(-4.3,-0.8,-4.9,0.2).curveTo(-5.5,1.2,-6.4,1.8).lineTo(-3.9,6.6).closePath().moveTo(-11.8,-0.3).lineTo(-9.4,-0.3).curveTo(-8.5,-0.2,-7.9,-0.8).curveTo(-7.5,-1.3,-7.5,-2).curveTo(-7.5,-2.8,-8,-3.2).curveTo(-8.4,-3.7,-9.4,-3.7).lineTo(-11.8,-3.7).closePath().moveTo(-50.6,6.6).lineTo(-50.6,1).lineTo(-54.9,-6.6).lineTo(-51.5,-6.6).lineTo(-48.9,-1.9).lineTo(-46.4,-6.6).lineTo(-43,-6.6).lineTo(-47.3,1.1).lineTo(-47.3,6.6).closePath();
	this.shape.setTransform(38.15,53.8);
