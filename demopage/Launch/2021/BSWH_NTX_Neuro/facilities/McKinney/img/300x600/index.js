...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.beginFill("#008FBE").beginStroke().moveTo(53.3,8.3).curveTo(51.7,7.6,50.5,6.4).curveTo(49.3,5.2,48.7,3.5).curveTo(48,1.9,48,0).curveTo(48,-1.9,48.7,-3.6).curveTo(49.4,-5.2,50.6,-6.4).curveTo(51.8,-7.6,53.4,-8.3).curveTo(55.1,-9,57,-9).curveTo(58.3,-9,59.4,-8.7).curveTo(60.6,-8.4,61.6,-7.8).curveTo(62.6,-7.2,63.4,-6.4).curveTo(64.2,-5.6,64.8,-4.7).lineTo(61.1,-2.3).curveTo(60.5,-3.5,59.5,-4.2).curveTo(58.5,-4.9,57,-4.9).curveTo(56,-4.9,55.1,-4.5).curveTo(54.3,-4.1,53.6,-3.4).curveTo(53,-2.8,52.7,-1.9).curveTo(52.3,-1,52.3,0).curveTo(52.3,1,52.6,1.9).curveTo(53,2.8,53.6,3.4).curveTo(54.2,4.1,55.1,4.5).curveTo(55.9,4.9,57,4.9).curveTo(58.6,4.9,59.6,4.1).curveTo(60.7,3.3,61.2,2).lineTo(65.1,4.1).curveTo(64.6,5.2,63.7,6.1).curveTo(62.9,7,61.9,7.6).curveTo(60.9,8.3,59.6,8.7).curveTo(58.4,9,57,9).curveTo(55,9,53.3,8.3).closePath().moveTo(-40.4,8.5).curveTo(-41.7,8.1,-42.7,7.1).curveTo(-43.6,6.2,-44.1,4.9).curveTo(-44.6,3.6,-44.6,1.9).lineTo(-44.6,-8.7).lineTo(-40.3,-8.7).lineTo(-40.3,1.9).curveTo(-40.3,3.3,-39.6,4.1).curveTo(-38.8,4.9,-37.5,4.9).curveTo(-36.3,4.9,-35.5,4.1).curveTo(-34.7,3.3,-34.7,1.9).lineTo(-34.7,-8.7).lineTo(-30.4,-8.7).lineTo(-30.4,1.9).curveTo(-30.4,3.6,-30.9,4.9).curveTo(-31.4,6.2,-32.3,7.1).curveTo(-33.3,8.1,-34.6,8.5).curveTo(-35.9,9,-37.5,9).curveTo(-39.1,9,-40.4,8.5).closePath().moveTo(-59.2,8.3).curveTo(-60.9,7.6,-62.1,6.4).curveTo(-63.3,5.2,-64,3.5).curveTo(-64.7,1.9,-64.7,0).curveTo(-64.7,-1.9,-64,-3.5).curveTo(-63.3,-5.1,-62.1,-6.3).curveTo(-60.9,-7.6,-59.2,-8.3).curveTo(-57.6,-9,-55.7,-9).curveTo(-53.8,-9,-52.2,-8.3).curveTo(-50.6,-7.6,-49.4,-6.3).curveTo(-48.1,-5.1,-47.4,-3.5).curveTo(-46.7,-1.9,-46.7,0).curveTo(-46.7,1.9,-47.4,3.5).curveTo(-48.1,5.2,-49.3,6.4).curveTo(-50.6,7.6,-52.2,8.3).curveTo(-53.8,9,-55.7,9).curveTo(-57.6,9,-59.2,8.3).closePath().moveTo(-57.6,-4.5).curveTo(-58.5,-4.1,-59.1,-3.4).curveTo(-59.7,-2.8,-60.1,-1.9).curveTo(-60.4,-1,-60.4,0).curveTo(-60.4,1,-60.1,1.9).curveTo(-59.7,2.8,-59.1,3.4).curveTo(-58.5,4.1,-57.6,4.5).curveTo(-56.7,4.9,-55.7,4.9).curveTo(-54.7,4.9,-53.8,4.5).curveTo(-52.9,4.1,-52.3,3.4).curveTo(-51.7,2.8,-51.3,1.9).curveTo(-50.9,1,-50.9,0).curveTo(-50.9,-1,-51.3,-1.9).curveTo(-51.7,-2.8,-52.3,-3.4).curveTo(-53,-4.1,-53.8,-4.5).curveTo(-54.7,-4.9,-55.7,-4.9).curveTo(-56.7,-4.9,-57.6,-4.5).closePath().moveTo(77.2,8.8).lineTo(73.4,0.5).lineTo(71.1,3.4).lineTo(71.1,8.8).lineTo(66.9,8.8).lineTo(66.9,-8.7).lineTo(71.1,-8.7).lineTo(71.1,-1.6).lineTo(76.7,-8.7).lineTo(81.6,-8.7).lineTo(76.5,-2.3).lineTo(81.6,8.8).closePath().moveTo(42.7,8.8).lineTo(41.8,6.2).lineTo(35.1,6.2).lineTo(34.2,8.8).lineTo(30,8.8).lineTo(36.4,-8.7).lineTo(40.5,-8.7).lineTo(47,8.8).closePath().moveTo(40.5,2.5).lineTo(38.5,-3.4).lineTo(36.4,2.5).lineTo(40.5,2.5).closePath().moveTo(15.2,8.8).lineTo(15.2,-8.7).lineTo(22.2,-8.7).curveTo(25.4,-8.7,26.9,-7.5).curveTo(28.5,-6.2,28.5,-3.7).curveTo(28.5,-2.5,28.1,-1.7).curveTo(27.6,-0.8,26.8,-0.3).curveTo(27.8,0.3,28.3,1.2).curveTo(28.9,2.1,28.9,3.5).curveTo(28.9,6.2,27.1,7.5).curveTo(25.3,8.8,22.2,8.8).closePath().moveTo(19.3,5.1).lineTo(22.3,5.1).curveTo(23.5,5.1,24,4.7).curveTo(24.6,4.2,24.6,3.4).curveTo(24.6,2.5,24.1,2.1).curveTo(23.5,1.7,22.2,1.7).lineTo(19.3,1.7).closePath().moveTo(19.3,-2).lineTo(22.4,-2).curveTo(23.5,-2,23.9,-2.4).curveTo(24.4,-2.9,24.4,-3.6).curveTo(24.4,-4.3,23.9,-4.7).curveTo(23.4,-5.1,22.3,-5.1).lineTo(19.3,-5.1).closePath().moveTo(-4.7,8.8).lineTo(-4.7,-8.7).lineTo(7.4,-8.7).lineTo(7.4,-4.9).lineTo(-0.5,-4.9).lineTo(-0.5,-2).lineTo(7.4,-2).lineTo(7.4,1.9).lineTo(-0.5,1.9).lineTo(-0.5,4.9).lineTo(7.4,4.9).lineTo(7.4,8.8).closePath().moveTo(-11,8.8).lineTo(-13.5,3.5).lineTo(-16.8,3.5).lineTo(-16.8,8.8).lineTo(-20.9,8.8).lineTo(-20.9,-8.7).lineTo(-13.4,-8.7).curveTo(-11.8,-8.7,-10.6,-8.3).curveTo(-9.4,-7.8,-8.5,-7).curveTo(-7.7,-6.2,-7.2,-5.1).curveTo(-6.8,-4,-6.8,-2.7).curveTo(-6.8,-1,-7.6,0.3).curveTo(-8.3,1.7,-9.7,2.4).lineTo(-6.4,8.8).closePath().moveTo(-16.8,-0.3).lineTo(-13.7,-0.3).curveTo(-12.4,-0.3,-11.7,-1).curveTo(-11.1,-1.6,-11.1,-2.6).curveTo(-11.1,-3.7,-11.7,-4.3).curveTo(-12.4,-4.9,-13.7,-4.9).lineTo(-16.8,-4.9).closePath().moveTo(-75.9,8.8).lineTo(-75.9,1.4).lineTo(-81.6,-8.7).lineTo(-77.1,-8.7).lineTo(-73.7,-2.5).lineTo(-70.4,-8.7).lineTo(-65.9,-8.7).lineTo(-71.7,1.5).lineTo(-71.7,8.8).closePath().moveTo(-27.4,-2.1).curveTo(-26.3,-2.9,-25.8,-3.7).curveTo(-25.2,-4.4,-25.1,-5.2).curveTo(-25.5,-4.6,-26.3,-4.6).curveTo(-27.1,-4.6,-27.6,-5.2).curveTo(-28.2,-5.8,-28.2,-6.7).curveTo(-28.2,-7.7,-27.5,-8.4).curveTo(-26.8,-9,-25.7,-9).curveTo(-24.4,-9,-23.7,-8.2).curveTo(-23.1,-7.3,-23.1,-6.1).curveTo(-23.1,-4.4,-23.9,-3.2).curveTo(-24.7,-2,-26.2,-0.9).closePath();
	this.shape.setTransform(85.125,19.175);
