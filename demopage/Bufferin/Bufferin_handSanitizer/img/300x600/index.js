...
p.nominalBounds = new cjs.Rectangle(0,0,306,182);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#666666").s().p("AgCAFIgCgBIgBgCIAAgCIAAgBIABgDIACgBIACAAIADAAIACABIABADIAAABIAAACIgBACIgCABIgDABIgCgBg");
	this.shape.setTransform(-1.525,8.85);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#666666").s().p("AgVAcIAAg4IASAAQAFAAAEACQAFACAEAEQADAEACAFQACAEAAAHIAAABQAAAGgCAGQgCAFgDADQgEADgFACQgFACgEAAgAgJATIAGAAQAGAAADgEQAEgFAAgJIAAgCQAAgIgEgEQgDgFgGAAIgGAAg");
	this.shape_1.setTransform(-5.375,6.55);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#666666").s().p("AgSAcIAAg4IAlAAIAAAKIgZAAIAAAOIAWAAIAAAIIgWAAIAAAPIAZAAIAAAJg");
	this.shape_2.setTransform(-10.4,6.55);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#666666").s().p("AgFAcIAAguIgRAAIAAgKIAtAAIAAAKIgRAAIAAAug");
	this.shape_3.setTransform(-15.475,6.55);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#666666").s().p("AgJAbQgEgCgDgDQgDgEgCgFQgBgFAAgGIAAgDQAAgGABgFQACgFADgEQADgEAEgBQAFgCAEAAQAGAAAEABIAHAEIAEAHIACAIIgMAAIgBgFIgCgDIgDgCIgFgBQgFAAgDAFQgDAEAAAJIAAADIABAHIACAGIAEADIAEABIAFAAIADgCIACgDIABgFIAMAAQAAAFgCADIgFAHQgCACgEACQgFABgFAAQgEAAgFgCg");
	this.shape_4.setTransform(-20.725,6.575);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#666666").s().p("AgSAcIAAg4IAlAAIAAAKIgZAAIAAAOIAVAAIAAAIIgVAAIAAAPIAZAAIAAAJg");
	this.shape_5.setTransform(-25.75,6.55);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#666666").s().p("AAKAcIgKgVIgJAAIAAAVIgMAAIAAg4IAVAAQAEABAEABQAEABACACQADACACADIABAIIgBAGIgCAEIgDACIgEADIAMAXIAAAAgAgJgBIAJAAIADgBIADgBIACgDIAAgDQAAgEgCgDQgCgCgEAAIgJAAg");
	this.shape_6.setTransform(-30.775,6.55);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#666666").s().p("AgFAcIAAg4IALAAIAAA4g");
	this.shape_7.setTransform(-34.875,6.55);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#666666").s().p("AgVAcIAAg4IASAAQAFAAAEACQAFACAEAEQADAEACAFQACAEAAAHIAAABQAAAGgCAGQgCAFgDADQgEADgFACQgFACgEAAgAgJATIAGAAQAGAAADgEQAEgFAAgJIAAgCQAAgIgEgEQgDgFgGAAIgGAAg");
	this.shape_8.setTransform(-38.775,6.55);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#666666").s().p("");
	this.shape_9.setTransform(-46.35,6.575);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#666666").s().p("AAOAcIgEgLIgTAAIgFALIgMAAIAVg4IALAAIAUA4gAAHAHIgHgUIgGAUIANAAg");
	this.shape_10.setTransform(-51.7,6.55);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#666666").s().p("AgSAcIAAg4IAlAAIAAAKIgZAAIAAAOIAVAAIAAAIIgVAAIAAAPIAZAAIAAAJg");
	this.shape_11.setTransform(-58.95,6.55);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#666666").s().p("");
	this.shape_12.setTransform(-64.05,6.575);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#666666").s().p("AgIAcIgHgFIgEgFQgCgFAAgEIAAglIAMAAIAAAlQAAAFADADQACACAEABQAFgBADgCQACgDAAgFIAAglIAMAAIAAAlQAAAEgCAFQgBADgDACIgHAFQgEABgFAAQgEAAgEgBg");
	this.shape_13.setTransform(-69.375,6.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_useAsDirected, new cjs.Rectangle(-74.1,0,76.1,13.4), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF9900").s().p("");
	this.shape.setTransform(-77.5859,30.2985);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("");
	this.shape_1.setTransform(-68.025,14.75);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.amazon_logo, new cjs.Rectangle(-119,5.7,102,30.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(259.85,603.15);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(95).to({_off:false},0).to({y:531.15},9,cjs.Ease.quadOut).wait(253));
	...
	// shine_cta
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.lf(["rgba(255,255,255,0)","rgba(255,255,255,0.498)","rgba(255,255,255,0)"],[0,0.537,1],-24,-18.4,23.9,18.3).s().p("At3KXIUP6cIHgFvI0Qacg");
	this.shape_1.setTransform(-26.65,500.875);
	this.shape_1._off = true;

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.lf(["rgba(255,255,255,0)","rgba(255,255,255,0.498)","rgba(255,255,255,0)"],[0,0.537,1],-24,-18.4,23.9,18.3).s().p("At3KXIUO6cIHhFvI0Qacg");
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(95).to({_off:false},0).to({y:546.6,alpha:1},9,cjs.Ease.quadOut).wait(253));
	...
	this.instance_4.setTransform(-1.25,-0.05);
	...
	// Layer_1
	this.instance_7 = new lib.billNye_name();
	this.instance_7.setTransform(229,268.1,1.0449,1.0449,0,0,0,-66.9,20.5);
	this.instance_7.alpha = 0;
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(48).to({_off:false},0).to({alpha:1},9).wait(28).to({alpha:0},9).to({_off:true},1).wait(262));

	// txt_killGerms_animation
	this.instance_8 = new lib.txt_killGerms_animation("synched",0,false);
	this.instance_8.setTransform(149.55,87.35,1,1,0,0,0,150.6,86.6);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(43).to({_off:false},0).wait(42).to({startPosition:34},0).to({alpha:0.5508,startPosition:39},9).to({_off:true},1).wait(262));
	...
	this.instance_10.setTransform(504.7,391.5,1,1,0,0,0,-198,240.5);
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(43).to({_off:false},0).to({x:124.7},9,cjs.Ease.quadOut).wait(43).to({alpha:0},9).to({_off:true},1).wait(252));

	// Ribbon_mc
	this.instance_11 = new lib.Ribbon_mc();
	this.instance_11.setTransform(-20.7,-20.95,1,1,0,0,0,-94.2,79);
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(3).to({_off:false},0).to({x:53.3,y:41.05},10,cjs.Ease.quadOut).wait(22).to({x:-246.7,alpha:0},10,cjs.Ease.quadOut).to({_off:true},1).wait(311));

	// Bufferin_logo
	this.instance_12 = new lib.Bufferin_logo_animation("synched",0,false);
	this.instance_12.setTransform(154.6,144.65,1,1,0,0,0,155.2,146.8);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(35).to({startPosition:31},0).to({x:-143.4,alpha:0,startPosition:36},10,cjs.Ease.quadOut).to({_off:true},1).wait(311));

	// Product_bottle
	this.instance_13 = new lib.Product_bottle_1();
	this.instance_13.setTransform(152.65,793.65,1,1,0,0,0,-80.5,190);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({y:411.65},11,cjs.Ease.quadOut).wait(24).to({x:-147.35,alpha:0},10,cjs.Ease.quadOut).to({_off:true},1).wait(311));
