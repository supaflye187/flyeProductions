...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#353535").s().p("AgMAPIAAgdIAZAAIAAAdg");
	this.shape.setTransform(-10,-478.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#353535").s().p("AgXBZIAKgVQAFgLACgLQADgKABgMQACgLgBgNQABgMgCgKQgBgMgDgLQgCgLgFgKIgKgXIAUAAQAOAYAHAXQAGAXAAATQAAAWgGAWQgHAWgOAXg");
	this.shape_1.setTransform(-15.85,-482.6);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#353535").s().p("AgNBHIAAiOIAbAAIAACOg");
	this.shape_2.setTransform(-20.7,-484.4);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#353535").s().p("AgNBHIAAiOIAbAAIAACOg");
	this.shape_3.setTransform(-25.5,-484.4);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#353535").s().p("AgTA1QgJgDgFgHQgEgHgCgLQgCgLgBgOQAAgMADgLQACgLAFgHQAFgHAIgDQAIgEALAAQANAAAHADQAJAEAFAHQAFAHACALQACAKAAANQgBAOgCALQgCALgFAHQgFAHgIADQgIADgMAAIgCAAQgLAAgGgDgAgHgiQgDADgBAFIgCAMIgBAOIABAQIACAMQABAFADACQADADAEAAQAIAAADgJQAEgIAAgVQAAgTgEgJQgDgIgIAAQgEAAgDACg");
	this.shape_4.setTransform(-32.7,-482.6719);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#353535").s().p("AgcA3IAAhqIAbAAIAAAOIAAAAQAEgIAGgEQAGgFAIAAIADAAIADAAIAAAbIgFgBIgEAAIgIABQgDABgDADQgDACgCAEQgBADAAAGIAAA/g");
	this.shape_5.setTransform(-40.4,-482.775);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#353535").s().p("AANBHIAAhJQAAgIgDgDQgCgEgHAAQgNAAAAARIAABHIgcAAIAAiOIAcAAIAAAvQAIgOASAAQAMAAAIAIQAHAGAAAQIAABPg");
	this.shape_6.setTransform(-53.95,-484.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#353535").s().p("AgRA2QgIgDgFgGQgFgHgCgKQgDgLAAgRQAAgPADgLQADgLAGgGQAGgHAIgDQAIgCAJAAQATAAAJALQAKALAAATIgaAAIgBgHIgCgHQgBgDgCgCQgDgCgEAAQgEAAgDACQgDACgCAFIgCALIAAAQIAAARIACALQACAFADACQADACADAAQAHAAAEgGQADgGAAgNIAaAAQAAAVgJALQgKALgWAAQgJAAgIgCg");
	this.shape_7.setTransform(-63.575,-482.675);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#353535").s().p("AANA3IAAhJQAAgIgDgEQgCgDgHAAQgNAAAAASIAABGIgcAAIAAhqIAbAAIAAAMIAAAAQAEgIAIgDQAFgEAKAAQAMAAAIAHQAHAHAAAQIAABPg");
	this.shape_8.setTransform(-73.2,-482.775);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#353535").s().p("AgNBIIAAhqIAbAAIAABqgAgNgwIAAgXIAbAAIAAAXg");
	this.shape_9.setTransform(-80.6,-484.475);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#353535").s().p("AgbAMIAAgXIA3AAIAAAXg");
	this.shape_10.setTransform(-86.7,-483.025);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#353535").s().p("AAFBHIAAgeIgxAAIAAgXIAuhYIAdAAIAABZIAOAAIAAAWIgOAAIAAAegAgWATIAbAAIAAg1g");
	this.shape_11.setTransform(-95.2,-484.325);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#353535").s().p("");
	this.shape_12.setTransform(-104.8,-484.225);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#353535").s().p("AAaBHIgHgdIglAAIgGAdIgeAAIAmiOIAiAAIAmCOgAAOARIgNg/IgBAAIgNA/IAbAAg");
	this.shape_13.setTransform(-119.95,-484.4);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#353535").s().p("AADBZQgNgXgHgWQgGgWgBgWQABgTAGgXQAHgXANgYIAWAAIgLAXQgEAKgDALIgEAXIgBAWIABAYIAEAWQADALAEALIALAVg");
	this.shape_14.setTransform(-127.95,-482.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_inchRoll, new cjs.Rectangle(-204.5,-498.4,270.1,27.599999999999966), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#353535").s().p("AgKANIAAgYIAVAAIAAAYg");
	this.shape.setTransform(62.575,-145.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#353535").s().p("AAKAsIAAg6QAAgHgCgCQgCgDgFAAQgLAAAAAOIAAA4IgVAAIAAhVIAVAAIAAAKIAAAAQAEgGAFgDQAFgDAGAAQALAAAGAGQAFAFABANIAAA/g");
	this.shape_1.setTransform(56.4,-148.375);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#353535").s().p("");
	this.shape_2.setTransform(48.35,-148.275);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#353535").s().p("AgKA6IAAhVIAVAAIAABVgAgKgmIAAgTIAVAAIAAATg");
	this.shape_3.setTransform(42.35,-149.725);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#353535").s().p("AgBA2QgEAAgCgDQgCgCgBgFIgBgLIAAgwIgLAAIAAgPIALAAIAAgYIAVAAIAAAYIANAAIAAAPIgNAAIAAAtQAAAFACADQACACAEAAIADAAIACgBIAAAQIgHAAIgHAAIgKgBg");
	this.shape_4.setTransform(37.9,-149.45);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#353535").s().p("");
	this.shape_5.setTransform(31.4,-148.275);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#353535").s().p("AAKAsIAAg6QAAgHgBgCQgDgDgFAAQgKAAAAAOIAAA4IgXAAIAAhVIAWAAIAAAKIAAAAQADgGAGgDQAFgDAGAAQAMAAAFAGQAGAFAAANIAAA/g");
	this.shape_6.setTransform(23.35,-148.375);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#353535").s().p("AgKA6IAAhVIAVAAIAABVgAgKgmIAAgTIAVAAIAAATg");
	this.shape_7.setTransform(17.2,-149.725);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#353535").s().p("AAfAsIAAg7QAAgFgCgDQgCgDgFAAQgFAAgDADQgDAEAAAIIAAA3IgVAAIAAg7QAAgFgCgDQgCgDgFAAQgFAAgDADQgDAEAAAIIAAA3IgWAAIAAhVIAVAAIAAAJIAAAAQAEgGAFgDQAGgCAHAAQAHAAAFADQAFAEACAHQADgHAFgEQAGgDAIAAQALAAAFAHQAFAGAAANIAAA9g");
	this.shape_8.setTransform(9.025,-148.375);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#353535").s().p("");
	this.shape_9.setTransform(-1.15,-148.275);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#353535").s().p("AgKA5IAAhxIAVAAIAABxg");
	this.shape_10.setTransform(-7.1,-149.65);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#353535").s().p("");
	this.shape_11.setTransform(-17,-148.275);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#353535").s().p("AgBA2QgEAAgCgDQgCgCgBgFIgBgLIAAgwIgLAAIAAgPIALAAIAAgYIAVAAIAAAYIANAAIAAAPIgNAAIAAAtQAAAFACADQABACAFAAIACAAIADgBIAAAQIgHAAIgIAAIgJgBg");
	this.shape_12.setTransform(-23.25,-149.45);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#353535").s().p("");
	this.shape_13.setTransform(-29.75,-148.275);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#353535").s().p("AgKA6IAAhVIAVAAIAABVgAgKgmIAAgTIAVAAIAAATg");
	this.shape_14.setTransform(-35.7,-149.725);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#353535").s().p("AgbAvQgFgKAAgYQAAgXAFgLQAHgKAOgBQAGABAEACQAEADADAFIABAAIAAgkIAVAAIAABxIgUAAIAAgJIgBAAQgDAGgFACQgEADgGAAQgOAAgHgLgAgJgHQgCAHAAANQAAAOACAHQACAIAHgBQAHABACgIQADgHAAgOQAAgNgDgHQgCgHgHgBQgHABgCAHg");
	this.shape_15.setTransform(-41.95,-149.55);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#353535").s().p("");
	this.shape_16.setTransform(-49.8,-148.275);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#353535").s().p("AAfAsIAAg7QAAgFgCgDQgCgDgFAAQgFAAgDADQgDAEAAAIIAAA3IgVAAIAAg7QAAgFgCgDQgCgDgFAAQgFAAgDADQgDAEAAAIIAAA3IgWAAIAAhVIAVAAIAAAJIAAAAQAEgGAFgDQAGgCAHAAQAHAAAFADQAFAEACAHQADgHAFgEQAGgDAIAAQALAAAFAHQAFAGAAANIAAA9g");
	this.shape_17.setTransform(-59.775,-148.375);
	...
	this.shape_18.setTransform(-72.125,-148.375);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#353535").s().p("AgKA5IAAhxIAVAAIAABxg");
	this.shape_19.setTransform(-80.5,-149.65);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_Immediatelamination, new cjs.Rectangle(-226.7,-161.3,435.6,22.900000000000006), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(66.05,-147.325);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#353535").s().p("AgZA1IAAgPIAFAAQAGAAACgDQADgDAAgFIgXhPIAWAAIALA2IALg2IAVAAIgUBKIgFAQQgDAGgDAEQgCADgFABIgMABg");
	this.shape_1.setTransform(60.625,-148.875);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#353535").s().p("AAAAzQgFAAgCgDQgBgCgBgEIgBgLIAAgtIgKAAIAAgOIAKAAIAAgXIATAAIAAAXIAMAAIAAAOIgMAAIAAArQABAFABACQACACAEAAIACAAIACgBIAAAPIgGAAIgHAAIgIgBg");
	this.shape_2.setTransform(54.85,-151.325);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#353535").s().p("AgKA2IAAhPIAVAAIAABPgAgKgjIAAgSIAVAAIAAASg");
	this.shape_3.setTransform(50.5,-151.575);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#353535").s().p("AgKA1IAAhqIAUAAIAABqg");
	this.shape_4.setTransform(46.6,-151.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#353535").s().p("");
	this.shape_5.setTransform(40.85,-150.225);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#353535").s().p("AgZAkQgEgFAAgMIAAg7IAUAAIAAA2QAAAHACACQADADAEAAQAKAAAAgOIAAg0IAUAAIAABPIgTAAIAAgJIgBAAQgDAGgFACQgFADgGAAQgKAAgGgFg");
	this.shape_6.setTransform(33.25,-150.1);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#353535").s().p("AALA2IAAghIgBAAQgDAFgEACQgDACgGAAQgMAAgHgKQgFgKAAgVQAAgXAFgKQAHgKAMABQAGgBAEADQAEADADAFIABAAIAAgIIAUAAIAABpgAgIgfQgCAHAAANQAAANACAGQACAHAGAAQAHAAACgHQACgGAAgNQAAgNgCgHQgCgGgHAAQgGAAgCAGg");
	this.shape_7.setTransform(25.35,-149);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#353535").s().p("AgUApIAAhPIATAAIAAAKIABAAQACgFAEgEQAFgDAGAAIACAAIACAAIAAAUIgDgBIgDAAIgGABIgFACIgDAFQgBADAAAEIAAAvg");
	this.shape_8.setTransform(15.375,-150.3);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#353535").s().p("AgOAoQgGgCgEgGQgEgFgCgIQgBgIAAgLQAAgJACgIQACgIAEgFQADgGAGgCQAGgDAIAAQAKAAAFACQAHADADAFQAEAGABAIQACAIAAAJQAAALgCAIQgBAIgFAFQgDAFgGADQgGACgJAAIgCAAQgIAAgEgCgAgFgZIgDAGIgCAJIAAAKIAAAMIACAJIADAGQACACADAAQAGAAADgHQACgGAAgQQAAgOgCgGQgDgHgGAAQgDAAgCACg");
	this.shape_9.setTransform(8.65,-150.2208);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#353535").s().p("AgKA1IAAhqIAUAAIAABqg");
	this.shape_10.setTransform(2.95,-151.5);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#353535").s().p("AgPAoQgFgCgEgGQgEgFgBgIQgCgIAAgLQAAgJACgIQABgIAEgFQAEgGAGgCQAGgDAIAAQAJAAAHACQAFADAEAFQAEAGABAIQACAIAAAJQAAALgCAIQgBAIgEAFQgEAFgGADQgGACgJAAIgCAAQgHAAgGgCgAgFgZIgDAGIgCAJIAAAKIAAAMIACAJIADAGQACACADAAQAHAAACgHQACgGAAgQQAAgOgCgGQgCgHgHAAQgDAAgCACg");
	this.shape_11.setTransform(-2.75,-150.2208);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#353535").s().p("AgNApQgFgCgEgFQgEgFgCgIQgCgIAAgNQAAgLADgIQACgIAEgFQAFgFAGgCQAGgCAGAAQAOAAAIAIQAHAJAAAOIgUAAIAAgGIgCgFIgDgEQAAAAgBAAQAAgBgBAAQAAAAgBAAQgBAAAAAAQgDAAgCACQgDABgBAEIgCAIIAAAMIAAAMIACAJQABAEACABQACACADAAQAFAAADgFQACgEAAgKIAUAAQAAAQgHAIQgHAIgRAAQgHAAgGgBg");
	this.shape_12.setTransform(-10.075,-150.225);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#353535").s().p("AgBAzQgDAAgCgDQgDgCgBgEIAAgLIAAgtIgLAAIAAgOIALAAIAAgXIATAAIAAAXIANAAIAAAOIgNAAIAAArQAAAFACACQABACAFAAIADAAIACgBIAAAPIgHAAIgHAAIgJgBg");
	this.shape_13.setTransform(-19.9,-151.325);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#353535").s().p("AAKApIAAg2QAAgGgCgDQgDgCgEAAQgKAAAAANIAAA0IgVAAIAAhPIAUAAIAAAJIAAAAQAEgGAFgDQAFgCAGAAQAKAAAFAFQAGAGAAALIAAA7g");
	this.shape_14.setTransform(-26.2,-150.3);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#353535").s().p("AgQAnQgGgEgDgGQgDgGgBgIIgBgPIABgPQABgHAEgGQADgGAGgEQAHgDAJAAQAJAAAGADQAGADADAFQADAFACAIIABARIAAAEIgoAAIAAAGIAAAHIACAGQABADACABQACACACAAQAFAAADgEQACgEABgHIATAAQgBAOgHAHQgHAHgPAAQgKAAgGgDgAgEgaIgDAEIgCAFIAAAGIAAADIAUAAIgBgIIgBgGIgDgEIgGgBIgEABg");
	this.shape_15.setTransform(-33.675,-150.225);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#353535").s().p("AgBAzQgDAAgCgDQgCgCgCgEIAAgLIAAgtIgLAAIAAgOIALAAIAAgXIAUAAIAAAXIAMAAIAAAOIgMAAIAAArQAAAFABACQACACAEAAIADAAIACgBIAAAPIgHAAIgHAAIgJgBg");
	this.shape_16.setTransform(-39.6,-151.325);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#353535").s().p("");
	this.shape_17.setTransform(-45.475,-150.225);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#353535").s().p("AgJA2IAAhPIATAAIAABPgAgJgjIAAgSIATAAIAAASg");
	this.shape_18.setTransform(-50.9,-151.575);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#353535").s().p("");
	this.shape_19.setTransform(-56.325,-150.225);

	this.shape_20 = new cjs.Shape();
	this.shape_20.graphics.f("#353535").s().p("AAKApIAAg2QAAgGgCgDQgCgCgFAAQgKAAAAANIAAA0IgVAAIAAhPIAUAAIAAAJIABAAQADgGAFgDQAEgCAHAAQAKAAAGAFQAEAGAAALIAAA7g");
	this.shape_20.setTransform(-63.7,-150.3);

	this.shape_21 = new cjs.Shape();
	this.shape_21.graphics.f("#353535").s().p("AgPAoQgFgCgEgGQgEgFgCgIQgBgIAAgLQAAgJACgIQACgIADgFQAEgGAGgCQAGgDAIAAQAKAAAFACQAHADADAFQAEAGABAIQACAIAAAJQAAALgCAIQgCAIgEAFQgDAFgGADQgGACgJAAIgCAAQgIAAgFgCgAgFgZIgDAGIgCAJIAAAKIAAAMIACAJIADAGQACACADAAQAHAAACgHQACgGAAgQQAAgOgCgGQgCgHgHAAQgDAAgCACg");
	this.shape_21.setTransform(-71.35,-150.2208);

	this.shape_22 = new cjs.Shape();
	this.shape_22.graphics.f("#353535").s().p("AgRAzQgIgDgDgIQgEgHgBgKIgBgXIABgVQABgLAEgHQADgHAIgEQAHgEALAAQALAAAHADQAHAEADAGQADAGACAGIABANIgXAAQAAgMgCgFQgDgGgHAAQgDAAgDADQgDACgBAFIgCAMIgBATIABATIADAMQACAEACACIAFABIAGgBQACgBABgDQACgDABgFIABgOIAWAAIgBAQQgCAIgDAGQgEAGgHADQgGADgLAAQgLAAgHgEg");
	this.shape_22.setTransform(-79.25,-151.525);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_22},{t:this.shape_21},{t:this.shape_20},{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.txt_consistentQuality, new cjs.Rectangle(-92.2,-162.5,169.3,21.69999999999999), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#353535").s().p("");
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.shape).to({_off:true},1).wait(8).to({_off:false},0).wait(166).to({_off:true},1).wait(5).to({_off:false},0).to({_off:true},1).wait(12).to({_off:false},0).to({_off:true},1).wait(146));
	...
	var mask_graphics_175 = new cjs.Graphics().p("AukFgIAAq/IdJAAIAAK/g");
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(124).to({_off:false},0).to({y:13.05},43,cjs.Ease.quadInOut).wait(8).to({_off:true},1).wait(5).to({_off:false},0).to({_off:true},1).wait(12).to({_off:false},0).to({_off:true},1).wait(146));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1}]},124).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4}]},1).to({state:[{t:this.shape_5}]},1).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_12}]},1).to({state:[{t:this.shape_13}]},1).to({state:[{t:this.shape_14}]},1).to({state:[{t:this.shape_15}]},1).to({state:[{t:this.shape_16}]},1).to({state:[{t:this.shape_17}]},1).to({state:[{t:this.shape_18}]},1).to({state:[{t:this.shape_19}]},1).to({state:[{t:this.shape_20}]},1).to({state:[{t:this.shape_21}]},1).to({state:[{t:this.shape_22}]},1).to({state:[{t:this.shape_23}]},1).to({state:[{t:this.shape_24}]},1).to({state:[{t:this.shape_25}]},1).to({state:[{t:this.shape_26}]},1).to({state:[{t:this.shape_27}]},1).to({state:[{t:this.shape_28}]},1).to({state:[{t:this.shape_29}]},1).to({state:[{t:this.shape_30}]},1).to({state:[{t:this.shape_31}]},1).to({state:[{t:this.shape_32}]},1).to({state:[{t:this.shape_33}]},1).to({state:[{t:this.shape_34}]},1).to({state:[{t:this.shape_35}]},1).to({state:[{t:this.shape_36}]},1).to({state:[{t:this.shape_37}]},1).to({state:[{t:this.shape_38}]},1).to({state:[{t:this.shape_39}]},1).to({state:[{t:this.shape_40}]},1).to({state:[{t:this.shape_41}]},1).to({state:[{t:this.shape_42}]},1).to({state:[{t:this.shape_43}]},1).to({state:[{t:this.shape_44}]},1).to({state:[{t:this.shape_44}]},8).to({state:[]},1).to({state:[{t:this.shape_44}]},5).to({state:[]},1).to({state:[{t:this.shape_44}]},12).to({state:[]},1).wait(146));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(66).to({_off:false},0).to({y:12.1},43,cjs.Ease.quadInOut).wait(66).to({_off:true},1).wait(5).to({_off:false},0).to({_off:true},1).wait(12).to({_off:false},0).to({_off:true},1).wait(146));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_45}]},66).to({state:[{t:this.shape_46}]},1).to({state:[{t:this.shape_47}]},1).to({state:[{t:this.shape_48}]},1).to({state:[{t:this.shape_49}]},1).to({state:[{t:this.shape_50}]},1).to({state:[{t:this.shape_51}]},1).to({state:[{t:this.shape_52}]},1).to({state:[{t:this.shape_53}]},1).to({state:[{t:this.shape_54}]},1).to({state:[{t:this.shape_55}]},1).to({state:[{t:this.shape_56}]},1).to({state:[{t:this.shape_57}]},1).to({state:[{t:this.shape_58}]},1).to({state:[{t:this.shape_59}]},1).to({state:[{t:this.shape_60}]},1).to({state:[{t:this.shape_61}]},1).to({state:[{t:this.shape_62}]},1).to({state:[{t:this.shape_63}]},1).to({state:[{t:this.shape_64}]},1).to({state:[{t:this.shape_65}]},1).to({state:[{t:this.shape_66}]},1).to({state:[{t:this.shape_67}]},1).to({state:[{t:this.shape_68}]},1).to({state:[{t:this.shape_69}]},1).to({state:[{t:this.shape_70}]},1).to({state:[{t:this.shape_71}]},1).to({state:[{t:this.shape_72}]},1).to({state:[{t:this.shape_73}]},1).to({state:[{t:this.shape_74}]},1).to({state:[{t:this.shape_75}]},1).to({state:[{t:this.shape_76}]},1).to({state:[{t:this.shape_77}]},1).to({state:[{t:this.shape_78}]},1).to({state:[{t:this.shape_79}]},1).to({state:[{t:this.shape_80}]},1).to({state:[{t:this.shape_81}]},1).to({state:[{t:this.shape_82}]},1).to({state:[{t:this.shape_83}]},1).to({state:[{t:this.shape_84}]},1).to({state:[{t:this.shape_85}]},1).to({state:[{t:this.shape_86}]},1).to({state:[{t:this.shape_87}]},1).to({state:[{t:this.shape_88}]},1).to({state:[{t:this.shape_88}]},66).to({state:[]},1).to({state:[{t:this.shape_88}]},5).to({state:[]},1).to({state:[{t:this.shape_88}]},12).to({state:[]},1).wait(146));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(10).to({_off:false},0).to({y:46.3},42,cjs.Ease.quadInOut).wait(123).to({_off:true},1).wait(5).to({_off:false},0).to({_off:true},1).wait(12).to({_off:false},0).to({_off:true},1).wait(146));

	// printer
	this.instance_4 = new lib.Printer();
	this.instance_4.setTransform(-160,-87);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({_off:true},1).wait(8).to({_off:false},0).wait(166).to({_off:true},1).wait(5).to({_off:false},0).to({_off:true},1).wait(12).to({_off:false},0).to({_off:true},1).wait(146));
...
if (reversed == null) { reversed = false; }
	...
	var mask_graphics_69 = new cjs.Graphics().p("Aq5L6IAA3yIV0AAIAAXyg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:34.55,y:-161.85}).wait(69).to({graphics:mask_graphics_69,x:34.55,y:-161.85}).wait(1).to({graphics:null,x:0,y:0}).wait(290));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(10).to({_off:false},0).to({y:-159.7},18,cjs.Ease.quadOut).wait(41).to({_off:true},1).wait(290));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(28).to({_off:false},0).to({y:-159.7},19,cjs.Ease.quadOut).wait(22).to({_off:true},1).wait(290));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(47).to({_off:false},0).to({y:-159.7},22,cjs.Ease.quadOut).to({_off:true},1).wait(290));

	// Layer_1
	this.instance_3 = new lib.hallway();
	this.instance_3.setTransform(-150,-300);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(69).to({_off:true},1).wait(290));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(285).to({_off:false},0).to({x:240.95,alpha:1},15,cjs.Ease.quadOut).wait(44));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(285).to({_off:false},0).to({regX:0.5,regY:0.8,scaleX:0.1997,scaleY:0.1997,y:26.85,alpha:1},15,cjs.Ease.quadOut).wait(44));

	// ctaBtn_mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_310 = new cjs.Graphics().p("AkZBgQgWAAAAgWIAAAAIAAiTQAAgWAWAAIAAAAIIzAAQAWAAAAAWIAAAAIAACTQAAAWgWAAIAAAAg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(310).to({graphics:mask_graphics_310,x:285.4093,y:24.8094}).wait(34));
	...
	this.shape_1.setTransform(244.375,4);
	...
	this.shape_2.setTransform(245.325,4.4);
	...
	this.shape_3.setTransform(253.075,7.65);
	...
	this.shape_4.setTransform(259.875,10.55);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_1,p:{x:244.375,y:4}}]},310).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_3}]},1).to({state:[{t:this.shape_4,p:{x:259.875,y:10.55}}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_4,p:{x:323.875,y:37.45}}]},1).to({state:[{t:this.shape_4,p:{x:330.625,y:40.35}}]},1).to({state:[{t:this.shape_2}]},1).to({state:[{t:this.shape_1,p:{x:338.425,y:43.6}}]},1).to({state:[{t:this.shape_2}]},1).wait(20));
	this.timeline.addTween(cjs.Tween.get(this.shape_2).wait(311).to({_off:false},0).wait(1).to({x:248.275,y:5.65},0).to({_off:true},1).wait(2).to({_off:false,x:268.625,y:14.2},0).wait(1).to({x:279.275,y:18.7},0).wait(1).to({x:291.875,y:24},0).wait(1).to({x:304.475,y:29.3},0).wait(1).to({x:315.125,y:33.8},0).to({_off:true},1).wait(2).to({_off:false,x:335.475,y:42.35},0).to({_off:true},1).wait(1).to({_off:false,x:339.375,y:44},0).wait(20));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.shape_5}]},276).to({state:[{t:this.shape_6}]},1).to({state:[{t:this.shape_7}]},1).to({state:[{t:this.shape_8}]},1).to({state:[{t:this.shape_9}]},1).to({state:[{t:this.shape_10}]},1).to({state:[{t:this.shape_11}]},1).to({state:[{t:this.shape_12}]},1).to({state:[{t:this.shape_13}]},1).to({state:[{t:this.shape_14}]},1).wait(59));
	...
	mask_1._off = true;
	var mask_1_graphics_183 = new cjs.Graphics().p("Ar1ERIAAohIXrAAIAAIhg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(183).to({graphics:mask_1_graphics_183,x:230.85,y:25.275}).wait(161));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(183).to({_off:false},0).to({regX:42.4,scaleX:0.6652,scaleY:0.6652,x:237.25,y:32.55,alpha:1,startPosition:10},10).to({regX:42.1,regY:-161.8,scaleX:0.4065,scaleY:0.4065,x:233.85,y:36.6,mode:"single",startPosition:69},60).to({_off:true},28).wait(63));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(124).to({_off:false},0).to({y:174.55,alpha:1},9,cjs.Ease.quadOut).wait(45).to({alpha:0},11,cjs.Ease.quadOut).to({_off:true},1).wait(154));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(63).to({_off:false},0).to({y:174.55,alpha:1},9,cjs.Ease.quadOut).wait(41).to({alpha:0},10).to({_off:true},1).wait(220));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({y:174.55,alpha:1},9,cjs.Ease.quadOut).wait(43).to({alpha:0},10).to({_off:true},1).wait(281));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({regX:0.7,regY:0.1,scaleX:0.2982,scaleY:0.2982,y:23.45,alpha:1,mode:"synched",startPosition:9,loop:false},9,cjs.Ease.quadOut).wait(167).to({mode:"single",startPosition:181},0).to({x:367.75,alpha:0,startPosition:194},13,cjs.Ease.quadIn).to({_off:true},1).wait(154));
