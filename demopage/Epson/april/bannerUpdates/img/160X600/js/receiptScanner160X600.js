...
function blowReceiptsAway(timestamp){
	...
	if(timestamp > (oldTime + animationInt)){
		...
		if(requestNum == -14){
			...
			document.getElementById("better-title").style.transform = "translate(0px, -110px)";// rotate(-33deg)
...
document.getElementById("better-title").addEventListener("transitionend", animateTitlesThree, false);
		...
		document.getElementById("scanner-receipt-motion").style.transform  = "translate(-48px, 450px) scale(0.35)";
...
*/
	document.getElementById("scanner-receipt-motion").style.transition = "all 0.25s ease-in-out";
	document.getElementById("laptop").style.transform = "translate(-35px, 454px) scale(1.2)";
	document.getElementById("laptop").style.opacity = "1.0";
	
	document.getElementById("arrow").style.top = "412px";
...
function initSceneSix(){
	...
	document.getElementById("laptop").style.transform = "translate(0px, 600px) scale(1.0)";
	
	
	document.getElementById("autoOrganize").style.top = "600px";
	...
	document.getElementById("receipt-scanner-drawer").style.top = "-20px";
