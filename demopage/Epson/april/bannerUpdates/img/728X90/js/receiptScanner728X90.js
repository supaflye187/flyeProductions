...
//if(1 == "stop"){
		...
		document.getElementById("better-title").style.transform = "translate(76px, 290px)";
...
document.getElementById("better-title").addEventListener("transitionend", animateTitlesThree, false);
		...
		document.getElementById("scanner-receipt-motion").style.transform = "translate(28px, -30px) scale(0.22)";
...
function receiptsGoIn(){
	...
	document.getElementById("receiptsGoInTitle").style.top = "-5px";
	...
	document.getElementById("scanner-receipt-motion").style.transform = "translate(351px, -88px) scale(0.22)";
	...
	for (var i = 0; i < receiptScannerEle.length; i++) {
	   //receiptScannerEle[i].style.transform = "translate(17px, 238px) scale(1.0)";
		receiptScannerEle[i].style.transform = "translate(358px, -35px) scale(0.49)";
	}
...
function stressGoesAway(){
	...
	document.getElementById("scanner-receipt-motion").style.transform = "translate(351px, -58px) scale(0.22)";
...
*/
	document.getElementById("scanner-receipt-motion").style.transition = "all 0.25s ease-in-out";
	document.getElementById("laptop").style.transform = "translate(-48px, 376px) scale(1.1);";
	...
	*/
	...
	document.getElementById("laptop").style.transform = "translate(389px, -78px) scale(0.45)";
...
function initSceneFive(){
	...
	*/
	...
	for (var i = 0; i < receiptScannerEle.length; i++) {
	   //receiptScannerEle[i].style.transform = "translate(17px, 238px) scale(1.0)";
		////receiptScannerEle[i].style.transform = "translate(85px, 151px) scale(1.20)";
	}
...
function initSceneSix(){
	...
	for (var i = 0; i < receiptScannerEle.length; i++) {
	   //receiptScannerEle[i].style.transform = "translate(17px, 238px) scale(1.0)";
		...
		receiptScannerEle[i].style.transform = "translate(380px, -26px) scale(0.55)";
	}
	document.getElementById("receipt-scanner").style.opacity = "0.0";
	document.getElementById("epson-logo").style.opacity = "0.0";
	document.getElementById("epson-logo_02").style.opacity = "1";
	...
	document.getElementById("scanner-receipt-motion").style.transform = "translate(373px, -78px) scale(0.24)";
	...
	document.getElementById("receipt-scanner-drawer").style.top = "-12px";
