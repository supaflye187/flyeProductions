...
function stressGoesAway(){
	...
	document.getElementById("receiptsGoInTitle").style.top = "290px";
...
function initSceneFive(){
	...
	document.getElementById("laptop").style.transform = "translate(0px, 0px) scale(1.0)";
...
function initSceneSix(){
	...
	document.getElementById("laptop").style.transform = "translate(300px, 0px) scale(1.0)";
	
	document.getElementById("autoOrganize").style.top = "290px";
	...
	document.getElementById("receipt-scanner-drawer").style.top = "53px";
