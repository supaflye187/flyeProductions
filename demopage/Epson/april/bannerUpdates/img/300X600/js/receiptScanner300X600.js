...
//if(1 == "stop"){
		...
		document.getElementById("better-title").style.transform = "translate(0px, 290px)";
...
function receiptsGoIn(){
	...
	document.getElementById("receiptsGoInTitle").style.top = "118px";
	...
	for (var i = 0; i < receiptScannerEle.length; i++) {
	   //receiptScannerEle[i].style.transform = "translate(17px, 238px) scale(1.0)";
		receiptScannerEle[i].style.transform = "translate(85px, 172px) scale(1.43)";
	}
...
function initSceneFive(){
	...
	document.getElementById("arrow").style.top = "350px";
	...
	*/
	...
	document.getElementById("laptop").style.transform = "translate(-75px, 366px) scale(1.5)";
...
function initSceneSix(){
	...
	document.getElementById("laptop").style.transform = "translate(0px, 800px) scale(1.0)";
	...
	document.getElementById("receipt-scanner-drawer").style.top = "-34px";
